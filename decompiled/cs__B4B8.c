...
l__0AC6:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x10));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x12));
	emu_push(emu_cs); emu_push(0x0ADE); emu_cs = 0x253D; emu_File_ReadBlockFile();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__0ADE:
	emu_addw(&emu_sp, 0xC);
 ...
 * @implements B4B8:1C3C:0011:EAB0
 ...
 * @implements B4B8:1D1A:0011:EAB0
 ...
 * @implements B4B8:221A:000D:A528
 * @implements B4B8:2227:0002:D33A
...
l__17F0:
	...
	emu_ax = 0x22C0;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1817); emu_cs = 0x253D; emu_File_ReadBlockFile();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1817:
	emu_addw(&emu_sp, 0xC);
...
l__1B81:
	...
	emu_ax = 0x22F0;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B90); emu_cs = 0x1FB5; emu_File_Exists();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1B90:
	emu_pop(&emu_cx);
	...
	emu_ax = 0x22FD;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B9F); emu_cs = 0x1FB5; emu_File_Exists();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1B9F:
	emu_pop(&emu_cx);
...
l__1BC1:
	...
	emu_ax = 0x230A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1BD7); emu_cs = 0x1FB5; emu_File_Exists();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1BD7:
	emu_pop(&emu_cx);
...
l__1C03:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1C0B); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1C0B:
	emu_pop(&emu_cx);
...
l__1C6F:
	...
	emu_ax = 0x22C0;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1C89); emu_cs = 0x253D; emu_File_ReadBlockFile();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1C89:
	emu_addw(&emu_sp, 0xC);
...
l__1CA8:
	...
	emu_ax = 0x230A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1CC0); emu_cs = 0x1FB5; emu_File_Open();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1CC0:
	emu_addw(&emu_sp, 0x6);
	...
	emu_push(emu_cs); emu_push(0x1CCE); emu_cs = 0x1FB5; emu_File_Close();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1CCE:
	emu_pop(&emu_cx);
...
l__1CD5:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1CDD); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1CDD:
	emu_pop(&emu_cx);
...
l__1D4D:
	...
	emu_ax = 0x1C;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1D59); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1D59:
	emu_pop(&emu_cx);
...
l__1E0D:
	...
	emu_ax = 0x22FD;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1E19); emu_cs = 0x1FB5; emu_File_Exists();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__1E19:
	emu_pop(&emu_cx);
...
l__20CA:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x20D2); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B8) { overlay(0x34B8, 1); }
l__20D2:
	emu_pop(&emu_cx);
...
l__21FA:
	...
	if (emu_get_memory16(emu_ds, 0x00, 0x38B2) == 0x0) goto l__221A;
	emu_ax = 0x1;
	emu_push(emu_ax);
