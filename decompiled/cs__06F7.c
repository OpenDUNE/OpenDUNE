...
l__014D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xE));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x10));
	emu_push(emu_cs); emu_push(0x0172); emu_cs = 0x16BC; emu_Unit_RemoveFromTeam();
l__0172:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_ax = 0xB;
...
l__03B8:
	...
	emu_push(emu_cs); emu_push(0x03C2); emu_cs = 0x2BB4; emu_Tools_Random_256();
l__03C2:
...
l__0452:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_cs); emu_push(0x0472); emu_cs = 0x1A34; emu_Unit_Deviate();
l__0472:
	emu_addw(&emu_sp, 0x6);
l__0475:
	emu_push(emu_ss);
