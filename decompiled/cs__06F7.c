...
l__030B:
	...
	emu_push(emu_cs); emu_push(0x031E); emu_cs = 0x34CD; overlay(0x34CD, 0); f__B4CD_1133_0039_A02F();
	goto l__031E;
l__031E:
	emu_pop(&emu_cx);
...
l__097B:
	...
	emu_si = emu_ax;
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0985); emu_cs = 0x34CD; overlay(0x34CD, 0); f__B4CD_1133_0039_A02F();
	goto l__0985;
l__0985:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_dx);
