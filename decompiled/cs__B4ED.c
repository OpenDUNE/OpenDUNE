...
l__0092:
	...
	emu_push(emu_cs); emu_push(0x00AE); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__00AE:
	emu_addw(&emu_sp, 0xA);
...
l__00DB:
	...
	emu_ax = 0x809A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0109); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0109:
	emu_addw(&emu_sp, 0xA);
...
l__0123:
	...
	emu_ax = 0x8088;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0139); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0139:
	emu_addw(&emu_sp, 0xA);
...
l__0194:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x01B1); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__01B1:
	emu_addw(&emu_sp, 0xE);
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x01CF); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__01CF:
	emu_addw(&emu_sp, 0xE);
...
l__02D6:
	...
	emu_ax = 0x5;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x02E0); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__02E0:
	emu_pop(&emu_cx);
...
l__0303:
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x030C); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__030C:
	emu_pop(&emu_cx);
...
l__04F2:
	...
	emu_push(emu_cs); emu_push(0x04FD); emu_cs = 0x01F7; emu_Tools_Divd();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__04FD:
...
l__052D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x1A));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x1C));
	emu_push(emu_cs); emu_push(0x0545); emu_cs = 0x01F7; emu_Tools_Divd();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0545:
	emu_get_memory16(emu_ss, emu_bp, -0x16) = emu_dx;
...
l__06BC:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x998C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x998A));
	emu_push(emu_cs); emu_push(0x06D8); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__06D8:
	emu_addw(&emu_sp, 0xA);
...
l__0A1D:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x0A38); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0A38:
	emu_addw(&emu_sp, 0xE);
	...
	emu_ax = 0x2620;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0A58); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0A58:
	emu_addw(&emu_sp, 0xE);
...
l__0C5D:
	...
	emu_push(emu_cs); emu_push(0x0C78); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0C78:
	emu_addw(&emu_sp, 0xE);
