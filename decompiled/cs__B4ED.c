...
l__00BB:
	...
	emu_push(emu_cs); emu_push(0x00D1); emu_cs = 0x2605; emu_Font_Select();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__00D1:
	emu_pop(&emu_cx);
...
l__0194:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x01B1); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__01B1:
	emu_addw(&emu_sp, 0xE);
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x01CF); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__01CF:
	emu_addw(&emu_sp, 0xE);
...
l__0506:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xC));
	emu_push(emu_cs); emu_push(0x0511); emu_cs = 0x352A; overlay(0x352A, 0); emu_WSA_GetFrameCount();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__0511:
	emu_pop(&emu_cx);
...
l__0522:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xC));
	emu_push(emu_cs); emu_push(0x052D); emu_cs = 0x352A; overlay(0x352A, 0); emu_WSA_GetFrameCount();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34ED) { overlay(0x34ED, 1); }
l__052D:
	emu_pop(&emu_cx);
