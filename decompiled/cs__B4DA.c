...
l__0B48:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x0B65); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__0B65:
	emu_addw(&emu_sp, 0xE);
...
l__0DE5:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x10));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xE));
	emu_push(emu_cs); emu_push(0x0E04); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__0E04:
	emu_addw(&emu_sp, 0xE);
...
l__1492:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x14B2); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__14B2:
	emu_addw(&emu_sp, 0xE);
...
l__17F1:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x1812); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__1812:
	emu_addw(&emu_sp, 0xE);
...
l__18B6:
	...
	emu_al = emu_get_memory8(emu_es, emu_bx, 0x0);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x18C5); emu_cs = 0x2521; emu_Font_GetWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__18C5:
	emu_pop(&emu_cx);
...
l__1901:
	...
	emu_al = emu_get_memory8(emu_es, emu_bx, 0x0);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1910); emu_cs = 0x2521; emu_Font_GetWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__1910:
	emu_pop(&emu_cx);
...
l__1A28:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x1A4A); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34DA) { overlay(0x34DA, 1); }
l__1A4A:
	emu_addw(&emu_sp, 0xE);
