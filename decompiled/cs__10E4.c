 ...
 * Called From: B511:0587:0008:250B
 */
...
l__0273:
	...
	emu_ax = 0x87D8;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x029C); emu_cs = 0x01F7; emu_String_sprintf_params();
l__029C:
	emu_addw(&emu_sp, 0xC);
 ...
 * Called From: 176C:2B5E:0008:A466
...
l__09AB:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x09DC); emu_cs = 0x01F7; emu_String_sprintf_params();
l__09DC:
	emu_addw(&emu_sp, 0xC);
l__09DF:
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0xA), 0xFFFF);
...
l__10A9:
	...
	emu_push(emu_cs); emu_push(0x10B2); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__10B2:
	emu_pop(&emu_cx);
...
l__12C4:
	emu_push(emu_ax);
l__12C5:
	emu_push(emu_cs); emu_push(0x12CA); emu_cs = 0x0FCB; emu_String_GetString();
l__12CA:
	emu_pop(&emu_cx);
...
l__13F9:
	...
	emu_ax = 0x31;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1418); emu_cs = 0x0FCB; emu_String_GetString();
l__1418:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__146F:
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1475); emu_cs = 0x0FCB; emu_String_GetString();
l__1475:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1491:
	...
	emu_ax = 0x55;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x14AE); emu_cs = 0x0FCB; emu_String_GetString();
l__14AE:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1581:
	...
	emu_push(emu_cs); emu_push(0x15C7); emu_cs = 0x0FCB; emu_String_GetString();
l__15C7:
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	emu_es = emu_dx;
...
l__18C6:
	...
	emu_ax = 0x2E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x18EA); emu_cs = 0x0FCB; emu_String_GetString();
l__18EA:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1964:
	...
	emu_ax = 0x59;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1983); emu_cs = 0x0FCB; emu_String_GetString();
l__1983:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1A36:
	...
	emu_ax = 0xA1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1A63); emu_cs = 0x0FCB; emu_String_GetString();
l__1A63:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1A70:
	...
	emu_ax = 0xA0;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1A8C); emu_cs = 0x0FCB; emu_String_GetString();
l__1A8C:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1B21:
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B27); emu_cs = 0x0FCB; emu_String_GetString();
l__1B27:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1CEF:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A02));
	emu_push(emu_cs); emu_push(0x1CF8); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__1CF8:
	emu_pop(&emu_cx);
...
l__2290:
	...
	emu_xorw(&emu_si, emu_si);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A02));
	emu_push(emu_cs); emu_push(0x22A2); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__22A2:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x8) = emu_ax;
