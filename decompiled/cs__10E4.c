...
l__1003:
	...
	if (emu_ax == emu_get_memory16(emu_ds, 0x00, 0x3A38)) { /* Unresolved jump */ emu_ip = 0x1010; emu_last_cs = 0x10E4; emu_last_ip = 0x1009; emu_last_length = 0x000D; emu_last_crc = 0x561B; emu_call(); return; }
	emu_ax = 0x1;
	goto l__1012;
l__1012:
	emu_get_memory16(emu_ss, emu_bp, -0x8) = emu_ax;
...
l__10A9:
	...
	emu_push(emu_cs); emu_push(0x10B2); emu_cs = 0x34CD; overlay(0x34CD, 0); f__B4CD_1133_0039_A02F();
	goto l__10B2;
l__10B2:
	emu_pop(&emu_cx);
...
l__15D6:
	...
	emu_cmpw(&emu_ax, 0x1);
	if (emu_ax == 0x1) { /* Unresolved jump */ emu_ip = 0x1629; emu_last_cs = 0x10E4; emu_last_ip = 0x15EF; emu_last_length = 0x0022; emu_last_crc = 0x5AFA; emu_call(); return; }
	emu_cmpw(&emu_ax, 0x2);
	if (emu_ax == 0x2) { /* Unresolved jump */ emu_ip = 0x15F8; emu_last_cs = 0x10E4; emu_last_ip = 0x15F4; emu_last_length = 0x0022; emu_last_crc = 0x5AFA; emu_call(); return; }
	goto l__1675;
l__1675:
	emu_bx = emu_si;
	emu_cl = 0x2;
...
l__18BA:
	...
	emu_ax = 0x64;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x18C6); emu_cs = 0x34C1; overlay(0x34C1, 0); f__B4C1_0129_0028_FB8E();
	goto l__18C6;
l__18C6:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__190B:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1922); emu_cs = 0x34C1; overlay(0x34C1, 0); f__B4C1_0129_0028_FB8E();
	goto l__1922;
l__1922:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__1ABE:
	...
	emu_push(emu_cs); emu_push(0x1ACD); emu_cs = 0x34C1; overlay(0x34C1, 0); f__B4C1_0129_0028_FB8E();
	goto l__1ACD;
l__1ACD:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__1C0F:
	...
	if (emu_ax == emu_get_memory16(emu_ds, 0x00, 0x38FE)) {
		emu_orw(&emu_di, emu_di);
		if (emu_di == 0) { /* Unresolved jump */ emu_ip = 0x1C28; emu_last_cs = 0x10E4; emu_last_ip = 0x1C23; emu_last_length = 0x001C; emu_last_crc = 0x840E; emu_call(); return; }
	}
	goto l__1C25;
l__1C25:
	emu_si = 0x8;
...
l__1CEF:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A02));
	emu_push(emu_cs); emu_push(0x1CF8); emu_cs = 0x34CD; overlay(0x34CD, 0); f__B4CD_1133_0039_A02F();
	goto l__1CF8;
l__1CF8:
	emu_pop(&emu_cx);
...
l__2290:
	...
	emu_xorw(&emu_si, emu_si);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A02));
	emu_push(emu_cs); emu_push(0x22A2); emu_cs = 0x34CD; overlay(0x34CD, 0); f__B4CD_1133_0039_A02F();
	goto l__22A2;
l__22A2:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_dx;
