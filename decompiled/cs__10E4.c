...
l__1140:
	emu_push(emu_cs);
	emu_push(0x1145); emu_GUI_Update97E5();
l__1145:
	goto l__1158;
l__1147:
	emu_get_memory16(emu_ss, emu_bp, -0x8) = 0x0;
...
l__12C4:
	emu_push(emu_ax);
l__12C5:
	emu_push(emu_cs); emu_push(0x12CA); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__12CA:
	emu_pop(&emu_cx);
...
l__13D0:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x6C91));
	emu_push(emu_cs); emu_push(0x13F9); emu_cs = 0x2903; emu_GUI_DrawSprite();
l__13F9:
	emu_addw(&emu_sp, 0xE);
	emu_ax = 0x11;
	emu_push(emu_ax);
	...
	emu_ax = 0x31;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1418); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__1418:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__146F:
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1475); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__1475:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1491:
	...
	emu_ax = 0x55;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x14AE); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__14AE:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1581:
	...
	emu_push(emu_cs); emu_push(0x15C7); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__15C7:
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	emu_es = emu_dx;
...
/**
 * Decompiled function emu_GUI_Update97E5()
 *
 * @name emu_GUI_Update97E5
