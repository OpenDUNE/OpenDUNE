 ...
 * @implements 0642:0AE6:0016:8598
 * @implements 0642:0AFC:000B:9D91
 * @implements 0642:0B07:0018:3136
 * @implements 0642:0B1F:0004:4A7F
 * @implements 0642:0B23:0009:8AB2
 * @implements 0642:0B2C:001D:FC53
 * @implements 0642:0B43:0006:7161
 * @implements 0642:0B49:0008:D9E5
 * @implements 0642:0B51:0007:CDE6
...
l__0AD2:
	...
	if (emu_get_memory16(emu_ds, 0x00, 0x6D8D) != 0x6) {
...
l__0B07:
	...
	emu_ax = 0xF;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0B1F); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__0B1F:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	goto l__0B43;
...
l__0B43:
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0B49); emu_cs = 0x2BC2; emu_GUI_DrawText();
l__0B49:
	emu_addw(&emu_sp, 0xC);
	emu_push(emu_cs); emu_push(0x0B51); emu_cs = 0x1DD7; emu_Driver_Music_IsPlaying();
l__0B51:
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax != 0) goto l__0B23;
l__0B55:
	emu_pop(&emu_si);
	emu_pop(&emu_bp);
