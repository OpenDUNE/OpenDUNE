...
void f__0642_000C_001A_AF29()
{
	...
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0026; emu_last_cs = 0x0642; emu_last_ip = 0x0021; emu_last_length = 0x001A; emu_last_crc = 0xAF29; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: 0642:00EA:000A:A0DD
 */
 ...
 *
 * Called From: 0642:00F4:000A:99DA
 */
 ...
 *
 * Called From: 0642:0101:000D:15EE
 */
 ...
 *
 * Called From: 0642:010D:000C:BC6B
 */
 ...
 *
 * Called From: 0642:0113:0006:E56C
 */
 ...
 *
 * Called From: 0642:011F:000C:CF74
 */
 ...
 *
 * Called From: 0642:012A:000B:70BA
 */
void f__0642_012A_0011_F8BB()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x013B); emu_cs = 0x3483; emu_ip = 0x0160; emu_last_cs = 0x0642; emu_last_ip = 0x0136; emu_last_length = 0x0011; emu_last_crc = 0xF8BB; emu_call(); // Jump does not resolve
 ...
 *
 * Called From: 0642:013B:0010:D43B
 */
 ...
 *
 * Called From: 0642:0147:000C:B04E
 */
 ...
 *
 * Called From: 0642:014F:0008:2A18
 */
 ...
 *
 * Called From: 0642:0158:0009:07B9
 */
 ...
 *
 * Called From: 0642:015E:0006:EAFC
 */
 ...
 *
 * Called From: 0642:0167:0009:B0F3
 */
 ...
 *
 * Called From: 0642:0171:000A:D6BC
 */
 ...
 *
 * Called From: 0642:0177:0006:E56C
 */
void f__0642_0177_0030_A2C8()
{
	...
	emu_push(emu_cs); emu_push(0x01A7); emu_cs = 0x34E9; emu_ip = 0x01D1; emu_last_cs = 0x0642; emu_last_ip = 0x01A2; emu_last_length = 0x0030; emu_last_crc = 0xA2C8; emu_call(); // Jump does not resolve
 ...
 *
 * Called From: 0642:01A7:0012:6F93
 */
 ...
 *
 * Called From: 0642:01AD:0005:F82B
 * Called From: 0642:01AD:0006:9C2A
 */
 ...
 *
 * Called From: 0642:01BC:000F:C47F
 */
 ...
 *
 * Called From: 0642:01CA:000E:F44C
 */
 ...
 *
 * Called From: 0642:01DB:0011:EBF0
 */
 ...
 *
 * Called From: 0642:01E8:000D:A777
 */
 ...
 *
 * Called From: 0642:01F3:000B:70BA
 */
void f__0642_01F3_0028_7517()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x021B); emu_cs = 0x0F78; emu_ip = 0x03CF; emu_last_cs = 0x0642; emu_last_ip = 0x0216; emu_last_length = 0x0028; emu_last_crc = 0x7517; emu_call(); // Jump does not resolve
 ...
 *
 * Called From: 0642:021B:0012:4ECE
 */
 ...
 *
 * Called From: 0642:0225:000A:0B5A
 */
void f__0642_0225_0011_537A()
{
	...
	emu_ip = 0x0306; emu_last_cs = 0x0642; emu_last_ip = 0x0233; emu_last_length = 0x0011; emu_last_crc = 0x537A; emu_call(); // Jump does not resolve
}
...
void f__0642_022C_000A_93B9()
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6D8D), 0x4);
	if (!emu_flags.zf) { f__0642_0236_000A_17BC(); return; }
	emu_ip = 0x0306; emu_last_cs = 0x0642; emu_last_ip = 0x0233; emu_last_length = 0x000A; emu_last_crc = 0x93B9; emu_call(); // Jump does not resolve
}
...
void f__0642_0236_000A_17BC()
{
	...
	emu_ip = 0x0306; emu_last_cs = 0x0642; emu_last_ip = 0x023D; emu_last_length = 0x000A; emu_last_crc = 0x17BC; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: 0642:0245:0005:7A4B
 */
void f__0642_0245_0007_AEBB()
{
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { f__0642_024C_0005_2EF2(); return; }
	emu_ip = 0x0306; emu_last_cs = 0x0642; emu_last_ip = 0x0249; emu_last_length = 0x0007; emu_last_crc = 0xAEBB; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: 0642:0251:0005:2EF2
 */
void f__0642_0251_0007_AEBE()
{
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { f__0642_0258_0010_94D1(); return; }
	emu_ip = 0x0306; emu_last_cs = 0x0642; emu_last_ip = 0x0255; emu_last_length = 0x0007; emu_last_crc = 0xAEBE; emu_call(); // Jump does not resolve
}
...
void f__0642_0258_0010_94D1()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0268); emu_cs = 0x3483; emu_ip = 0x028D; emu_last_cs = 0x0642; emu_last_ip = 0x0263; emu_last_length = 0x0010; emu_last_crc = 0x94D1; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: 0642:0285:0013:DFDC
 */
 ...
 *
 * Called From: 0642:0290:000B:69BA
 */
...
void f__0642_02AE_0027_9BAA()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0306; emu_last_cs = 0x0642; emu_last_ip = 0x02C6; emu_last_length = 0x0027; emu_last_crc = 0x9BAA; emu_call(); return; } // Jump does not resolve
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x02D0; emu_last_cs = 0x0642; emu_last_ip = 0x02C8; emu_last_length = 0x0027; emu_last_crc = 0x9BAA; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x31BC));
	if ((emu_flags.cf || emu_flags.zf)) { f__0642_0306_0008_64F7(); return; }
	emu_push(emu_cs); emu_push(0x02D5); emu_cs = 0x1DD7; emu_ip = 0x0B5F; emu_last_cs = 0x0642; emu_last_ip = 0x02D0; emu_last_length = 0x0027; emu_last_crc = 0x9BAA; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: 0642:030E:0008:64F7
 */
...
void f__0642_031C_0012_D4EA()
{
	...
	emu_ip = 0x03DC; emu_last_cs = 0x0642; emu_last_ip = 0x032B; emu_last_length = 0x0012; emu_last_crc = 0xD4EA; emu_call(); // Jump does not resolve
}
...
void f__0642_0335_002B_2F1D()
{
	...
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0377; emu_last_cs = 0x0642; emu_last_ip = 0x0349; emu_last_length = 0x002B; emu_last_crc = 0x2F1D; emu_call(); return; } // Jump does not resolve
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0353; emu_last_cs = 0x0642; emu_last_ip = 0x034B; emu_last_length = 0x002B; emu_last_crc = 0x2F1D; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: 0642:0360:002B:2F1D
 */
 ...
 *
 * Called From: 0642:038F:002F:5F80
 * Called From: 0642:038F:0018:8AC7
 */
 ...
 *
 * Called From: 0642:0398:0009:3ADE
 */
 ...
 *
 * Called From: 0642:03A5:0008:DF89
 * Called From: 0642:03A5:000D:7292
 */
 ...
 *
 * Called From: 0642:03AE:0009:BE77
 */
 ...
 *
 * Called From: 0642:03BB:000D:DD0B
 */
 ...
 *
 * Called From: 0642:03C2:0007:BB52
 */
 ...
 *
 * Called From: 0642:03C7:0005:BF6B
 */
 ...
 *
 * Called From: 0642:03CC:0005:F04C
 */
 ...
 *
 * Called From: 0642:03D1:0005:ED74
 */
 ...
 *
 * Called From: 0642:03D9:0008:75E4
 */
 ...
 *
 * Called From: 0642:03EC:000E:F2B7
 */
void f__0642_03EC_0016_21F1()
{
	emu_addws(&emu_sp, 0x6);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x38F8), 0x0);
	if (emu_flags.zf) { emu_ip = 0x0405; emu_last_cs = 0x0642; emu_last_ip = 0x03F4; emu_last_length = 0x0016; emu_last_crc = 0x21F1; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x37A0), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x0405; emu_last_cs = 0x0642; emu_last_ip = 0x03FB; emu_last_length = 0x0016; emu_last_crc = 0x21F1; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: 0642:0402:0016:21F1
 */
 ...
 *
 * Called From: 0642:0414:0005:6168
 */
void f__0642_0414_0014_A716()
{
	...
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0428); emu_cs = 0x257A; emu_ip = 0x0435; emu_last_cs = 0x0642; emu_last_ip = 0x0423; emu_last_length = 0x0014; emu_last_crc = 0xA716; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: 0642:0430:0005:6168
 */
 ...
 *
 * Called From: 0642:0438:0008:F5FA
 */
 ...
 *
 * Called From: 0642:0442:000A:426B
 */
 ...
 *
 * Called From: 0642:044D:000B:7BE4
 */
 ...
 *
 * Called From: 0642:0471:0024:22E8
 */
...
void f__0642_0491_0018_2263()
{
	...
	if (emu_flags.zf) { emu_ip = 0x04A9; emu_last_cs = 0x0642; emu_last_ip = 0x04A0; emu_last_length = 0x0018; emu_last_crc = 0x2263; emu_call(); return; } // Jump does not resolve
	emu_addws(&emu_bx.x, 0x2);
	if (--emu_cx.x != 0) { f__0642_049A_000F_4EEF(); return; }
	emu_ip = 0x04EA; emu_last_cs = 0x0642; emu_last_ip = 0x04A7; emu_last_length = 0x0018; emu_last_crc = 0x2263; emu_call(); // Jump does not resolve
}
...
void f__0642_0559_0027_3560()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0574; emu_last_cs = 0x0642; emu_last_ip = 0x056C; emu_last_length = 0x0027; emu_last_crc = 0x3560; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: 0642:05B7:0026:A299
 * Called From: 0642:05B7:0028:2879
 * Called From: 0642:05B7:002B:2BAE
 */
 ...
 *
 * Called From: 0642:05C7:0010:2CA3
 */
void f__0642_05C7_0031_5A24()
{
	...
	emu_ip = 0x06D4; emu_last_cs = 0x0642; emu_last_ip = 0x05F5; emu_last_length = 0x0031; emu_last_crc = 0x5A24; emu_call(); // Jump does not resolve
}
...
{
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0603; emu_last_cs = 0x0642; emu_last_ip = 0x05F8; emu_last_length = 0x000B; emu_last_crc = 0xA38F; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x76AC));
 ...
 *
 * Called From: 0642:0622:0015:23C1
 */
 ...
 *
 * Called From: 0642:063A:0018:8149
 */
 ...
 *
 * Called From: 0642:0652:0018:8149
 */
 ...
 *
 * Called From: 0642:066A:0018:8149
 */
void f__0642_066A_0016_3765()
{
	emu_addws(&emu_sp, 0x8);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (!emu_flags.zf) { f__0642_06B1_000D_A409(); return; }
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x38EC), 0x0);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x06AB; emu_last_cs = 0x0642; emu_last_ip = 0x06A1; emu_last_length = 0x000F; emu_last_crc = 0x7F87; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: 0642:06BE:000D:A409
 */
void f__0642_06BE_0040_399F()
{
	...
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x76AE));
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0755; emu_last_cs = 0x0642; emu_last_ip = 0x06DF; emu_last_length = 0x0040; emu_last_crc = 0x399F; emu_call(); return; } // Jump does not resolve
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x06E9; emu_last_cs = 0x0642; emu_last_ip = 0x06E1; emu_last_length = 0x0040; emu_last_crc = 0x399F; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x76AC));
...
void f__0642_06D4_002A_1932()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x06E9; emu_last_cs = 0x0642; emu_last_ip = 0x06E1; emu_last_length = 0x002A; emu_last_crc = 0x1932; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x76AC));
	if (!emu_flags.cf) { f__0642_0755_0005_2EF2(); return; }
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x31D6));
	emu_movw(&emu_ax.x, 0xDF);
 ...
 *
 * Called From: 0642:06FE:002A:1932
 * Called From: 0642:06FE:0040:399F
 */
 ...
 *
 * Called From: 0642:0716:0018:8129
 */
void f__0642_0716_0016_04B0()
{
	emu_addws(&emu_sp, 0x8);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (!emu_flags.zf) { f__0642_0732_000D_A409(); return; }
 ...
 *
 * Called From: 0642:073F:000D:A409
 * Called From: 0642:073F:0013:43D9
 */
 ...
 *
 * Called From: 0642:075A:001B:0AF9
 * Called From: 0642:075A:0005:2EF2
 */
...
void f__0642_075D_0011_C164()
{
	...
	emu_xorw(&emu_dx.x, emu_dx.x);
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_ip = 0x07BC; emu_last_cs = 0x0642; emu_last_ip = 0x076C; emu_last_length = 0x0011; emu_last_crc = 0xC164; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: 0642:0782:0014:FFCC
 */
 ...
 *
 * Called From: 0642:0799:0017:3AC1
 */
 ...
 *
 * Called From: 0642:07B2:0019:BAF4
 */
...
void f__0642_0AD2_002A_8B98()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0AE6; emu_last_cs = 0x0642; emu_last_ip = 0x0ADD; emu_last_length = 0x002A; emu_last_crc = 0x8B98; emu_call(); return; } // Jump does not resolve
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0AFC); emu_cs = 0x1DD7; emu_ip = 0x1215; emu_last_cs = 0x0642; emu_last_ip = 0x0AF7; emu_last_length = 0x002A; emu_last_crc = 0x8B98; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
