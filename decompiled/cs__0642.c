...
l__003B:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x006A); emu_cs = 0x01F7; emu_Tools_Memcopy();
...
l__0098:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00C7); emu_cs = 0x01F7; emu_Tools_Memcopy();
...
l__076E:
	...
	emu_ax = 0x8282;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0782); emu_cs = 0x01F7; emu_Tools_Memcopy();
l__0782:
	emu_addw(&emu_sp, 0xA);
	...
	emu_ax = 0x8282;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0799); emu_cs = 0x01F7; emu_String_strcat();
l__0799:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_ds);
	...
	emu_ax = 0x8282;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x07B2); emu_cs = 0x01F7; emu_String_strcat();
l__07B2:
	emu_addw(&emu_sp, 0x8);
	emu_dx = emu_ds;
	emu_ax = 0x8282;
