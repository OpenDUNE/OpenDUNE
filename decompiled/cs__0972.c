...
l__0A98:
	...
	emu_push(emu_cs); emu_push(0x0AAA); emu_cs = 0x0C10; emu_Object_GetScriptVariable4();
l__0AAA:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__0AB4:
	...
	emu_push(emu_cs); emu_push(0x0AC6); emu_cs = 0x0C10; emu_Object_GetScriptVariable4();
l__0AC6:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
