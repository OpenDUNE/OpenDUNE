...
l__0119:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x012B); emu_cs = 0x1082; emu_Structure_FindFirst();
l__012B:
	emu_addw(&emu_sp, 0x8);
	goto l__0A50;
l__0131:
...
l__017A:
	...
	if (emu_get_memory16(emu_es, emu_bx, 0x50) == 0x0) goto l__01BB;
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x8434));
	...
	if (emu_ax != emu_get_memory16(emu_ds, 0x00, 0x3A3C)) goto l__01BB;
	emu_cmpw(&emu_dx, emu_get_memory16(emu_ds, 0x00, 0x3A3A));
	if (emu_dx != emu_get_memory16(emu_ds, 0x00, 0x3A3A)) goto l__01BB;
	emu_ax = 0x1;
	emu_push(emu_ax);
...
l__0315:
	...
	emu_push(emu_cs); emu_push(0x0326); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__0326:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
	...
	emu_push(emu_cs); emu_push(0x0338); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__0338:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__0475:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x8430));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x10));
	emu_push(emu_cs); emu_push(0x048A); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__048A:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__04BD:
	...
	emu_push(emu_cs); emu_push(0x04D0); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__04D0:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_push(emu_cs); emu_push(0x04E4); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__04E4:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x10) = emu_ax;
...
l__0644:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8436));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8434));
	emu_push(emu_cs); emu_push(0x0651); emu_cs = 0x1A34; emu_Unit_GetLinkedStructure();
l__0651:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__06E1:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x1A));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x1C));
	emu_push(emu_cs); emu_push(0x0712); emu_cs = 0x1082; emu_Structure_Free();
l__0712:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
l__0714:
...
l__0796:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x8430));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x10));
	emu_push(emu_cs); emu_push(0x07AB); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__07AB:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_di = emu_ax;
l__07AF:
	...
	emu_push(emu_cs); emu_push(0x07BC); emu_cs = 0x1A34; emu_Structure_GetLinkedUnit();
l__07BC:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	...
	emu_push(emu_ax);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x07E2); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__07E2:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__09CB:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8436));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x09DB); emu_cs = 0x15C2; emu_Script_Run();
l__09DB:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__09E4:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8436));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x09F4); emu_cs = 0x15C2; emu_Script_Run();
l__09F4:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__09FE:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8436));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0A1A); emu_cs = 0x15C2; emu_Script_Reset();
l__0A1A:
	emu_addw(&emu_sp, 0x8);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x8434));
	emu_al = emu_get_memory8(emu_es, emu_bx, 0x2);
...
l__0A44:
	...
	emu_movw(&emu_ax, emu_bp - 0xE);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0A4E); emu_cs = 0x1082; emu_Structure_FindNext();
l__0A4E:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
l__0A50:
...
l__0B46:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3950));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x394E));
	emu_push(emu_cs); emu_push(0x0B58); emu_cs = 0x1A34; emu_Structure_GetLinkedUnit();
l__0B58:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
...
l__13D3:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x8430));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x10));
	emu_push(emu_cs); emu_push(0x13EF); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__13EF:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
	...
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1400); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__1400:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
