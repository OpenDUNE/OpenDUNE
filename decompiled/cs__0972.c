...
void f__0972_017A_0040_F4EB()
{
	...
	/* Unresolved jump */ emu_ip = 0x01BA; emu_last_cs = 0x0972; emu_last_ip = 0x01B5; emu_last_length = 0x0040; emu_last_crc = 0xF4EB; emu_call();
}
...
void f__0972_0420_001A_C1B0()
{
	...
	/* Unresolved jump */ emu_ip = 0x043A; emu_last_cs = 0x0972; emu_last_ip = 0x0435; emu_last_length = 0x001A; emu_last_crc = 0xC1B0; emu_call();
}
...
void f__0972_06E1_0031_1FDA()
{
	...
	/* Unresolved jump */ emu_ip = 0x0712; emu_last_cs = 0x0972; emu_last_ip = 0x070D; emu_last_length = 0x0031; emu_last_crc = 0x1FDA; emu_call();
}
...
void f__0972_08B2_0038_5CE7()
{
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x394A));
	emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x12), 0x0);
	if (emu_flags.zf) { f__0972_08EF_002F_F6E4(); return; }
	emu_xorw(&emu_ax, emu_ax);
...
void f__0972_0F3D_0036_4859()
{
	...
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__0972_0FC3_000B_799F(); return; }
	...
	/* Unresolved jump */ emu_ip = 0x0F73; emu_last_cs = 0x0972; emu_last_ip = 0x0F6E; emu_last_length = 0x0036; emu_last_crc = 0x4859; emu_call();
}
...
void f__0972_11B9_0020_8DC9()
{
	...
	f__0972_11D9_000B_0103(); return;
}

/**
 * Decompiled function f__0972_11D9_000B_0103()
 *
 * @name f__0972_11D9_000B_0103
 * @implements 0972:11D9:000B:0103 ()
 *
 */
void f__0972_11D9_000B_0103()
{
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x1215; emu_last_cs = 0x0972; emu_last_ip = 0x11DC; emu_last_length = 0x000B; emu_last_crc = 0x0103; emu_call(); return; }
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x11E4); emu_cs = 0x167E; f__167E_0088_001A_60ED();
	f__0972_11E4_000C_47C7(); return;
}

/**
 * Decompiled function f__0972_11E4_000C_47C7()
 *
 * @name f__0972_11E4_000C_47C7
 * @implements 0972:11E4:000C:47C7 ()
 *
 */
void f__0972_11E4_000C_47C7()
{
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0x2);
	if (!emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x1215; emu_last_cs = 0x0972; emu_last_ip = 0x11E8; emu_last_length = 0x000C; emu_last_crc = 0x47C7; emu_call(); return; }
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x11F0); emu_cs = 0x167E; f__167E_0284_000C_4C88();
	f__0972_11F0_0012_15D4(); return;
}

/**
 * Decompiled function f__0972_11F0_0012_15D4()
 *
 * @name f__0972_11F0_0012_15D4
 * @implements 0972:11F0:0012:15D4 ()
 *
 */
void f__0972_11F0_0012_15D4()
{
	emu_pop(&emu_cx);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_dx);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	...
	f__0972_1202_0017_9738(); return;
}

/**
 * Decompiled function f__0972_1202_0017_9738()
 *
 * @name f__0972_1202_0017_9738
 * @implements 0972:1202:0017:9738 ()
 *
 */
void f__0972_1202_0017_9738()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x1215; emu_last_cs = 0x0972; emu_last_ip = 0x120A; emu_last_length = 0x0017; emu_last_crc = 0x9738; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_movw(&emu_get_memory16(emu_es, emu_bx, 0x56), 0x0);
	emu_xorw(&emu_ax, emu_ax);
	f__0972_1219_0005_8BCF(); return;
}

/**
 * Decompiled function f__0972_1219_0005_8BCF()
 *
 * @name f__0972_1219_0005_8BCF
 * @implements 0972:1219:0005:8BCF ()
 *
 * Called From: 0972:1217:0017:9738
 */
void f__0972_1219_0005_8BCF()
{
	emu_pop(&emu_si);
	emu_movw(&emu_sp, emu_bp);
	emu_pop(&emu_bp);
...
void f__0972_124E_0019_3598()
{
	...
	/* Unresolved jump */ emu_ip = 0x1267; emu_last_cs = 0x0972; emu_last_ip = 0x1262; emu_last_length = 0x0019; emu_last_crc = 0x3598; emu_call();
}
...
void f__0972_1708_0010_9DFE()
{
	...
	/* Unresolved jump */ emu_ip = 0x1718; emu_last_cs = 0x0972; emu_last_ip = 0x1713; emu_last_length = 0x0010; emu_last_crc = 0x9DFE; emu_call();
}
