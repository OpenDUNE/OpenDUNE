...
/**
 * Decompiled function f__0972_0A69_0007_C3F1()
 *
 * @name f__0972_0A69_0007_C3F1
 * @implements 0972:0A69:0007:C3F1 ()
 * @implements 0972:0A70:0002:2597
 *
 * Called From: 15C2:0932:003A:D1E0
 */
void f__0972_0A69_0007_C3F1()
{
l__0A69:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
l__114F:
	...
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x116F); emu_cs = 0x167E; f__167E_0005_0013_AF0C();
l__116F:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
	...
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x117A); emu_cs = 0x167E; f__167E_01BB_0010_85F6();
l__117A:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1708:
	...
	emu_ax = 0x85;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1718); emu_cs = 0x0FCB; emu_String_GetString();
	/* Unresolved jump */ emu_ip = 0x1718; emu_last_cs = 0x0972; emu_last_ip = 0x1718; emu_last_length = 0x0010; emu_last_crc = 0x9DFE; emu_call();
l__1745:
	emu_ax = 0x85;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x174E); emu_cs = 0x0FCB; emu_String_GetString();
l__174E:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	...
	emu_push(emu_cs); emu_push(0x175E); emu_cs = 0x0FCB; emu_String_GetString();
l__175E:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
