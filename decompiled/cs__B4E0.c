...
l__0000:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x000F); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
...
l__005C:
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x006B); emu_cs = 0x29DA; emu_GUI_Widget_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__006B:
	emu_pop(&emu_cx);
...
l__0094:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00B4); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__00B4:
...
l__00CF:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00D8); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__00D8:
	emu_pop(&emu_cx);
...
l__0141:
	...
	emu_push(emu_cs); emu_push(0x014A); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__014A:
	emu_pop(&emu_cx);
...
l__01B3:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x01CE); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__01CE:
	emu_addw(&emu_sp, 0x6);
...
l__01EF:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x020A); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__020A:
	emu_addw(&emu_sp, 0x6);
...
l__026F:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0283); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0283:
	emu_addw(&emu_sp, 0x6);
...
l__0ADB:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x804D));
	emu_push(emu_cs);
	emu_push(0x0AE8); emu_String_NextString();
l__0AE8:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ds, 0x00, 0x804F) = emu_dx;
...
l__0B15:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x804D));
	emu_push(emu_cs);
	emu_push(0x0B22); emu_String_PrevString();
l__0B22:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ds, 0x00, 0x804F) = emu_dx;
...
l__0C0F:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0CB9); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Link();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0CB9:
	emu_addw(&emu_sp, 0x8);
...
l__0CE2:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0CF3); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeInvisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0CF3:
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0D00); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeInvisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0D00:
	emu_pop(&emu_cx);
...
l__0D2B:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0D4A); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Link();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0D4A:
	emu_addw(&emu_sp, 0x8);
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0D71); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0D71:
	emu_addw(&emu_sp, 0x6);
...
l__0DA8:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0DE6); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Link();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0DE6:
	emu_addw(&emu_sp, 0x8);
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0E08); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0E08:
	emu_addw(&emu_sp, 0x6);
...
l__0E3F:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0E7D); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Link();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0E7D:
	emu_addw(&emu_sp, 0x8);
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802C));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x802A));
	emu_push(emu_cs); emu_push(0x0E9C); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Link();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0E9C:
	emu_addw(&emu_sp, 0x8);
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8028));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8026));
	emu_push(emu_cs); emu_push(0x0EB3); emu_cs = 0x34A2; overlay(0x34A2, 0); emu_GUI_Widget_Draw();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E0) { overlay(0x34E0, 1); }
l__0EB3:
	emu_pop(&emu_cx);
