...
l__0160:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0168); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0168:
	emu_addw(&emu_sp, 0xE);
...
l__0191:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0199); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0199:
	emu_addw(&emu_sp, 0xE);
...
l__03A4:
	...
	emu_ax = 0x2C3E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x03C7); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__03C7:
	emu_addw(&emu_sp, 0x10);
...
l__0485:
	...
	emu_ax = 0x2C3E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x04A8); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__04A8:
	emu_addw(&emu_sp, 0x10);
...
l__05DB:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x05F3); emu_cs = 0x1FB5; emu_File_WriteBlock();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__05F3:
	emu_addw(&emu_sp, 0xA);
...
l__07FB:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x0813); emu_cs = 0x1FB5; emu_File_WriteBlock();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0813:
	emu_addw(&emu_sp, 0xA);
...
l__094B:
	...
	emu_ax = 0x64;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x095E); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Window_Widget_Allocate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__095E:
	emu_addw(&emu_sp, 0xE);
...
l__09C2:
	...
	emu_ax = 0x65;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x09D5); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Window_Widget_Allocate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__09D5:
	emu_addw(&emu_sp, 0xE);
...
l__0AB9:
	...
	emu_ax = 0x2C41;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0AC6); emu_cs = 0x1FB5; emu_File_Exists();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0AC6:
	emu_pop(&emu_cx);
...
l__0E2D:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x0E50); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0E50:
	emu_addw(&emu_sp, 0xE);
...
l__0E8C:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0EAA); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0EAA:
	emu_addw(&emu_sp, 0xE);
 ...
 * @implements B518:107C:000A:79CC
 * @implements B518:1086:000E:30F0
 * @implements B518:108C:0008:8339
