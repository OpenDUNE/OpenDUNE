...
void f__B518_085A_0014_A312()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x81E6), 0x0);
...
{
	emu_addws(&emu_sp, 0xC);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x81EB), 0x3C);
