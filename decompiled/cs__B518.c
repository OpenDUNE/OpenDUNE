...
l__007C:
	...
	emu_ax = 0x1A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x008B); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__008B:
	emu_pop(&emu_cx);
...
l__0093:
	...
	emu_ax = 0x18;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00A3); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__00A3:
	emu_pop(&emu_cx);
...
l__00AB:
	...
	emu_ax = 0x19;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00C2); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__00C2:
	emu_pop(&emu_cx);
...
l__00CD:
	emu_ax = 0x149;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00D6); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__00D6:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00DE); emu_cs = 0x2521; emu_Font_GetStringWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__00DE:
	emu_pop(&emu_cx);
	...
	emu_ax = 0x14A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00EA); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__00EA:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00F2); emu_cs = 0x2521; emu_Font_GetStringWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__00F2:
	emu_pop(&emu_cx);
	...
	emu_ax = 0x149;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0102); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
...
l__010E:
	emu_ax = 0x14A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0117); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0117:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x011F); emu_cs = 0x2521; emu_Font_GetStringWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__011F:
	emu_pop(&emu_cx);
...
l__013A:
	...
	emu_ax = 0x149;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0160); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0160:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0168); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0168:
	emu_addw(&emu_sp, 0xE);
	...
	emu_ax = 0x14A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0191); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0191:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0199); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0199:
	emu_addw(&emu_sp, 0xE);
...
l__03A4:
	...
	emu_ax = 0x2C3E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x03C7); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__03C7:
	emu_addw(&emu_sp, 0x10);
...
l__0485:
	...
	emu_ax = 0x2C3E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x04A8); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__04A8:
	emu_addw(&emu_sp, 0x10);
...
l__058B:
	emu_ax = 0x5;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0594); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0594:
	emu_pop(&emu_cx);
...
l__06CD:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x071C); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__071C:
	emu_addw(&emu_sp, 0xE);
...
l__0D20:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D28); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0D28:
	emu_addw(&emu_sp, 0x10);
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D48); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0D48:
	emu_addw(&emu_sp, 0xE);
...
l__0D67:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D6F); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0D6F:
	emu_addw(&emu_sp, 0xE);
...
l__0D91:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D99); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0D99:
	emu_addw(&emu_sp, 0x10);
...
l__0E2D:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x0E50); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0E50:
	emu_addw(&emu_sp, 0xE);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0E5E); emu_cs = 0x2521; emu_Font_GetStringWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0E5E:
	emu_pop(&emu_cx);
...
l__0E8C:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0EAA); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0EAA:
	emu_addw(&emu_sp, 0xE);
...
l__0EE6:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0EEE); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__0EEE:
	emu_addw(&emu_sp, 0xE);
...
l__11F9:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x1217); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__1217:
	emu_addw(&emu_sp, 0xE);
...
l__128F:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1297); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__1297:
	emu_addw(&emu_sp, 0xE);
...
l__12B2:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x12BA); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__12BA:
	emu_addw(&emu_sp, 0xE);
...
l__12D5:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x12DD); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__12DD:
	emu_addw(&emu_sp, 0xE);
...
l__13F8:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1412); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__1412:
	emu_addw(&emu_sp, 0xE);
l__1415:
	...
	emu_ax = 0x2C5A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1430); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__1430:
	emu_addw(&emu_sp, 0x10);
	...
	emu_ax = 0x2C3E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1453); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__1453:
	emu_addw(&emu_sp, 0x10);
	...
	emu_ax = 0x2C3E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1476); emu_cs = 0x10E4; emu_GUI_DrawText();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3518) { overlay(0x3518, 1); }
l__1476:
	emu_addw(&emu_sp, 0x10);
