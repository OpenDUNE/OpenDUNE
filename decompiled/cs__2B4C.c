...
void f__2B4C_00A4_000C_B454()
{
	...
	if (!emu_flags.cf) { f__2B4C_00B0_000E_CC99(); return; }
...
void f__2B4C_0120_000C_B4F5()
{
	...
	emu_cmpw(&emu_ax, emu_bx);
	if (!emu_flags.cf) { f__2B4C_012C_000E_CC99(); return; }
