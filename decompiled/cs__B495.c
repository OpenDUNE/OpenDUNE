...
l__0000:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0022); emu_cs = 0x2B0E; emu_Tools_Memmove();
...
l__0022:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0045); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0045:
	emu_pop(&emu_cx);
...
l__0060:
	...
	emu_push(emu_cs); emu_push(0x006C); emu_cs = 0x10E4; emu_GUI_DrawCredits();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__006C:
	emu_pop(&emu_cx);
...
l__0076:
	...
	emu_push(emu_cs); emu_push(0x0084); emu_cs = 0x34A2; overlay(0x34A2, 0); emu_GUI_Widget_HandleEvents();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0084:
	emu_pop(&emu_cx);
...
l__0096:
	...
	emu_pop(&emu_cx);
l__0098:
	emu_push(emu_cs); emu_push(0x009D); emu_cs = 0x0642; emu_GUI_PaletteAnimate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__009D:
	...
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A38));
	emu_push(emu_cs); emu_push(0x00B1); emu_cs = 0x10E4; emu_GUI_DrawCredits();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__00B1:
	emu_pop(&emu_cx);
	...
	emu_push(emu_cs); emu_push(0x00BB); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__00BB:
	emu_pop(&emu_cx);
...
l__00C1:
	...
	emu_movw(&emu_ax, emu_bp - 0x6);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00DD); emu_cs = 0x2B0E; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__00DD:
	emu_addw(&emu_sp, 0xC);
...
l__01B1:
	...
	emu_push(emu_cs); emu_push(0x01BF); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__01BF:
	emu_addw(&emu_sp, 0x6);
...
l__026E:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x027C); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__027C:
	emu_addw(&emu_sp, 0x6);
...
l__0288:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x02A7); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeInvisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__02A7:
	emu_pop(&emu_cx);
...
l__02AE:
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x02B9); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeVisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__02B9:
	emu_pop(&emu_cx);
...
l__02F1:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x02FF); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__02FF:
	emu_addw(&emu_sp, 0x6);
...
l__035D:
	...
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A38));
	emu_push(emu_cs); emu_push(0x036D); emu_cs = 0x10E4; emu_GUI_DrawCredits();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__036D:
	emu_pop(&emu_cx);
...
l__0376:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x038C); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__038C:
	emu_addw(&emu_sp, 0x6);
...
l__0398:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x03A9); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__03A9:
	emu_addw(&emu_sp, 0x6);
...
l__03E4:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x03F8); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__03F8:
	emu_addw(&emu_sp, 0x6);
...
l__0471:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0485); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0485:
	emu_addw(&emu_sp, 0x6);
...
l__04D7:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x04E5); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeInvisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__04E5:
	emu_pop(&emu_cx);
...
l__04EC:
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x04F7); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeVisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__04F7:
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0507); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0507:
	emu_addw(&emu_sp, 0x6);
...
l__0511:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0522); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0522:
	emu_pop(&emu_cx);
...
l__0544:
	...
	emu_ax = 0xB6;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0570); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0570:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0578); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0578:
	emu_addw(&emu_sp, 0xE);
...
l__05B8:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x05E8); emu_cs = 0x01F7; emu_String_sprintf();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__05E8:
	emu_addw(&emu_sp, 0xC);
	...
	emu_push(emu_cs); emu_push(0x060B); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__060B:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0613); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0613:
	emu_addw(&emu_sp, 0xE);
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x062C); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__062C:
	emu_pop(&emu_cx);
...
l__0659:
	...
	emu_ax = 0xB5;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0675); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0675:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x067D); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__067D:
	emu_addw(&emu_sp, 0xE);
...
l__06BF:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x06D4); emu_cs = 0x01F7; emu_String_sprintf();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__06D4:
	emu_addw(&emu_sp, 0xA);
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x06E1); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__06E1:
	emu_pop(&emu_cx);
	...
	emu_ax = 0xB8;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x070F); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__070F:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0717); emu_cs = 0x10E4; emu_GUI_DrawText_Wrapper();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0717:
	emu_addw(&emu_sp, 0xE);
...
l__073E:
	...
	emu_ax = 0x10;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0762); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0762:
...
l__076A:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0772); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0772:
	emu_pop(&emu_cx);
...
l__078D:
	...
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A38));
	emu_push(emu_cs); emu_push(0x0799); emu_cs = 0x10E4; emu_GUI_DrawCredits();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__0799:
	emu_pop(&emu_cx);
...
l__07A3:
	emu_pop(&emu_cx);
	emu_push(emu_cs); emu_push(0x07A9); emu_cs = 0x0642; emu_GUI_PaletteAnimate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__07A9:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x7FA4));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x7FA2));
	emu_push(emu_cs); emu_push(0x07B6); emu_cs = 0x34A2; overlay(0x34A2, 0); emu_GUI_Widget_HandleEvents();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__07B6:
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_cs); emu_push(0x07C4); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__07C4:
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x7FA4));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x7FA2));
	emu_push(emu_cs); emu_push(0x07D6); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__07D6:
	emu_addw(&emu_sp, 0x6);
...
l__125B:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x126C); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__126C:
	emu_pop(&emu_cx);
...
l__12AE:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x12D6); emu_cs = 0x2903; emu_GUI_DrawSprite();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__12D6:
	emu_addw(&emu_sp, 0xE);
	...
	emu_push(emu_di);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_cs); emu_push(0x1322); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1322:
	emu_addw(&emu_sp, 0x10);
	...
	emu_push(emu_di);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_cs); emu_push(0x1345); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1345:
	emu_addw(&emu_sp, 0x10);
...
l__13C8:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x7FA4));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x7FA2));
	emu_push(emu_cs); emu_push(0x13DB); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__13DB:
	emu_addw(&emu_sp, 0x6);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x13E5); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeInvisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__13E5:
	emu_pop(&emu_cx);
...
l__140C:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1459); emu_cs = 0x2903; emu_GUI_DrawSprite();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1459:
	emu_addw(&emu_sp, 0x14);
...
l__145E:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1490); emu_cs = 0x2903; emu_GUI_DrawSprite();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1490:
	emu_addw(&emu_sp, 0xE);
...
l__14D5:
	...
	emu_push(emu_cs); emu_push(0x14FB); emu_cs = 0x352A; overlay(0x352A, 0); emu_WSA_DisplayFrame();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__14FB:
	emu_addw(&emu_sp, 0xE);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x1509); emu_cs = 0x352A; overlay(0x352A, 0); emu_WSA_Unload();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1509:
	emu_pop(&emu_cx);
...
l__1510:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1530); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1530:
	emu_addw(&emu_sp, 0x10);
...
l__1572:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x157A); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__157A:
	emu_pop(&emu_cx);
...
l__157F:
	...
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A38));
	emu_push(emu_cs); emu_push(0x158C); emu_cs = 0x10E4; emu_GUI_DrawCredits();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__158C:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_cs); emu_push(0x1596); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1596:
	emu_pop(&emu_cx);
...
l__1699:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x6));
	emu_push(emu_cs); emu_push(0x16A5); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__16A5:
	emu_pop(&emu_cx);
 ...
 * @implements B495:197C:0008:84DA
 * @implements B495:1984:0008:C68B
...
l__1811:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x1840); emu_cs = 0x01F7; emu_Tools_Divd();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1840:
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
...
l__1863:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1877); emu_cs = 0x01F7; emu_String_sprintf();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1877:
	emu_addw(&emu_sp, 0xC);
...
l__1984:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x198C); emu_cs = 0x01F7; emu_Terminate_Normal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
	/* Unresolved jump */ emu_ip = 0x198C; emu_last_cs = 0xB495; emu_last_ip = 0x198C; emu_last_length = 0x0008; emu_last_crc = 0xC68B; emu_call();
l__198D:
	emu_ax = 0x3495;
	emu_push(emu_ax);
	emu_ax = 0x98;
...
l__19B0:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x19C6); emu_cs = 0x2537; emu_Tools_RandomRange();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__19C6:
	emu_pop(&emu_cx);
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x19D5); emu_cs = 0x2537; emu_Tools_RandomRange();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__19D5:
	emu_pop(&emu_cx);
...
l__1A29:
	...
	emu_ax = 0x18D0;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1A3B); emu_cs = 0x1FB5; emu_File_Open();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1A3B:
	emu_addw(&emu_sp, 0x6);
...
l__1A55:
	emu_addw(&emu_sp, 0xA);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x1A5E); emu_cs = 0x1FB5; emu_File_Close();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3495) { overlay(0x3495, 1); }
l__1A5E:
	emu_pop(&emu_cx);
