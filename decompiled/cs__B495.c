...
void f__B495_0022_0023_E778()
{
	...
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x8BE8), emu_ax.x);
...
void f__B495_014A_0029_416B()
{
	...
	/* Unresolved jump */ emu_ip = 0x0173; emu_last_cs = 0xB495; emu_last_ip = 0x0173; emu_last_length = 0x0029; emu_last_crc = 0x416B; emu_call();
}
...
void f__B495_0920_000C_42EE()
{
	emu_pop(&emu_cx.x);
	emu_pop(&emu_cx.x);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x8BE8), 0x0);
...
void f__B495_140C_004D_AD7F()
{
	...
	/* Unresolved jump */ emu_ip = 0x1459; emu_last_cs = 0xB495; emu_last_ip = 0x1459; emu_last_length = 0x004D; emu_last_crc = 0xAD7F; emu_call();
}
...
void f__B495_149F_0036_9C55()
{
	...
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x7FB0));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x7FAE));
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ds, 0x00,  0x8BF1));
	emu_push(emu_get_memory16(emu_es, emu_bx.x,  0xA));
	emu_push(emu_get_memory16(emu_es, emu_bx.x,  0x8));
