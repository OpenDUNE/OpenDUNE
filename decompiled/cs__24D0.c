...
void f__24D0_000D_0039_C17D()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x003A; emu_last_cs = 0x24D0; emu_last_ip = 0x0031; emu_last_length = 0x0039; emu_last_crc = 0xC17D; emu_call(); return; } // Jump does not resolve
	emu_subw(&emu_di, emu_si);
	emu_addw(&emu_get_memory16(emu_ss, emu_bp,  0xE), emu_si);
	emu_xorw(&emu_si, emu_si);
	emu_cmpws(&emu_si, 0x28);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0044; emu_last_cs = 0x24D0; emu_last_ip = 0x003D; emu_last_length = 0x0039; emu_last_crc = 0xC17D; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_di, 0x28);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0046; emu_last_cs = 0x24D0; emu_last_ip = 0x0042; emu_last_length = 0x0039; emu_last_crc = 0xC17D; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x00A0; emu_last_cs = 0x24D0; emu_last_ip = 0x0044; emu_last_length = 0x0039; emu_last_crc = 0xC17D; emu_call(); // Jump does not resolve
}
...
void f__24D0_0023_0023_6DA5()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp,  0x10), 0xC8);
	emu_orw(&emu_si, emu_si);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x003A; emu_last_cs = 0x24D0; emu_last_ip = 0x0031; emu_last_length = 0x0023; emu_last_crc = 0x6DA5; emu_call(); return; } // Jump does not resolve
	emu_subw(&emu_di, emu_si);
	emu_addw(&emu_get_memory16(emu_ss, emu_bp,  0xE), emu_si);
	emu_xorw(&emu_si, emu_si);
	emu_cmpws(&emu_si, 0x28);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0044; emu_last_cs = 0x24D0; emu_last_ip = 0x003D; emu_last_length = 0x0023; emu_last_crc = 0x6DA5; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_di, 0x28);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0046; emu_last_cs = 0x24D0; emu_last_ip = 0x0042; emu_last_length = 0x0023; emu_last_crc = 0x6DA5; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x00A0; emu_last_cs = 0x24D0; emu_last_ip = 0x0044; emu_last_length = 0x0023; emu_last_crc = 0x6DA5; emu_call(); // Jump does not resolve
}
...
void f__24D0_002F_0017_14B6()
{
	...
	emu_xorw(&emu_si, emu_si);
	emu_cmpws(&emu_si, 0x28);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0044; emu_last_cs = 0x24D0; emu_last_ip = 0x003D; emu_last_length = 0x0017; emu_last_crc = 0x14B6; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_di, 0x28);
	if ((emu_flags.sf != emu_flags.of)) { f__24D0_0046_0057_54FF(); return; }
	emu_ip = 0x00A0; emu_last_cs = 0x24D0; emu_last_ip = 0x0044; emu_last_length = 0x0017; emu_last_crc = 0x14B6; emu_call(); // Jump does not resolve
}
...
{
	emu_cmpws(&emu_si, 0x28);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0044; emu_last_cs = 0x24D0; emu_last_ip = 0x003D; emu_last_length = 0x000C; emu_last_crc = 0x9629; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_di, 0x28);
	if ((emu_flags.sf != emu_flags.of)) { f__24D0_0046_0057_54FF(); return; }
...
void f__24D0_0046_0057_54FF()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0068; emu_last_cs = 0x24D0; emu_last_ip = 0x0055; emu_last_length = 0x0057; emu_last_crc = 0x54FF; emu_call(); return; } // Jump does not resolve
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x007F; emu_last_cs = 0x24D0; emu_last_ip = 0x006C; emu_last_length = 0x0057; emu_last_crc = 0x54FF; emu_call(); return; } // Jump does not resolve
...
void f__24D0_0051_004C_FA6A()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp,  0x8), 0x0);
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp,  0xC), 0x0);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x007F; emu_last_cs = 0x24D0; emu_last_ip = 0x006C; emu_last_length = 0x004C; emu_last_crc = 0xFA6A; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0xC));
	emu_subw(&emu_get_memory16(emu_ss, emu_bp,  0x8), emu_ax.x);
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0xC));
	emu_addw(&emu_get_memory16(emu_ss, emu_bp,  0x10), emu_ax.x);
