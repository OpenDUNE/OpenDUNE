...
void f__2B42_0000_0022_1DB2()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0022; emu_last_cs = 0x2B42; emu_last_ip = 0x0015; emu_last_length = 0x0022; emu_last_crc = 0x1DB2; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_cx.x, 0x13F);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0025; emu_last_cs = 0x2B42; emu_last_ip = 0x001B; emu_last_length = 0x0022; emu_last_crc = 0x1DB2; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_cx.x, 0x13F);
	emu_ip = 0x0025; emu_last_cs = 0x2B42; emu_last_ip = 0x0020; emu_last_length = 0x0022; emu_last_crc = 0x1DB2; emu_call(); // Jump does not resolve
}
...
{
	emu_cmpws(&emu_cx.x, 0x0);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0022; emu_last_cs = 0x2B42; emu_last_ip = 0x0015; emu_last_length = 0x0010; emu_last_crc = 0x99D3; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_cx.x, 0x13F);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__2B42_0025_0014_36D8(); return; }
	emu_movw(&emu_cx.x, 0x13F);
	emu_ip = 0x0025; emu_last_cs = 0x2B42; emu_last_ip = 0x0020; emu_last_length = 0x0010; emu_last_crc = 0x99D3; emu_call(); // Jump does not resolve
}
...
void f__2B42_0025_0014_36D8()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0039; emu_last_cs = 0x2B42; emu_last_ip = 0x002C; emu_last_length = 0x0014; emu_last_crc = 0x36D8; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, 0x13F);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__2B42_003C_001B_3888(); return; }
	emu_movw(&emu_dx.x, 0x13F);
	emu_ip = 0x003C; emu_last_cs = 0x2B42; emu_last_ip = 0x0037; emu_last_length = 0x0014; emu_last_crc = 0x36D8; emu_call(); // Jump does not resolve
}
...
void f__2B42_003C_001B_3888()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0057; emu_last_cs = 0x2B42; emu_last_ip = 0x0045; emu_last_length = 0x001B; emu_last_crc = 0x3888; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x7068), 0x1);
	if (!emu_flags.zf) { emu_ip = 0x0052; emu_last_cs = 0x2B42; emu_last_ip = 0x004C; emu_last_length = 0x001B; emu_last_crc = 0x3888; emu_call(); return; } // Jump does not resolve
	emu_shlw(&emu_cx.x, 0x1);
	emu_shlw(&emu_dx.x, 0x1);
	emu_movw(&emu_ax.x, 0x7);
	emu_pushf(); emu_flags.inf = 0; emu_push(emu_cs); emu_cs = 0x0070; emu_push(0x0057); f__0070_0198_0005_E61B();
...
void f__2B42_0057_001C_AB52()
{
	...
	emu_xchgw(&emu_dx.x, &emu_cx.x);
	emu_cmpws(&emu_cx.x, 0x0);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0073; emu_last_cs = 0x2B42; emu_last_ip = 0x0066; emu_last_length = 0x001C; emu_last_crc = 0xAB52; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_cx.x, 0xC7);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0076; emu_last_cs = 0x2B42; emu_last_ip = 0x006C; emu_last_length = 0x001C; emu_last_crc = 0xAB52; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_cx.x, 0xC7);
	emu_ip = 0x0076; emu_last_cs = 0x2B42; emu_last_ip = 0x0071; emu_last_length = 0x001C; emu_last_crc = 0xAB52; emu_call(); // Jump does not resolve
}
...
{
	emu_cmpws(&emu_cx.x, 0x0);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0073; emu_last_cs = 0x2B42; emu_last_ip = 0x0066; emu_last_length = 0x0010; emu_last_crc = 0x1880; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_cx.x, 0xC7);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__2B42_0076_0014_B78C(); return; }
	emu_movw(&emu_cx.x, 0xC7);
	emu_ip = 0x0076; emu_last_cs = 0x2B42; emu_last_ip = 0x0071; emu_last_length = 0x0010; emu_last_crc = 0x1880; emu_call(); // Jump does not resolve
}
...
void f__2B42_0076_0014_B78C()
{
	...
	emu_cmpws(&emu_dx.x, 0x0);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x008A; emu_last_cs = 0x2B42; emu_last_ip = 0x007D; emu_last_length = 0x0014; emu_last_crc = 0xB78C; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, 0xC7);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__2B42_008D_0010_8866(); return; }
	emu_movw(&emu_dx.x, 0xC7);
	emu_ip = 0x008D; emu_last_cs = 0x2B42; emu_last_ip = 0x0088; emu_last_length = 0x0014; emu_last_crc = 0xB78C; emu_call(); // Jump does not resolve
}
...
void f__2B42_008D_0010_8866()
{
	...
	emu_cmpb(&emu_get_memory8(emu_ds, 0x00,  0x7096), 0x0);
	if (emu_flags.zf) { emu_ip = 0x009D; emu_last_cs = 0x2B42; emu_last_ip = 0x0096; emu_last_length = 0x0010; emu_last_crc = 0x8866; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x8);
	emu_pushf(); emu_flags.inf = 0; emu_push(emu_cs); emu_cs = 0x0070; emu_push(0x009D); f__0070_0198_0005_E61B();
