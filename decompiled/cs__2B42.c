...
void f__2B42_003C_001B_3888()
{
	...
	if (emu_flags.zf) { f__2B42_0057_001C_AB52(); return; }
...
void f__2B42_008D_0010_8866()
{
	...
	emu_cmpb(&emu_get_memory8(emu_ds, 0x00, 0x7096), 0x0);
	if (emu_flags.zf) { f__2B42_009D_0005_BC42(); return; }
	emu_movw(&emu_ax, 0x8);
