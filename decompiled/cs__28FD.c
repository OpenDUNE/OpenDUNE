...
void f__28FD_002B_0009_3693()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x0034; emu_last_cs = 0x28FD; emu_last_ip = 0x002F; emu_last_length = 0x0009; emu_last_crc = 0x3693; emu_call(); return; } // Jump does not resolve
	emu_decw(&emu_dx.x);
	emu_ip = 0x0022; emu_last_cs = 0x28FD; emu_last_ip = 0x0032; emu_last_length = 0x0009; emu_last_crc = 0x3693; emu_call(); // Jump does not resolve
}
