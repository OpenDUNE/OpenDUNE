...
l__025F:
	...
	if (emu_ax == 0) { /* Unresolved jump */ emu_ip = 0x02E2; emu_last_cs = 0x104B; emu_last_ip = 0x026C; emu_last_length = 0x0064; emu_last_crc = 0xD684; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_get_memory16(emu_es, emu_bx, 0x2) = 0x1;
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x02C3); emu_cs = 0x15C2; emu_Script_Reset();
l__02C3:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_si);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x4);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x02D6); emu_cs = 0x15C2; emu_Script_Load();
l__02D6:
	emu_addw(&emu_sp, 0x6);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
