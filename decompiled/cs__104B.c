...
void f__104B_0017_0046_2F85()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0017; emu_last_cs = 0x104B; emu_last_ip = 0x0056; emu_last_length = 0x0046; emu_last_crc = 0x2F85; emu_call(); return; } // Jump does not resolve
	emu_pop(&emu_si);
...
void f__104B_0079_0026_FD93()
{
	...
	if (emu_flags.zf) { emu_ip = 0x00A2; emu_last_cs = 0x104B; emu_last_ip = 0x0089; emu_last_length = 0x0026; emu_last_crc = 0xFD93; emu_call(); return; } // Jump does not resolve
...
void f__104B_0082_001D_CF58()
{
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x35EE));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x35F0));
	if (emu_flags.zf) { emu_ip = 0x00A2; emu_last_cs = 0x104B; emu_last_ip = 0x0089; emu_last_length = 0x001D; emu_last_crc = 0xCF58; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x530);
	emu_push(emu_ax.x);
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_push(emu_ax.x);
...
void f__104B_00F8_002E_3820()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0124; emu_last_cs = 0x104B; emu_last_ip = 0x0121; emu_last_length = 0x002E; emu_last_crc = 0x3820; emu_call(); return; } // Jump does not resolve
	emu_incw(&emu_si);
	emu_ip = 0x0158; emu_last_cs = 0x104B; emu_last_ip = 0x0124; emu_last_length = 0x002E; emu_last_crc = 0x3820; emu_call(); // Jump does not resolve
}
...
void f__104B_0110_0016_6D19()
{
	...
	emu_movw(&emu_si, emu_get_memory16(emu_es, emu_bx.x,  0x4));
	emu_cmpw(&emu_si, emu_get_memory16(emu_ds, 0x00,  0x35F2));
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0124; emu_last_cs = 0x104B; emu_last_ip = 0x0121; emu_last_length = 0x0016; emu_last_crc = 0x6D19; emu_call(); return; } // Jump does not resolve
	emu_incw(&emu_si);
...
{
	emu_cmpw(&emu_si, emu_get_memory16(emu_ds, 0x00,  0x35F2));
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0126; emu_last_cs = 0x104B; emu_last_ip = 0x015C; emu_last_length = 0x0013; emu_last_crc = 0x49FB; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
...
void f__104B_0354_0023_5A6D()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0377; emu_last_cs = 0x104B; emu_last_ip = 0x035C; emu_last_length = 0x0023; emu_last_crc = 0x5A6D; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_cx.x, 0x10);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0377; emu_last_cs = 0x104B; emu_last_ip = 0x0361; emu_last_length = 0x0023; emu_last_crc = 0x5A6D; emu_call(); return; } // Jump does not resolve
