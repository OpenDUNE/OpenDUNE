...
l__0542:
	...
	if (emu_get_memory8(emu_ds, 0x00, 0x7010) == 0x2) { /* Unresolved jump */ emu_ip = 0x054F; emu_last_cs = 0x29E8; emu_last_ip = 0x054A; emu_last_length = 0x000D; emu_last_crc = 0xDF7C; emu_call(); return; }
	goto l__0632;
l__0632:
	emu_pop(&emu_di);
	emu_pop(&emu_cx);
