...
void f__B52A_0104_0056_67EF()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { f__B52A_015A_000B_64B1(); return; }
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) {
		emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0xE), 0x1);
		if ((emu_flags.cf || emu_flags.zf)) { f__B52A_015A_000B_64B1(); return; }
	}
	f__B52A_0141_0019_667E(); return;
}
 ...
 * Called From: B52A:0151:0056:67EF
 */
...
void f__B52A_0476_0030_9D41()
{
	...
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x352A) { ovl__352A(0xFF); }
	f__B52A_04A6_0006_EFF6(); return;
}

/**
 * Decompiled function f__B52A_04A6_0006_EFF6()
 *
 * @name f__B52A_04A6_0006_EFF6
 * @implements B52A:04A6:0006:EFF6 ()
 *
 */
void f__B52A_04A6_0006_EFF6()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	f__B52A_04A8_0004_893F(); return;
}
 ...
 * Called From: B52A:05B6:001F:0178
 */
void f__B52A_05BC_0030_A33B()
{
	...
	if (!emu_flags.zf) { f__B52A_05EC_0008_C579(); return; }
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0xA), 0xFFFF);
	f__B52A_05F2_0002_D43A(); return;
}
...
/**
 * Decompiled function f__B52A_05F2_0002_D43A()
 *
 * @name f__B52A_05F2_0002_D43A
 * @implements B52A:05F2:0002:D43A ()
 *
 * Called From: B52A:05EA:0030:A33B
 */
void f__B52A_05F2_0002_D43A()
{
 ...
 * Called From: B52A:05F2:0002:D43A
 ...
 * Called From: B52A:0620:000D:23E0
 */
...
/**
 * Decompiled function f__B52A_08D0_0022_4157()
 *
 * @name f__B52A_08D0_0022_4157
 * @implements B52A:08D0:0022:4157 ()
 *
 * Called From: B52A:08CC:001B:1BB9
 */
void f__B52A_08D0_0022_4157()
{
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0xA), emu_ax);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
 ...
 * Called From: B52A:08ED:0022:4157
 */
