...
l__0027:
	...
	emu_cmpw(&emu_ax, 0x2);
	if (emu_flags.zf) goto l__003A;
	emu_cmpw(&emu_ax, 0x3);
	if (emu_flags.zf) goto l__0064;
	goto l__007B;
l__003A:
	emu_push(emu_di);
...
l__0088:
	...
	if (emu_flags.zf) goto l__00A2;
	emu_cmpw(&emu_ax, 0x8000);
	if (emu_flags.zf) goto l__00A7;
...
l__02E4:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0x2);
	if (emu_flags.zf) goto l__0300;
	emu_cmpw(&emu_ax, 0x3);
	if (emu_flags.zf) goto l__02F1;
	goto l__030E;
l__02F1:
	emu_push(emu_si);
	emu_push(emu_cs);
