...
{
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x0040); emu_cs = 0x0FE4; f__0FE4_05FD_002C_15BA();
...
void f__167E_0040_0011_B96B()
{
	...
	emu_ip = 0x0014; emu_last_cs = 0x167E; emu_last_ip = 0x004F; emu_last_length = 0x0011; emu_last_crc = 0xB96B; emu_call(); // Jump does not resolve
}
...
{
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x006A); emu_cs = 0x1082; f__1082_03A1_0023_9F5D();
...
void f__167E_00F3_001E_8CB3()
{
	...
	emu_ip = 0x0157; emu_last_cs = 0x167E; emu_last_ip = 0x010F; emu_last_length = 0x001E; emu_last_crc = 0x8CB3; emu_call(); // Jump does not resolve
}
...
{
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x013C); emu_cs = 0x0FE4; f__0FE4_05FD_002C_15BA();
...
void f__167E_013C_0012_1FAD()
{
	...
	if (emu_flags.zf) { emu_ip = 0x014E; emu_last_cs = 0x167E; emu_last_ip = 0x0147; emu_last_length = 0x0012; emu_last_crc = 0x1FAD; emu_call(); return; } // Jump does not resolve
...
void f__167E_0177_0012_EE2A()
{
	...
	emu_ip = 0x01B1; emu_last_cs = 0x167E; emu_last_ip = 0x0187; emu_last_length = 0x0012; emu_last_crc = 0xEE2A; emu_call(); // Jump does not resolve
}
...
{
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0193); emu_cs = 0x0FE4; f__0FE4_05FD_002C_15BA();
...
{
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x019B); emu_cs = 0x1082; f__1082_03A1_0023_9F5D();
...
void f__167E_01D3_0013_5505()
{
	...
	emu_ip = 0x0276; emu_last_cs = 0x167E; emu_last_ip = 0x01E3; emu_last_length = 0x0013; emu_last_crc = 0x5505; emu_call(); // Jump does not resolve
}
...
{
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0216); emu_cs = 0x0FE4; f__0FE4_05FD_002C_15BA();
...
{
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x022B); emu_cs = 0x1082; f__1082_03A1_0023_9F5D();
...
void f__167E_029B_0007_9375()
{
	emu_pop(&emu_cx.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x02A2); emu_cs = 0x0FE4; f__0FE4_05FD_002C_15BA();
...
void f__167E_02C5_0007_DC29()
{
	emu_pop(&emu_cx.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x02CC); emu_cs = 0x1082; f__1082_03A1_0023_9F5D();
...
void f__167E_02F6_0007_DC29()
{
	emu_pop(&emu_cx.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x02FD); emu_cs = 0x1082; f__1082_03A1_0023_9F5D();
...
void f__167E_0305_0007_9375()
{
	emu_pop(&emu_cx.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x030C); emu_cs = 0x0FE4; f__0FE4_05FD_002C_15BA();
