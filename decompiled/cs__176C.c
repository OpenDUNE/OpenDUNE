 ...
 * Called From: 1423:06DF:0024:0208
 * Called From: 1423:076C:000F:6861
 ...
 * Called From: 1A34:191C:000B:F53C
...
l__007B:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00B9); emu_cs = 0x15C2; emu_Script_Reset();
l__00B9:
	emu_addw(&emu_sp, 0x8);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0xA);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00DE); emu_cs = 0x15C2; emu_Script_Load();
l__00DE:
	goto l__0102;
l__0102:
	emu_addw(&emu_sp, 0x6);
...
l__0750:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x626A));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0760); emu_cs = 0x15C2; emu_Script_Run();
l__0760:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__082E:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0834); emu_cs = 0x167E; f__167E_02AE_000C_CC85();
l__0834:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_dx);
	if (emu_ax == 0) goto l__0851;
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x083F); emu_cs = 0x167E; f__167E_02AE_000C_CC85();
...
l__0956:
	...
	emu_push(emu_cs); emu_push(0x0968); emu_cs = 0x0C3A; emu_Structure_UpdateAnimation();
l__0968:
	emu_addw(&emu_sp, 0x6);
...
l__0C5D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0CA2); emu_cs = 0x0C3A; emu_Structure_UpdateAnimation();
l__0CA2:
	emu_addw(&emu_sp, 0x6);
l__0CA5:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0xE));
...
l__13CD:
	...
	emu_ax = 0x19;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x13E1); emu_cs = 0x2537; f__2537_000C_001C_86CB();
l__13E1:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_ax);
...
l__1400:
	...
	emu_ax = 0x4B;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1410); emu_cs = 0x2537; f__2537_000C_001C_86CB();
l__1410:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_ax);
...
l__2671:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x626C));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x267D); emu_cs = 0x0FCB; emu_String_GetString();
l__267D:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__268D:
	...
	emu_ax = 0x13;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x26A7); emu_cs = 0x0FCB; emu_String_GetString();
l__26A7:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__2B47:
	...
	emu_ax = 0x14;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x2B5B); emu_cs = 0x0FCB; emu_String_GetString();
l__2B5B:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__7E7E:
	...
	emu_ax = 0x984A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x7E90); emu_cs = 0x01F7; emu_String_strcat();
l__7E90:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0xA);
	emu_addw(&emu_ax, 0x6);
	...
	emu_ax = 0x984A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x7EA7); emu_cs = 0x01F7; emu_String_strcat();
l__7EA7:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_ds);
	emu_ax = 0x984A;
...
l__7EE5:
	...
	emu_ax = 0x984A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x7EF7); emu_cs = 0x01F7; emu_String_strcat();
l__7EF7:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_ds);
	emu_ax = 0x984A;
