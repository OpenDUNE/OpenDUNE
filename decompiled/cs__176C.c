...
void f__176C_0E67_000B_166D()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0E72); emu_cs = 0x1082; emu_Building_Find();
...
void f__176C_2615_000B_166D()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x2620); emu_cs = 0x1082; emu_Building_Find();
...
void f__176C_2A30_0026_C654()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x2A56); emu_cs = 0x1082; emu_Building_Find();
