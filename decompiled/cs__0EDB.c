...
l__0102:
	...
	emu_addw(&emu_bx, emu_ax);
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x16));
	emu_push(emu_cs); emu_push(0x011B); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__011B:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_bx = 0x5;
...
l__0386:
	...
	emu_si = emu_get_memory16(emu_es, emu_bx, 0x16);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x03A3); emu_cs = 0x167E; f__167E_0005_0013_AF0C();
l__03A3:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x03AE); emu_cs = 0x167E; f__167E_00B7_0034_F3DA();
l__03AE:
	emu_pop(&emu_cx);
	goto l__03B6;
l__03B6:
...
l__0594:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x05BA); emu_cs = 0x167E; f__167E_0088_001A_60ED();
