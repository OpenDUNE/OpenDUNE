...
l__0057:
	...
	emu_ax = 0xFF;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0065); emu_cs = 0x34C1; overlay(0x34C1, 0); f__B4C1_0129_0028_FB8E();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3483) { overlay(0x3483, 1); }
l__0065:
	emu_pop(&emu_cx);
...
l__0363:
	...
	if (emu_ax == 0xFFFF) { /* Unresolved jump */ emu_ip = 0x03BB; emu_last_cs = 0xB483; emu_last_ip = 0x0375; emu_last_length = 0x0016; emu_last_crc = 0x83DF; emu_call(); return; }
	goto l__03BE;
l__0379:
