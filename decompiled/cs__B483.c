...
l__016F:
	...
	if (!(emu_flags.sf != emu_flags.of)) goto l__0185;
	goto l__027E;
l__0185:
	emu_movw(&emu_ax, emu_si);
	emu_movw(&emu_dx, 0x6);
...
l__0283:
	...
	if ((emu_flags.sf != emu_flags.of)) goto l__0297;
	goto l__0360;
l__0297:
	emu_movw(&emu_ax, emu_si);
	emu_movw(&emu_dx, 0x6);
...
l__0388:
	emu_cmpw(&emu_si, 0x5);
	if ((emu_flags.sf != emu_flags.of)) goto l__037D;
