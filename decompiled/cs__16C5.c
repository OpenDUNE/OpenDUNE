...
l__038C:
	...
	emu_push(emu_cs); emu_push(0x039F); emu_cs = 0x16BC; emu_Unit_RemoveFromTeam();
l__039F:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	...
	emu_push(emu_cs); emu_push(0x03B4); emu_cs = 0x16BC; emu_Unit_AddToTeam();
l__03B4:
	emu_addw(&emu_sp, 0x8);
	goto l__0253;
l__03BA:
...
l__0498:
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0xC));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0xA));
	emu_push(emu_cs); emu_push(0x04C6); emu_cs = 0x0F3F; emu_Tile_GetDistanceRoundedUp();
l__04C6:
	emu_addw(&emu_sp, 0x8);
...
l__04D9:
	...
	emu_push(emu_cs); emu_push(0x0514); emu_cs = 0x167E; emu_Tools_Index_GetPackedTile();
l__0514:
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
...
l__0592:
	...
	emu_push(emu_cs); emu_push(0x059E); emu_cs = 0x167E; emu_Tools_Index_GetTile();
l__059E:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0xC) = emu_dx;
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0xC));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0xA));
	emu_push(emu_cs); emu_push(0x05C1); emu_cs = 0x0F3F; emu_Tile_GetDistanceRoundedUp();
l__05C1:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0x8) = emu_ax;
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0xC));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0xA));
	emu_push(emu_cs); emu_push(0x05E7); emu_cs = 0x0F3F; emu_Tile_GetDistanceRoundedUp();
l__05E7:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xC));
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x16));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x14));
	emu_push(emu_cs); emu_push(0x0604); emu_cs = 0x0F3F; emu_Tile_GetDistanceRoundedUp();
l__0604:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0xA) = emu_ax;
	goto l__0615;
...
l__0678:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0686); emu_cs = 0x1A34; emu_Unit_SetDestination();
l__0686:
	emu_addw(&emu_sp, 0x6);
	emu_incw(&emu_si);
	goto l__069E;
...
l__0719:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x073A); emu_cs = 0x167E; emu_Tools_Index_GetPackedTile();
l__073A:
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0xA));
