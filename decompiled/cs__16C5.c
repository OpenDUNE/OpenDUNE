...
void f__16C5_02DC_001D_4A1C()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { f__16C5_02E9_0010_5ED3(); return; }
 ...
 *
 * Called From: 16C5:0308:000F:EECE
 */
 ...
 *
 * Called From: 16C5:033B:0033:424B
 */
void f__16C5_033B_002A_9578()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { f__16C5_034B_001A_1855(); return; }
 ...
 * Called From: 16C5:0365:002A:9578
 * Called From: 16C5:0365:001A:1855
 */
 ...
 * Called From: 16C5:039F:0027:420B
 */
 ...
 *
 * Called From: 16C5:0418:0023:C4F4
 */
 ...
 *
 * Called From: 16C5:042C:0014:7049
 */
 ...
 * Called From: 16C5:043C:0010:F460
 */
 ...
 *
 * Called From: 16C5:046E:001B:4B24
 */
 ...
 *
 * Called From: 16C5:0493:0025:660E
 */
 ...
 *
 * Called From: 16C5:04C6:002E:4299
 */
 ...
 *
 * Called From: 16C5:04D7:000B:799F
 * Called From: 16C5:04D7:0011:175D
 */
void f__16C5_04D7_003D_5378()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0538; emu_last_cs = 0x16C5; emu_last_ip = 0x0505; emu_last_length = 0x003D; emu_last_crc = 0x5378; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x6124));
...
void f__16C5_04D9_003B_9EEA()
{
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x6124));
	emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x1A), 0x0);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0538; emu_last_cs = 0x16C5; emu_last_ip = 0x04FA; emu_last_length = 0x003B; emu_last_crc = 0x9EEA; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x6124));
	emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x18), 0x0);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0538; emu_last_cs = 0x16C5; emu_last_ip = 0x0505; emu_last_length = 0x003B; emu_last_crc = 0x9EEA; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x6124));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x1A));
	/* Unresolved call */ emu_push(emu_cs); emu_push(0x0514); emu_cs = 0x167E; emu_ip = 0x0162; emu_last_cs = 0x16C5; emu_last_ip = 0x050F; emu_last_length = 0x003B; emu_last_crc = 0x9EEA; emu_call();
	f__16C5_0514_000B_9CBA();
}
 ...
 *
 * Called From: 16C5:0514:003D:5378
 */
 ...
 *
 * Called From: 16C5:051F:000B:9CBA
 */
 ...
 *
 * Called From: 16C5:0527:0008:DA8A
 */
void f__16C5_0527_0016_F4ED()
{
	...
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0xA);
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__16C5_0538_0005_BB66(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x6124));
	emu_movw(&emu_get_memory16(emu_es, emu_bx, 0x18), 0x2);
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x8));
	/* Unresolved jump */ emu_ip = 0x053D; emu_last_cs = 0x16C5; emu_last_ip = 0x053B; emu_last_length = 0x0016; emu_last_crc = 0xF4ED; emu_call();
}
 ...
 *
 * Called From: 16C5:0577:0034:CA88
 */
 ...
 *
 * Called From: 16C5:059E:000C:6B53
 */
 ...
 *
 * Called From: 16C5:05C1:0023:DF62
 */
 ...
 *
 * Called From: 16C5:05E7:0026:0FE7
 */
 ...
 *
 * Called From: 16C5:0604:001D:B1ED
 */
...
void f__16C5_060C_0037_5F94()
{
	...
	if (!emu_flags.cf) { f__16C5_0627_001C_37C4(); return; }
	emu_movw(&emu_ax, emu_di);
	emu_addw(&emu_ax, 0x2);
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x8));
	if (emu_flags.cf) { /* Unresolved jump */ emu_ip = 0x0634; emu_last_cs = 0x16C5; emu_last_ip = 0x0625; emu_last_length = 0x0037; emu_last_crc = 0x5F94; emu_call(); return; }
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0xA));
	if (emu_flags.cf) { /* Unresolved jump */ emu_ip = 0x068C; emu_last_cs = 0x16C5; emu_last_ip = 0x062D; emu_last_length = 0x0037; emu_last_crc = 0x5F94; emu_call(); return; }
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x8), emu_di);
	if ((emu_flags.cf || emu_flags.zf)) { /* Unresolved jump */ emu_ip = 0x068C; emu_last_cs = 0x16C5; emu_last_ip = 0x0632; emu_last_length = 0x0037; emu_last_crc = 0x5F94; emu_call(); return; }
	emu_movw(&emu_ax, 0x1);
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	/* Unresolved call */ emu_push(emu_cs); emu_push(0x0643); emu_cs = 0x176C; emu_ip = 0x000E; emu_last_cs = 0x16C5; emu_last_ip = 0x063E; emu_last_length = 0x0037; emu_last_crc = 0x5F94; emu_call();
...
void f__16C5_0615_002E_F6D7()
{
	...
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x8), emu_di);
	if ((emu_flags.cf || emu_flags.zf)) { /* Unresolved jump */ emu_ip = 0x068C; emu_last_cs = 0x16C5; emu_last_ip = 0x0632; emu_last_length = 0x002E; emu_last_crc = 0xF6D7; emu_call(); return; }
	emu_movw(&emu_ax, 0x1);
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	/* Unresolved call */ emu_push(emu_cs); emu_push(0x0643); emu_cs = 0x176C; emu_ip = 0x000E; emu_last_cs = 0x16C5; emu_last_ip = 0x063E; emu_last_length = 0x002E; emu_last_crc = 0xF6D7; emu_call();
	f__16C5_0643_0023_559B();
}
...
void f__16C5_0627_001C_37C4()
{
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0xA));
	if (emu_flags.cf) { /* Unresolved jump */ emu_ip = 0x068C; emu_last_cs = 0x16C5; emu_last_ip = 0x062D; emu_last_length = 0x001C; emu_last_crc = 0x37C4; emu_call(); return; }
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x8), emu_di);
 ...
 *
 * Called From: 16C5:0643:001C:37C4
 * Called From: 16C5:0643:000F:6841
 */
 ...
 *
 * Called From: 16C5:0666:0023:559B
 */
 ...
 *
 * Called From: 16C5:0670:000A:CB50
 */
 ...
 *
 * Called From: 16C5:0678:0008:A673
 */
 ...
 *
 * Called From: 16C5:0686:000E:B4D2
 */
 ...
 *
 * Called From: 16C5:069B:000F:6849
 */
 ...
 *
 * Called From: 16C5:06A9:000B:799F
 * Called From: 16C5:06A9:000E:5BF5
 */
...
void f__16C5_06AB_0011_16E1()
{
	...
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x06BC; emu_last_cs = 0x16C5; emu_last_ip = 0x06B7; emu_last_length = 0x0011; emu_last_crc = 0x16E1; emu_call(); return; }
	f__16C5_057D_0015_F18F(); return;
}
 ...
 *
 * Called From: 16C5:06E3:001D:94A6
 */
 ...
 *
 * Called From: 16C5:0719:000C:2071
 */
void f__16C5_0719_0021_53DA()
{
	...
	emu_movw(&emu_si, emu_ax);
	emu_orw(&emu_si, emu_si);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0762; emu_last_cs = 0x16C5; emu_last_ip = 0x0720; emu_last_length = 0x0021; emu_last_crc = 0x53DA; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ds, 0x00, 0x6124));
 ...
 *
 * Called From: 16C5:073A:0021:53DA
 */
 ...
 *
 * Called From: 16C5:074C:0012:7F5F
 */
 ...
 *
 * Called From: 16C5:0754:0008:1757
 */
 ...
 *
 * Called From: 16C5:076C:000A:B112
 */
void f__16C5_076C_0013_89D8()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x077F; emu_last_cs = 0x16C5; emu_last_ip = 0x077A; emu_last_length = 0x0013; emu_last_crc = 0x89D8; emu_call(); return; }
...
void f__16C5_0788_0018_4AA5()
{
	...
	emu_xorw(&emu_ax, emu_ax);
	/* Unresolved jump */ emu_ip = 0x09BE; emu_last_cs = 0x16C5; emu_last_ip = 0x079D; emu_last_length = 0x0018; emu_last_crc = 0x4AA5; emu_call();
}
 ...
 *
 * Called From: 16C5:07AD:000D:11BB
 */
 ...
 *
 * Called From: 16C5:07D2:0025:40DD
 */
 ...
 *
 * Called From: 16C5:07ED:001B:B10A
 */
...
void f__16C5_085B_0048_ACCD()
{
	...
	if (!emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x08C4; emu_last_cs = 0x16C5; emu_last_ip = 0x0894; emu_last_length = 0x0048; emu_last_crc = 0xACCD; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x56), 0x0);
 ...
 *
 * Called From: 16C5:08B9:0016:8B23
 */
void f__16C5_08B9_000B_D46A()
{
	emu_addw(&emu_sp, 0x8);
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0xC));
	if ((emu_flags.sf != emu_flags.of)) { /* Unresolved jump */ emu_ip = 0x08C4; emu_last_cs = 0x16C5; emu_last_ip = 0x08BF; emu_last_length = 0x000B; emu_last_crc = 0xD46A; emu_call(); return; }
	f__16C5_0989_0002_C93A(); return;
}
 ...
 *
 * Called From: 16C5:08DC:0018:C08E
 */
 ...
 *
 * Called From: 16C5:08F5:0019:EFED
 */
 ...
 *
 * Called From: 16C5:0908:0013:98D0
 */
void f__16C5_0908_001E_7ACA()
{
	...
	emu_orw(&emu_si, emu_si);
	if (!(emu_flags.sf != emu_flags.of)) { f__16C5_0917_000F_9BA4(); return; }
 ...
 *
 * Called From: 16C5:0926:000F:9BA4
 * Called From: 16C5:0926:001E:7ACA
 */
 ...
 *
 * Called From: 16C5:0930:000A:CB50
 */
 ...
 *
 * Called From: 16C5:093D:000D:8578
 */
 ...
 *
 * Called From: 16C5:095A:000F:345F
 */
 ...
 *
 * Called From: 16C5:0962:0005:BFC0
 * Called From: 16C5:0962:0008:A673
 */
 ...
 *
 * Called From: 16C5:0970:000E:B4D2
 */
 ...
 *
 * Called From: 16C5:0986:0016:8E0F
 */
 ...
 *
 * Called From: 16C5:09A8:000B:799F
 */
...
void f__16C5_09AA_0011_56DF()
{
	...
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x09BB; emu_last_cs = 0x16C5; emu_last_ip = 0x09B6; emu_last_length = 0x0011; emu_last_crc = 0x56DF; emu_call(); return; }
	f__16C5_07F3_0015_B1A9(); return;
}
 ...
 *
 * Called From: 16C5:0A5A:003A:2375
 */
 ...
 *
 * Called From: 16C5:0A75:001B:990F
 */
