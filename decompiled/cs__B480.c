...
l__0086:
	...
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) goto l__00E4;
...
l__01E7:
	...
	emu_movw(&emu_bx, emu_ax);
	emu_cmpw(&emu_bx, 0x4);
	if (!(emu_flags.cf || emu_flags.zf)) goto l__0204;
	emu_shlw(&emu_bx, 0x1);
...
l__0322:
	emu_cmpw(&emu_di, 0x9);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) goto l__0305;
