...
void f__B480_0029_000A_50E7()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0033); emu_cs = 0x01F7; emu_ip = 0x03AA; emu_last_cs = 0xB480; emu_last_ip = 0x002E; emu_last_length = 0x000A; emu_last_crc = 0x50E7; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
