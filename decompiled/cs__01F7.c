...
void f__01F7_0099_0044_8C82()
{
	...
	if (emu_flags.cf) { f__01F7_010C_0004_0D38(); return; }
	...
	emu_movw(&emu_bx, 0x2);
	emu_pushf(); emu_flags.inf = 0; emu_push(emu_cs); emu_cs = 0x01F7; emu_push(0x00DD); f__01F7_0349_0004_4860();
...
void f__01F7_04FA_0084_C87E()
{
	...
	if (!emu_flags.zf) { f__01F7_053B_0043_C7D2(); return; }
	emu_orw(&emu_dx, emu_dx);
	if (emu_flags.sf) {
...
void f__01F7_0889_002A_3EEB()
{
	...
	if (emu_flags.sf) { f__01F7_08CE_000E_CF0D(); return; }
...
void f__01F7_0D43_0013_D2AA()
{
	...
	emu_cmpb(&emu_bl, 0x9);
	if ((emu_flags.cf || emu_flags.zf)) { f__01F7_0D56_0003_2ADE(); return; }
...
{
	emu_cmpb(&emu_ch, 0x0);
	if (!(emu_flags.cf || emu_flags.zf)) { f__01F7_127E_0022_EBA7(); return; }
	emu_testw(&emu_get_memory16(emu_ss, emu_bp, -0x2), 0x2);
	if (!emu_flags.zf) { f__01F7_1261_0003_E2BB(); return; }
...
void f__01F7_14DE_000C_BAA4()
{
	...
	/* Unresolved jump */ emu_ip = 0x14EA; emu_last_cs = 0x01F7; emu_last_ip = 0x14E7; emu_last_length = 0x000C; emu_last_crc = 0xBAA4; emu_call();
}
...
void f__01F7_1741_001B_9E34()
{
	...
	emu_movw(&emu_dx, emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_orw(&emu_dx, emu_dx);
	if (emu_flags.zf) { f__01F7_1761_0009_4CC9(); return; }
...
void f__01F7_185E_004A_2060()
{
	...
	emu_push(emu_di);
	emu_movw(&emu_get_memory16(emu_cs, 0x00, 0x1607), emu_ds);
	if (emu_flags.zf) { f__01F7_18C9_0009_4CC9(); return; }
...
void f__01F7_1AF8_0021_2D85()
{
	...
	emu_cmpw(&emu_ax, 0xFFFF);
	if ((emu_flags.cf || emu_flags.zf)) { f__01F7_1B19_0010_8C34(); return; }
...
void f__01F7_2138_0010_D825()
{
	...
	if (!emu_flags.zf) {
		...
		if (!emu_flags.zf) {
			emu_cmpb(&emu_al, 0x9);
			if (!emu_flags.zf) { f__01F7_2128_0003_5D07(); return; }
		}
	}
...
void f__01F7_2153_001D_602A()
{
	...
	if (emu_flags.zf) { f__01F7_216F_0001_6180(); return; }
...
void f__01F7_2923_0024_671B()
{
	...
	emu_testw(&emu_di, 0x1);
	if (!emu_flags.zf) {
		if (emu_cx == 0) { f__01F7_2944_0003_2E77(); return; }
		emu_stosb();
		emu_decw(&emu_cx);
	}
...
void f__01F7_2ADD_0028_9E59()
{
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x2B05); f__01F7_207A_0014_31F0();
...
void f__01F7_2B14_0023_AF3A()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x2B37); f__01F7_22E8_0011_1764();
...
void f__01F7_30E9_0013_EEEF()
{
	...
	/* Unresolved jump */ emu_ip = 0x30FC; emu_last_cs = 0x01F7; emu_last_ip = 0x30F9; emu_last_length = 0x0013; emu_last_crc = 0xEEEF; emu_call();
}
...
void f__01F7_33E2_004A_D92C()
{
	...
	emu_orw(&emu_si, emu_si);
	if ((emu_flags.cf || emu_flags.zf)) { f__01F7_346E_0006_1452(); return; }
	...
	if (!emu_flags.zf) { f__01F7_3447_002D_8DA6(); return; }
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x342C); f__01F7_184B_000A_9146();
	f__01F7_342C_000E_7D70(); return;
}
...
void f__01F7_3474_001A_8B70()
{
	...
	emu_movw(&emu_ax, emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp,  0xC));
	if (emu_flags.zf) { f__01F7_34C8_0005_4AB7(); return; }
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x348E); f__01F7_39A5_001F_1A5D();
	f__01F7_348E_0018_9A8B(); return;
}
...
void f__01F7_363F_0026_37C8()
{
	...
	/* Unresolved jump */ emu_ip = 0x3665; emu_last_cs = 0x01F7; emu_last_ip = 0x3662; emu_last_length = 0x0026; emu_last_crc = 0x37C8; emu_call();
}
...
{
	emu_xchgw(&emu_dx, &emu_cx);
	if (emu_cx == 0) { f__01F7_3AEE_000A_AC55(); return; }
	emu_movw(&emu_ax, emu_cx);
	emu_decw(&emu_cx);
	emu_rep_cmpsb(emu_ds);
	emu_movw(&emu_cx, emu_ax);
...
void f__01F7_426C_002A_8B7E()
{
	...
	if (!(emu_flags.cf || emu_flags.zf)) { f__01F7_42ED_0007_CAD2(); return; }
...
void f__01F7_431E_001C_8DD0()
{
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x433A); f__01F7_0773_001E_D7DA();
...
void f__01F7_4399_003D_4254()
{
	...
	emu_sbbw(&emu_bx, 0x0);
	emu_orw(&emu_bx, emu_bx);
	if ((emu_flags.sf != emu_flags.of)) { f__01F7_43FB_0009_AEAB(); return; }
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x43D6); f__01F7_4445_0016_943B();
...
void f__01F7_4404_0021_4078()
{
	...
	emu_movw(&emu_ax, emu_si);
	emu_orw(&emu_ax, emu_ax);
	if ((emu_flags.cf || emu_flags.zf)) { f__01F7_443C_0009_3193(); return; }
	emu_push(emu_si);
	emu_push(emu_ss);
	emu_movw(&emu_ax, emu_bp - 0x8E);
	emu_push(emu_ax);
