...
l__0695:
	...
	if ((int16)emu_si > (int16)0x30) { /* Unresolved jump */ emu_ip = 0x0685; emu_last_cs = 0x01F7; emu_last_ip = 0x069A; emu_last_length = 0x0019; emu_last_crc = 0x5985; emu_call(); return; }
