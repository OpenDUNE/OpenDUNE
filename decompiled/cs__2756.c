...
void f__2756_06FB_0042_E7A6()
{
	...
	emu_incw(&emu_ax);
	if (--emu_cx != 0) { /* Unresolved jump */ emu_ip = 0x0722; emu_last_cs = 0x2756; emu_last_ip = 0x0739; emu_last_length = 0x0042; emu_last_crc = 0xE7A6; emu_call(); }
 ...
 * Called From: 2756:07D6:0007:3FBD
 */
