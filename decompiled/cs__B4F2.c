...
l__00EB:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x00FF); emu_cs = 0x1DD7; emu_Driver_Voice_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__00FF:
	emu_pop(&emu_cx);
...
l__023A:
	...
	emu_xorw(&emu_si, emu_si);
	emu_push(emu_cs); emu_push(0x0246); emu_cs = 0x1DD7; emu_Driver_Music_FadeOut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0246:
...
l__026F:
	...
	goto l__0272;
l__0272:
	emu_push(emu_cs); emu_push(0x0277); emu_cs = 0x1DD7; emu_Driver_Voice_IsPlaying();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0277:
	emu_orw(&emu_ax, emu_ax);
...
l__030E:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0316); emu_cs = 0x10E4; emu_GUI_DrawInterfaceAndRadar();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0316:
	emu_pop(&emu_cx);
...
l__031C:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x032A); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeSelected();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__032A:
	emu_addw(&emu_sp, 0x6);
...
l__0418:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0432); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0432:
	emu_addw(&emu_sp, 0x6);
...
l__046D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x047B); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__047B:
	emu_addw(&emu_sp, 0x6);
...
l__05C8:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x05D6); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_DrawAll();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__05D6:
	emu_pop(&emu_cx);
...
l__067B:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_cs); emu_push(0x0689); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0689:
	emu_addw(&emu_sp, 0x6);
...
l__070A:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0712); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0712:
	emu_pop(&emu_cx);
...
l__07C9:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x07D3); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeNormal();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__07D3:
	emu_addw(&emu_sp, 0x6);
...
l__0D64:
	...
	emu_ax = 0x2A39;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D7B); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeVisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0D7B:
	emu_pop(&emu_cx);
...
l__0DA9:
	...
	emu_ax = 0x29FD;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0DC0); emu_cs = 0x348B; overlay(0x348B, 0); emu_GUI_Widget_MakeVisible();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0DC0:
	emu_pop(&emu_cx);
