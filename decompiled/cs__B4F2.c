...
l__0083:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0093); emu_cs = 0x3483; overlay(0x3483, 0); f__B483_0283_0014_983A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0093:
	emu_pop(&emu_cx);
...
l__0191:
	...
	emu_push(emu_cs); emu_push(0x019E); emu_cs = 0x34A2; overlay(0x34A2, 0); f__B4A2_0039_000B_EC51();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__019E:
	emu_pop(&emu_cx);
...
l__01AB:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x01B9); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_00F2_0005_601A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__01B9:
	emu_addw(&emu_sp, 0x6);
...
l__02AE:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x02CC); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
...
l__03AA:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x03B7); emu_cs = 0x34A2; overlay(0x34A2, 0); f__B4A2_0039_000B_EC51();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__03B7:
	emu_pop(&emu_cx);
...
l__03C4:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x03D7); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_00F2_0005_601A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__03D7:
	emu_addw(&emu_sp, 0x6);
...
l__0418:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0432); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0432:
	emu_addw(&emu_sp, 0x6);
...
l__046D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x047B); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__047B:
	emu_addw(&emu_sp, 0x6);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0489); emu_cs = 0x34A2; overlay(0x34A2, 0); f__B4A2_0729_0013_2494();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0489:
	emu_pop(&emu_cx);
...
l__0541:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x0550); emu_cs = 0x34A2; overlay(0x34A2, 0); f__B4A2_0039_000B_EC51();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0550:
	emu_pop(&emu_cx);
...
l__055D:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x056F); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_00F2_0005_601A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__056F:
	emu_addw(&emu_sp, 0x6);
...
l__067B:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_cs); emu_push(0x0689); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0689:
	emu_addw(&emu_sp, 0x6);
...
l__07B2:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x07C9); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_00F2_0005_601A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__07C9:
	emu_addw(&emu_sp, 0x6);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x07D3); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__07D3:
	emu_addw(&emu_sp, 0x6);
...
l__0AD8:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_cs); emu_push(0x0AE8); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0AE8:
	emu_addw(&emu_sp, 0x6);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_cs); emu_push(0x0AF6); emu_cs = 0x34A2; overlay(0x34A2, 0); f__B4A2_0729_0013_2494();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0AF6:
	emu_pop(&emu_cx);
...
l__0BCC:
	...
	emu_ax = 0x29FD;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0C2D); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0C2D:
	emu_addw(&emu_sp, 0x6);
	...
	emu_ax = 0x29FD;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0C3A); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0088_0029_3A68();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0C3A:
	emu_pop(&emu_cx);
...
l__0C5F:
	...
	emu_ax = 0x2A39;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0CCA); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0127_000E_E325();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0CCA:
	emu_addw(&emu_sp, 0x6);
	...
	emu_ax = 0x2A39;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0CD7); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0088_0029_3A68();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0CD7:
	emu_pop(&emu_cx);
...
/**
 * Decompiled function f__B4F2_0C43_0017_56DB()
 *
 * @name f__B4F2_0C43_0017_56DB
 * @implements B4F2:0C43:0017:56DB ()
 * @implements B4F2:0C8E:0002:EEBA
 * @implements B4F2:0CE2:0002:C03A
 * @implements B4F2:0CE4:0006:6B66
 * @implements B4F2:0CEA:0003:9B9A
 * @implements B4F2:0CED:0005:8BCF
 *
 * Called From: B4F2:0349:0005:3DBD
 */
void f__B4F2_0C43_0017_56DB()
{
l__0C43:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	emu_cmpw(&emu_bx, 0xD);
	if (emu_bx <= 0xD) { /* Unresolved jump */ emu_ip = 0x0C5A; emu_last_cs = 0xB4F2; emu_last_ip = 0x0C55; emu_last_length = 0x0017; emu_last_crc = 0x56DB; emu_call(); return; }
	goto l__0CE2;
l__0C8E:
	goto l__0CED;
l__0CE2:
...
l__0CE4:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0CEA); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0CEA:
	emu_pop(&emu_cx);
...
l__0D7F:
	...
	emu_ax = 0x2A39;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D89); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0088_0029_3A68();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0D89:
	emu_pop(&emu_cx);
...
l__0DC4:
	...
	emu_ax = 0x29FD;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0DCE); emu_cs = 0x348B; overlay(0x348B, 0); f__B48B_0088_0029_3A68();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0DCE:
	emu_pop(&emu_cx);
...
l__0EF4:
	emu_ax = 0x5;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0EFD); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0EFD:
	emu_pop(&emu_cx);
...
l__0F38:
	emu_ax = 0x5;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0F41); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__0F41:
	emu_pop(&emu_cx);
...
l__0F79:
	...
	emu_get_memory16(emu_ds, 0x00, 0x4192) = emu_ax;
	emu_get_memory16(emu_ds, 0x00, 0x4194) = emu_di;
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x4);
	emu_cl = 0x3;
	emu_sarw(&emu_ax, emu_cl);
	emu_get_memory16(emu_ds, 0x00, 0x4196) = emu_ax;
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
	emu_get_memory16(emu_ds, 0x00, 0x4198) = emu_ax;
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_ax = emu_get_memory16(emu_es, emu_bx, 0x2E);
	emu_andw(&emu_ax, 0x5);
	emu_cmpw(&emu_ax, 0x1);
	if (emu_ax == 0x1) goto l__100B;
	emu_cmpw(&emu_ax, 0x4);
	if (emu_ax == 0x4) goto l__0FFF;
	emu_cmpw(&emu_ax, 0x5);
	if (emu_ax == 0x5) goto l__100B;
	goto l__1012;
l__0FFF:
	emu_get_memory16(emu_ss, emu_bp, -0x8) = 0x2;
l__1004:
	emu_get_memory16(emu_ss, emu_bp, -0xA) = 0xE7;
	goto l__101E;
l__100B:
...
l__1012:
	emu_get_memory16(emu_ss, emu_bp, -0x8) = 0x2;
	emu_get_memory16(emu_ss, emu_bp, -0xA) = 0xE8;
	goto l__101E;
l__101E:
	emu_ax = 0x1;
	emu_push(emu_ax);
...
l__102E:
	...
	if (emu_get_memory16(emu_es, emu_bx, 0x38) != 0x1E) {
		emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
		emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x38), 0x6B);
		if (emu_get_memory16(emu_es, emu_bx, 0x38) != 0x6B) {
			emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
			emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x38), 0x6C);
			if (emu_get_memory16(emu_es, emu_bx, 0x38) != 0x6C) {
				emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
				emu_cmpw(&emu_get_memory16(emu_es, emu_bx, 0x38), 0x66);
				if (emu_get_memory16(emu_es, emu_bx, 0x38) != 0x66) goto l__1075;
			}
		}
	}
l__1059:
...
l__109F:
	emu_addw(&emu_sp, 0xE);
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x2), 0x0);
	if (emu_get_memory16(emu_ss, emu_bp, -0x2) != 0x0) goto l__10ED;
	emu_ax = emu_di;
...
l__112B:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x2A93));
	emu_push(emu_cs); emu_push(0x1138); emu_cs = 0x34A2; overlay(0x34A2, 0); f__B4A2_0039_000B_EC51();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__1138:
	emu_pop(&emu_cx);
...
l__12A5:
	...
	emu_movw(&emu_ax, emu_bp - 0xE);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x12B5); emu_cs = 0x34B1; overlay(0x34B1, 0); f__B4B1_0000_0016_067A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34F2) { overlay(0x34F2, 1); }
l__12B5:
	emu_pop(&emu_cx);
