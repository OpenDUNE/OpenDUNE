 ...
 * Called From: 34F2:0025:0005:15A2
...
void f__B4F2_0222_000F_8F90()
{
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { emu_ip = 0x022F; emu_last_cs = 0xB4F2; emu_last_ip = 0x0225; emu_last_length = 0x000F; emu_last_crc = 0x8F90; emu_call(); return; } // Jump does not resolve
...
void f__B4F2_023A_000C_1C48()
{
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { emu_ip = 0x024C; emu_last_cs = 0xB4F2; emu_last_ip = 0x023D; emu_last_length = 0x000C; emu_last_crc = 0x1C48; emu_call(); return; } // Jump does not resolve
	emu_xorw(&emu_si, emu_si);
...
void f__B4F2_1138_001E_8854()
{
	...
	if (emu_flags.zf) { emu_ip = 0x115B; emu_last_cs = 0xB4F2; emu_last_ip = 0x1152; emu_last_length = 0x001E; emu_last_crc = 0x8854; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x41C2), 0x0);
	if (emu_flags.zf) { emu_ip = 0x135C; emu_last_cs = 0xB4F2; emu_last_ip = 0x1355; emu_last_length = 0x000C; emu_last_crc = 0x6370; emu_call(); return; } // Jump does not resolve
...
void f__B4F2_1363_000C_7B70()
{
	...
	if (emu_flags.zf) { emu_ip = 0x136F; emu_last_cs = 0xB4F2; emu_last_ip = 0x1368; emu_last_length = 0x000C; emu_last_crc = 0x7B70; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x69);
...
void f__B4F2_1380_000C_4B70()
{
	...
	if (emu_flags.zf) { emu_ip = 0x138C; emu_last_cs = 0xB4F2; emu_last_ip = 0x1385; emu_last_length = 0x000C; emu_last_crc = 0x4B70; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x69);
...
void f__B4F2_1391_000C_4370()
{
	...
	emu_movw(&emu_ax.x, 0x69);
	emu_ip = 0x13A0; emu_last_cs = 0xB4F2; emu_last_ip = 0x139B; emu_last_length = 0x000C; emu_last_crc = 0x4370; emu_call(); // Jump does not resolve
}
