 ...
 *
 * Called From: B4F2:000D:000D:C9F0
 */
 ...
 *
 * Called From: B4F2:0029:001C:9C78
 */
 ...
 *
 * Called From: B4F2:0035:000C:02B1
 */
 ...
 *
 * Called From: B4F2:003F:000A:8FD3
 */
 ...
 *
 * Called From: B4F2:0063:0012:A048
 */
 ...
 *
 * Called From: B4F2:007A:0017:F3DE
 */
 ...
 *
 * Called From: B4F2:0083:0009:2605
 */
void f__B4F2_0083_0010_7381()
{
	...
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0093); emu_cs = 0x3483; emu_ip = 0x00B8; emu_last_cs = 0xB4F2; emu_last_ip = 0x008E; emu_last_length = 0x0010; emu_last_crc = 0x7381; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B4F2:00CA:002E:D76F
 */
 ...
 *
 * Called From: B4F2:00EB:0019:2DA2
 */
 ...
 *
 * Called From: B4F2:00FF:0014:7995
 */
 ...
 *
 * Called From: B4F2:0109:000A:BA05
 */
 ...
 *
 * Called From: B4F2:0125:001C:9EE7
 */
 ...
 *
 * Called From: B4F2:0134:000F:54A6
 */
void f__B4F2_0134_0013_7748()
{
	...
	emu_push(emu_cs); emu_push(0x0147); emu_cs = 0x2B6C; emu_ip = 0x027E; emu_last_cs = 0xB4F2; emu_last_ip = 0x0142; emu_last_length = 0x0013; emu_last_crc = 0x7748; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B4F2:0173:0005:3FA8
 */
 ...
 *
 * Called From: B4F2:017D:000A:3489
 */
 ...
 *
 * Called From: B4F2:0189:000C:D4B9
 */
 ...
 *
 * Called From: B4F2:019E:000D:7056
 */
 ...
 *
 * Called From: B4F2:01B9:000E:6100
 */
 ...
 *
 * Called From: B4F2:01CC:0013:C71B
 */
void f__B4F2_01CC_0013_9E8D()
{
	...
	emu_ip = 0x027D; emu_last_cs = 0xB4F2; emu_last_ip = 0x01DC; emu_last_length = 0x0013; emu_last_crc = 0x9E8D; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:01EE:0008:CA33
 */
void f__B4F2_01EE_000A_E23B()
{
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { f__B4F2_01F5_0003_DD01(); return; }
	emu_xorw(&emu_si, emu_si);
	emu_ip = 0x027F; emu_last_cs = 0xB4F2; emu_last_ip = 0x01F5; emu_last_length = 0x000A; emu_last_crc = 0xE23B; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:0201:0009:39F0
 */
void f__B4F2_0201_0009_8EC4()
{
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { f__B4F2_0208_0002_FABA(); return; }
	emu_xorw(&emu_si, emu_si);
	f__B4F2_027F_0015_800B(); return;
}
 ...
 *
 * Called From: B4F2:0215:000B:636B
 */
 ...
 *
 * Called From: B4F2:0222:0009:48EA
 */
void f__B4F2_0222_000F_7024()
{
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { f__B4F2_022F_0002_E73A(); return; }
	emu_xorw(&emu_si, emu_si);
 ...
 *
 * Called From: B4F2:023A:0009:49EC
 */
 ...
 *
 * Called From: B4F2:0246:000C:7BCE
 */
...
void f__B4F2_027F_0015_800B()
{
	...
	if (emu_flags.zf) { emu_ip = 0x02A2; emu_last_cs = 0xB4F2; emu_last_ip = 0x0284; emu_last_length = 0x0015; emu_last_crc = 0x800B; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:0294:0015:800B
 */
 ...
 *
 * Called From: B4F2:02A0:000C:9527
 */
 ...
 * Called From: B4F2:02A7:0005:1765
 * Called From: B4F2:02A7:0007:73D6
 */
...
void f__B4F2_02AE_001E_2B44()
{
	...
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x02CC); emu_cs = 0x252E; emu_ip = 0x02CD; emu_last_cs = 0xB4F2; emu_last_ip = 0x02C7; emu_last_length = 0x001E; emu_last_crc = 0x2B44; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B4F2:031C:0006:58B0
 */
 ...
 *
 * Called From: B4F2:032A:000E:514C
 */
 ...
 *
 * Called From: B4F2:0336:000C:961D
 */
 ...
 *
 * Called From: B4F2:033B:0005:014D
 */
 ...
 *
 * Called From: B4F2:0340:0005:7CF0
 */
 ...
 *
 * Called From: B4F2:0345:0005:D341
 */
 ...
 *
 * Called From: B4F2:036C:0027:E6B6
 */
 ...
 *
 * Called From: B4F2:0396:000F:A3C2
 */
 ...
 *
 * Called From: B4F2:03A2:000C:ECA6
 */
 ...
 *
 * Called From: B4F2:03B7:000D:7056
 */
 ...
 *
 * Called From: B4F2:03D7:0013:1C32
 */
void f__B4F2_03D7_001E_062C()
{
	...
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x046B; emu_last_cs = 0xB4F2; emu_last_ip = 0x03EC; emu_last_length = 0x001E; emu_last_crc = 0x062C; emu_call(); return; } // Jump does not resolve
	emu_shlw(&emu_bx.x, 0x1);
 ...
 *
 * Called From: B4F2:0406:0011:E3EC
 */
 ...
 *
 * Called From: B4F2:0415:000F:AF85
 * Called From: B4F2:0415:0009:8999
 ...
 *
 * Called From: B4F2:0432:001A:FFEB
 */
 ...
 *
 * Called From: B4F2:043E:000C:103B
 * Called From: B4F2:043E:0009:9993
 */
...
void f__B4F2_0440_0019_423E()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { f__B4F2_0451_0008_6C8F(); return; }
 ...
 *
 * Called From: B4F2:047B:000E:814C
 */
 ...
 *
 * Called From: B4F2:0489:000E:A6E7
 */
 ...
 * Called From: B4F2:0490:0005:1765
 * Called From: B4F2:0490:0007:73D6
 */
 ...
 *
 * Called From: B4F2:04A1:000A:CE31
 */
 ...
 *
 * Called From: B4F2:04CC:0015:5960
 */
...
void f__B4F2_04D8_0019_0F72()
{
	...
	emu_ip = 0x04F3; emu_last_cs = 0xB4F2; emu_last_ip = 0x04EF; emu_last_length = 0x0019; emu_last_crc = 0x0F72; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:04FC:000B:A00B
 * Called From: B4F2:04FC:0009:F00D
 */
 ...
 *
 * Called From: B4F2:0516:000D:4D30
 * Called From: B4F2:0516:0010:8F88
 */
 ...
 *
 * Called From: B4F2:0522:000C:DD04
 */
 ...
 *
 * Called From: B4F2:052E:000C:2EB3
 */
 ...
 *
 * Called From: B4F2:0541:0009:A53C
 */
 ...
 *
 * Called From: B4F2:0550:000F:C332
 */
 ...
 *
 * Called From: B4F2:056F:0012:AC5F
 */
void f__B4F2_056F_001C_386D()
{
	...
	if (emu_flags.zf) { emu_ip = 0x058B; emu_last_cs = 0xB4F2; emu_last_ip = 0x0582; emu_last_length = 0x001C; emu_last_crc = 0x386D; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_ax.x, 0x26);
	if (emu_flags.zf) { emu_ip = 0x05DB; emu_last_cs = 0xB4F2; emu_last_ip = 0x0587; emu_last_length = 0x001C; emu_last_crc = 0x386D; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:0606:000A:BD94
 */
 ...
 *
 * Called From: B4F2:061B:0015:09D0
 */
 ...
 *
 * Called From: B4F2:0628:000D:8771
 */
void f__B4F2_0628_000F_6786()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0637; emu_last_cs = 0xB4F2; emu_last_ip = 0x0630; emu_last_length = 0x000F; emu_last_crc = 0x6786; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:0689:000E:7936
 */
 ...
 * Called From: B4F2:0691:0005:1765
 * Called From: B4F2:0691:0008:8DED
 */
 ...
 *
 * Called From: B4F2:06A4:000A:3D33
 */
...
void f__B4F2_06AE_0035_32F1()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x06D9; emu_last_cs = 0xB4F2; emu_last_ip = 0x06D0; emu_last_length = 0x0035; emu_last_crc = 0x32F1; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
 ...
 *
 * Called From: B4F2:06E3:0035:32F1
 */
 ...
 *
 * Called From: B4F2:06EF:000C:EB11
 */
void f__B4F2_06EF_0023_EA60()
{
	...
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpb(&emu_get_memory8(emu_es, emu_bx.x,  0x0), 0x5B);
	if (!emu_flags.zf) { f__B4F2_070A_0008_64F7(); return; }
	emu_movw(&emu_si, emu_get_memory16(emu_ds, 0x00, -0x7F4E));
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0712); emu_cs = 0x2598; emu_ip = 0x0712; emu_last_cs = 0xB4F2; emu_last_ip = 0x070D; emu_last_length = 0x0023; emu_last_crc = 0xEA60; emu_call(); // Jump does not resolve
 ...
 *
 * Called From: B4F2:0712:0008:64F7
 */
 ...
 *
 * Called From: B4F2:071C:000A:DE66
 */
 ...
 *
 * Called From: B4F2:0722:0006:0569
 */
 ...
 *
 * Called From: B4F2:074E:002C:58CA
 */
 ...
 *
 * Called From: B4F2:0756:0008:33E5
 */
 ...
 *
 * Called From: B4F2:0776:001D:11B0
 */
 ...
 *
 * Called From: B4F2:079D:0027:A2D1
 */
void f__B4F2_079D_0015_8FF6()
{
	...
	emu_ip = 0x0836; emu_last_cs = 0xB4F2; emu_last_ip = 0x07AF; emu_last_length = 0x0015; emu_last_crc = 0x8FF6; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:07C9:0017:B773
 */
 ...
 *
 * Called From: B4F2:07D3:000A:F8F6
 */
void f__B4F2_07D3_0015_0F31()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0821; emu_last_cs = 0xB4F2; emu_last_ip = 0x07E4; emu_last_length = 0x0015; emu_last_crc = 0x0F31; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x0834; emu_last_cs = 0xB4F2; emu_last_ip = 0x07E6; emu_last_length = 0x0015; emu_last_crc = 0x0F31; emu_call(); // Jump does not resolve
}
...
void f__B4F2_07E8_0019_E1DC()
{
	...
	if (emu_flags.zf) { emu_ip = 0x081F; emu_last_cs = 0xB4F2; emu_last_ip = 0x07EF; emu_last_length = 0x0019; emu_last_crc = 0xE1DC; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x2A97));
 ...
 *
 * Called From: B4F2:0801:0019:E1DC
 */
 ...
 *
 * Called From: B4F2:0849:000A:8D25
 */
...
void f__B4F2_0855_0013_A7FD()
{
	...
	emu_ip = 0x0D4C; emu_last_cs = 0xB4F2; emu_last_ip = 0x0865; emu_last_length = 0x0013; emu_last_crc = 0xA7FD; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:087D:0015:B404
 */
 ...
 *
 * Called From: B4F2:0889:000C:EE8E
 */
 ...
 *
 * Called From: B4F2:089B:0012:37F8
 */
 ...
 *
 * Called From: B4F2:08AA:000F:B3B1
 */
void f__B4F2_08AA_0023_995F()
{
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_dx.x);
	if (emu_flags.zf) { emu_ip = 0x0902; emu_last_cs = 0xB4F2; emu_last_ip = 0x08AD; emu_last_length = 0x0023; emu_last_crc = 0x995F; emu_call(); return; } // Jump does not resolve
	...
	if (!emu_flags.zf) { emu_ip = 0x08CD; emu_last_cs = 0xB4F2; emu_last_ip = 0x08BF; emu_last_length = 0x0023; emu_last_crc = 0x995F; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:08F7:002A:5752
 * Called From: B4F2:08F7:0028:5BF2
 */
 ...
 *
 * Called From: B4F2:08FF:0008:0683
 */
 ...
 *
 * Called From: B4F2:090E:000F:E61A
 */
void f__B4F2_090E_002B_B1B5()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0939); emu_cs = 0x0FCB; emu_ip = 0x0998; emu_last_cs = 0xB4F2; emu_last_ip = 0x0934; emu_last_length = 0x002B; emu_last_crc = 0xB1B5; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B4F2:0980:0037:8E4A
 */
...
void f__B4F2_0988_0079_A2B2()
{
	...
	emu_movw(&emu_ax.x, emu_ds);
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0x8), emu_ax.x);
	if (!emu_flags.zf) { emu_ip = 0x09EE; emu_last_cs = 0xB4F2; emu_last_ip = 0x09E5; emu_last_length = 0x0079; emu_last_crc = 0xA2B2; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:0A0C:000B:51A5
 * Called From: B4F2:0A0C:0005:3DBD
 */
 ...
 *
 * Called From: B4F2:0A1B:000F:E74D
 */
void f__B4F2_0A1B_00A8_6448()
{
	...
	if (!emu_flags.zf) { f__B4F2_0A44_007F_1761(); return; }
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x8));
...
void f__B4F2_0A23_00A0_F132()
{
	...
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x2A95));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x2A93));
	emu_push(emu_cs); emu_push(0x0AC3); emu_cs = 0x348B; emu_ip = 0x0AE3; emu_last_cs = 0xB4F2; emu_last_ip = 0x0ABE; emu_last_length = 0x00A0; emu_last_crc = 0xF132; emu_call(); // Jump does not resolve
	f__B4F2_0AC3_0015_5E76();
}
 ...
 *
 * Called From: B4F2:0AC3:007F:1761
 * Called From: B4F2:0AC3:00A8:6448
 */
 ...
 *
 * Called From: B4F2:0AD8:0015:5E76
 */
 ...
 *
 * Called From: B4F2:0AE8:0010:CB6F
 */
 ...
 *
 * Called From: B4F2:0AF6:000E:5E9D
 */
...
void f__B4F2_0B05_0044_6791()
{
	...
	emu_ip = 0x0B8D; emu_last_cs = 0xB4F2; emu_last_ip = 0x0B47; emu_last_length = 0x0044; emu_last_crc = 0x6791; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:0B9A:0051:E4E8
 */
 ...
 *
 * Called From: B4F2:0BA2:0008:0683
 */
void f__B4F2_0BA2_0013_29DD()
{
	...
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0BB5; emu_last_cs = 0xB4F2; emu_last_ip = 0x0BB0; emu_last_length = 0x0013; emu_last_crc = 0x29DD; emu_call(); return; } // Jump does not resolve
...
void f__B4F2_0BA6_000F_3ECB()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_cmpw(&emu_ax.x, emu_di);
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x0BB5; emu_last_cs = 0xB4F2; emu_last_ip = 0x0BB0; emu_last_length = 0x000F; emu_last_crc = 0x3ECB; emu_call(); return; } // Jump does not resolve
	f__B4F2_0949_0037_8E4A(); return;
}
...
void f__B4F2_0BB5_000A_6986()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0BBF; emu_last_cs = 0xB4F2; emu_last_ip = 0x0BBA; emu_last_length = 0x000A; emu_last_crc = 0x6986; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:0D0B:0005:6168
 */
 ...
 *
 * Called From: B4F2:0D16:000B:EB1E
 */
 ...
 *
 * Called From: B4F2:0D3B:0025:F411
 */
 ...
 *
 * Called From: B4F2:0D43:0008:43E5
 */
 ...
 *
 * Called From: B4F2:0D4B:0008:64F7
 */
...
void f__B4F2_0D52_0029_1FC2()
{
	...
	if (!emu_flags.zf) { f__B4F2_0D64_0017_7F9F(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x2A97));
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0D7F; emu_last_cs = 0xB4F2; emu_last_ip = 0x0D6F; emu_last_length = 0x0029; emu_last_crc = 0x1FC2; emu_call(); return; } // Jump does not resolve
	emu_push(emu_ds);
	emu_movw(&emu_ax.x, 0x2A39);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0D7B); emu_cs = 0x348B; emu_ip = 0x0DA5; emu_last_cs = 0xB4F2; emu_last_ip = 0x0D76; emu_last_length = 0x0029; emu_last_crc = 0x1FC2; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__B4F2_0D64_0017_7F9F()
{
	...
	emu_movw(&emu_ax.x, 0x2A39);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0D7B); emu_cs = 0x348B; emu_ip = 0x0DA5; emu_last_cs = 0xB4F2; emu_last_ip = 0x0D76; emu_last_length = 0x0017; emu_last_crc = 0x7F9F; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B4F2:0D89:000A:F079
 */
 ...
 *
 * Called From: B4F2:0D99:0010:3CB0
 */
...
void f__B4F2_0DA7_0019_443B()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0DC0); emu_cs = 0x348B; emu_ip = 0x0DEA; emu_last_cs = 0xB4F2; emu_last_ip = 0x0DBB; emu_last_length = 0x0019; emu_last_crc = 0x443B; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__B4F2_0DA9_0017_0422()
{
	...
	emu_movw(&emu_ax.x, 0x29FD);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0DC0); emu_cs = 0x348B; emu_ip = 0x0DEA; emu_last_cs = 0xB4F2; emu_last_ip = 0x0DBB; emu_last_length = 0x0017; emu_last_crc = 0x0422; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B4F2:0DCE:000A:347F
 */
 ...
 *
 * Called From: B4F2:0DDE:0010:B907
 */
 ...
 *
 * Called From: B4F2:0E02:001F:AB1C
 */
 ...
 *
 * Called From: B4F2:0E12:0010:2CBB
 */
 ...
 *
 * Called From: B4F2:0E2F:0019:86E9
 */
 ...
 *
 * Called From: B4F2:0E4B:001C:FAAE
 */
...
void f__B4F2_0E73_0011_CF2A()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_ss);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax.x);
	emu_ip = 0x0EC3; emu_last_cs = 0xB4F2; emu_last_ip = 0x0E82; emu_last_length = 0x0011; emu_last_crc = 0xCF2A; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B4F2:0EBC:0038:CF2A
 */
...
void f__B4F2_0EC3_0016_F9AF()
{
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, -0x6674));
	emu_push(emu_get_memory16(emu_ds, 0x00, -0x6676));
	emu_push(emu_cs); emu_push(0x0ED9); emu_cs = 0x259E; emu_ip = 0x0F19; emu_last_cs = 0xB4F2; emu_last_ip = 0x0ED4; emu_last_length = 0x0016; emu_last_crc = 0xF9AF; emu_call(); // Jump does not resolve
	f__B4F2_0ED9_0007_EF7C();
}
 ...
 *
 * Called From: B4F2:0ED9:001D:B10D
 */
 ...
 *
 * Called From: B4F2:0EEE:000E:BC8E
 */
 ...
 *
 * Called From: B4F2:0EF4:0006:0569
 */
 ...
 *
 * Called From: B4F2:0EFD:0009:C306
 */
 ...
 *
 * Called From: B4F2:0F1A:001D:FFB4
 */
 ...
 *
 * Called From: B4F2:0F22:0008:33E5
 */
 ...
 *
 * Called From: B4F2:0F32:000E:BC8E
 */
 ...
 *
 * Called From: B4F2:0F38:0006:0569
 */
 ...
 *
 * Called From: B4F2:0F41:0009:C306
 */
 ...
 *
 * Called From: B4F2:0F5E:001D:FF8F
 */
 ...
 *
 * Called From: B4F2:0F66:0008:33E5
 */
 ...
 *
 * Called From: B4F2:0F79:0011:1140
 */
 ...
 *
 * Called From: B4F2:102E:0010:DC57
 */
void f__B4F2_102E_0047_75DD()
{
	...
	if (emu_flags.zf) { f__B4F2_1059_001C_705D(); return; }
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
 ...
 *
 * Called From: B4F2:1097:0022:D216
 * Called From: B4F2:1097:000C:2AAD
 */
 ...
 *
 * Called From: B4F2:109F:0008:0683
 */
 ...
 *
 * Called From: B4F2:10BB:001C:4E38
 */
 ...
 *
 * Called From: B4F2:10E5:002A:1D60
 */
 ...
 * Called From: B4F2:10ED:0008:F38A
 */
 ...
 *
 * Called From: B4F2:10F5:0008:1199
 */
 ...
 *
 * Called From: B4F2:1119:0019:B3DC
 */
 ...
 *
 * Called From: B4F2:1124:000B:D674
 */
 ...
 *
 * Called From: B4F2:1138:000D:7056
 */
void f__B4F2_1138_001E_D0F3()
{
	...
	emu_ip = 0x115F; emu_last_cs = 0xB4F2; emu_last_ip = 0x1154; emu_last_length = 0x001E; emu_last_crc = 0xD0F3; emu_call(); // Jump does not resolve
}
 ...
 * Called From: B4F2:1168:0005:1765
 * Called From: B4F2:1168:0007:EB00
 */
 ...
 *
 * Called From: B4F2:1175:000D:BD26
 */
 ...
 *
 * Called From: B4F2:1198:000B:BBAE
 * Called From: B4F2:1198:000C:BFCE
 */
 ...
 *
 * Called From: B4F2:11A5:000D:4FB1
 */
 ...
 *
 * Called From: B4F2:11CA:0016:244A
 */
 ...
 *
 * Called From: B4F2:11E2:0013:5635
 */
void f__B4F2_11E2_0018_1D91()
{
	emu_addws(&emu_sp, 0x6);
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp, -0x2), 0xFF);
	if (emu_flags.zf) { emu_ip = 0x1219; emu_last_cs = 0xB4F2; emu_last_ip = 0x11E9; emu_last_length = 0x0018; emu_last_crc = 0x1D91; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:11FA:0018:1D91
 */
 ...
 *
 * Called From: B4F2:1208:000E:5317
 */
void f__B4F2_1208_0011_0023()
{
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp,  0x8));
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x1219; emu_last_cs = 0xB4F2; emu_last_ip = 0x120B; emu_last_length = 0x0011; emu_last_crc = 0x0023; emu_call(); return; } // Jump does not resolve
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__B4F2_1214_0005_D7FA(); return; }
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x6));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x1219; emu_last_cs = 0xB4F2; emu_last_ip = 0x1212; emu_last_length = 0x0011; emu_last_crc = 0x0023; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x1);
	emu_ip = 0x121D; emu_last_cs = 0xB4F2; emu_last_ip = 0x1217; emu_last_length = 0x0011; emu_last_crc = 0x0023; emu_call(); // Jump does not resolve
}
...
void f__B4F2_1246_001A_72DC()
{
	...
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp,  0x6), 0x0);
	if (emu_flags.zf) { emu_ip = 0x1279; emu_last_cs = 0xB4F2; emu_last_ip = 0x1255; emu_last_length = 0x001A; emu_last_crc = 0x72DC; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:1260:001A:72DC
 */
 ...
 *
 * Called From: B4F2:1274:0014:86F2
 */
 ...
 *
 * Called From: B4F2:1298:000F:0377
 */
 ...
 *
 * Called From: B4F2:12A5:000D:4FB1
 */
void f__B4F2_12A5_0010_09E9()
{
	...
	emu_pop(&emu_cx.x);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (emu_flags.zf) { emu_ip = 0x12E6; emu_last_cs = 0xB4F2; emu_last_ip = 0x12A9; emu_last_length = 0x0010; emu_last_crc = 0x09E9; emu_call(); return; } // Jump does not resolve
	emu_push(emu_ss);
	emu_movw(&emu_ax.x, emu_bp - 0xE);
	emu_push(emu_ax.x);
 ...
 *
 * Called From: B4F2:12B5:0010:09E9
 */
 ...
 *
 * Called From: B4F2:12DA:0025:4F31
 */
 ...
 *
 * Called From: B4F2:12E3:0009:06A3
 */
...
{
	emu_cmpws(&emu_si, 0x5);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x12FD; emu_last_cs = 0xB4F2; emu_last_ip = 0x12F8; emu_last_length = 0x0008; emu_last_crc = 0x87B8; emu_call(); return; } // Jump does not resolve
	f__B4F2_122E_0018_F493(); return;
}
...
void f__B4F2_1321_002F_0347()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_orw(&emu_ax.x, emu_ax.x);
	if (!emu_flags.zf) { f__B4F2_1348_0008_E6C9(); return; }
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), 0x0);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x0);
 ...
 *
 * Called From: B4F2:13AA:0006:6B66
 */
...
void f__B4F2_13CE_0013_65D7()
{
	...
	emu_ip = 0x1470; emu_last_cs = 0xB4F2; emu_last_ip = 0x13DE; emu_last_length = 0x0013; emu_last_crc = 0x65D7; emu_call(); // Jump does not resolve
}
...
void f__B4F2_13E1_0060_F8EA()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x1444; emu_last_cs = 0xB4F2; emu_last_ip = 0x142C; emu_last_length = 0x0060; emu_last_crc = 0xF8EA; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_di);
	emu_addw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_ax.x);
	emu_movw(&emu_ax.x, emu_si);
 ...
 *
 * Called From: B4F2:1441:0060:F8EA
 */
 ...
 *
 * Called From: B4F2:1461:0020:1786
 */
void f__B4F2_1461_000F_9CB8()
{
	emu_addws(&emu_sp, 0xA);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6C91), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x1470; emu_last_cs = 0xB4F2; emu_last_ip = 0x1469; emu_last_length = 0x000F; emu_last_crc = 0x9CB8; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B4F2:1470:000F:9CB8
 */
