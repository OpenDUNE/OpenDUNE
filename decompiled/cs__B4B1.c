...
void f__B4B1_0409_001F_F908()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0428); emu_cs = 0x1FB5; emu_ip = 0x12C4; emu_last_cs = 0xB4B1; emu_last_ip = 0x0423; emu_last_length = 0x001F; emu_last_crc = 0xF908; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
