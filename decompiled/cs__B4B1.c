 ...
 *
 * Called From: B4B1:0428:001F:F908
 */
 ...
 * Called From: B4B1:043A:0012:20E5
 */
...
void f__B4B1_0483_001D_92B3()
{
	...
	emu_addws(&emu_cx, 0xF8);
	emu_adcws(&emu_bx, 0xFF);
	emu_push(emu_bx);
	emu_push(emu_cx);
