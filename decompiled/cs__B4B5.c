...
void f__B4B5_0014_0038_72B6()
{
	...
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x38B0), emu_ax);
...
void f__B4B5_00A4_0022_04BB()
{
	...
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC7);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00C6); emu_cs = 0x34FC; ovl__34FC(0);
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B5) { ovl__34B5(0xFF); }
	f__B4B5_00C6_001F_0DBE(); return;
}
...
{
	emu_addw(&emu_sp, 0xE);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x8D01), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8D03));
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1ED0);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
...
{
	emu_addw(&emu_sp, 0xE);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x8D03), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x8D05));
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EDE);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EDA);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0104); emu_cs = 0x34FC; ovl__34FC(0);
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B5) { ovl__34B5(0xFF); }
	f__B4B5_0104_0023_B49E(); return;
}
...
void f__B4B5_0104_0023_B49E()
{
	emu_addw(&emu_sp, 0xE);
	emu_cwd();
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x8D07), emu_dx);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x8D05), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EE3);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
...
{
	emu_addw(&emu_sp, 0xE);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x8D0B), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x39FC));
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EEB);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
...
{
	emu_addw(&emu_sp, 0xE);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x8D09), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_movw(&emu_ax, 0xD);
	emu_push(emu_ax);
	...
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F17);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F0A);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
...
void f__B4B5_01B3_0026_A872()
{
	...
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F2E);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F23);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
...
void f__B4B5_01D9_0026_480D()
{
	...
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F43);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F37);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC1);
	emu_push(emu_ax);
...
void f__B4B5_021B_0041_D371()
{
	...
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F56);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F50);
	emu_push(emu_ax);
...
void f__B4B5_02E9_0024_0501()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_movw(&emu_ax, 0x27);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F73);
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xC));
...
void f__B4B5_030D_003F_A1B8()
{
	...
	if (emu_flags.zf) {
		...
		emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x3A3C), emu_ax);
		emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x3A3A), emu_dx);
		emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
		emu_movw(&emu_ax, emu_get_memory16(emu_es, emu_bx, 0x12));
		emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x38B4), emu_ax);
	}
	f__B4B5_0343_0009_0B24(); return;
}
...
void f__B4B5_034C_0019_3E28()
{
	...
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B5) { ovl__34B5(0xFF); }
	/* Unresolved jump */ emu_ip = 0x0365; emu_last_cs = 0xB4B5; emu_last_ip = 0x0360; emu_last_length = 0x0019; emu_last_crc = 0x3E28; emu_call();
}
...
void f__B4B5_052E_0019_A2F9()
{
	...
	emu_pop(&emu_cx);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_movb(&emu_get_memory8(emu_es, emu_bx, 0x64), emu_al);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F83);
	emu_push(emu_ax);
	emu_xorw(&emu_ax, emu_ax);
	emu_xorw(&emu_dx, emu_dx);
	emu_push(emu_ax);
...
void f__B4B5_057A_0017_470E()
{
	...
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34B5) { ovl__34B5(0xFF); }
	/* Unresolved jump */ emu_ip = 0x0591; emu_last_cs = 0xB4B5; emu_last_ip = 0x058C; emu_last_length = 0x0017; emu_last_crc = 0x470E; emu_call();
}
...
void f__B4B5_05B5_001F_CB42()
{
	emu_addw(&emu_sp, 0x6);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_movb(&emu_get_memory8(emu_es, emu_bx, 0x9), 0x0);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
...
void f__B4B5_0A4C_0024_5A64()
{
	...
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EC0);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F96);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1EDA);
	emu_push(emu_ax);
...
void f__B4B5_0D54_0023_4ECB()
{
	...
	emu_movw(&emu_bx, emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, emu_bx, 0x8D43), emu_dx);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F81);
	emu_push(emu_ax);
	emu_xorw(&emu_ax, emu_ax);
...
void f__B4B5_0D8F_002E_8780()
{
	...
	emu_movw(&emu_bx, emu_ax);
	emu_pop(&emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, emu_bx, 0x8D45), emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F81);
	emu_push(emu_ax);
	emu_xorw(&emu_ax, emu_ax);
...
void f__B4B5_0DC7_0027_5285()
{
	...
	emu_movw(&emu_bx, emu_ax);
	emu_pop(&emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, emu_bx, 0x8D47), emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x1F81);
	emu_push(emu_ax);
	emu_push(emu_ss);
...
void f__B4B5_0E02_003C_C4FF()
{
	...
	emu_imuluw(&emu_ax, emu_dx);
	emu_movw(&emu_bx, emu_ax);
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, emu_bx, 0x8D47));
	emu_push(emu_ax);
	emu_movw(&emu_ax, emu_si);
	emu_movw(&emu_dx, 0xA);
	emu_imuluw(&emu_ax, emu_dx);
	emu_movw(&emu_bx, emu_ax);
	emu_pop(&emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, emu_bx, 0x8D49), emu_ax);
	emu_movw(&emu_ax, emu_si);
	emu_movw(&emu_dx, 0xA);
	emu_imuluw(&emu_ax, emu_dx);
	emu_movw(&emu_dx, emu_get_memory16(emu_ss, emu_bp, -0x12));
	emu_movw(&emu_bx, emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, emu_bx, 0x8D4B), emu_dx);
	f__B4B5_0E33_000B_414C(); return;
}
...
void f__B4B5_103C_001B_6488()
{
	...
	emu_movw(&emu_get_memory16(emu_ds, emu_bx, 0x97E7), emu_ax);
	f__B4B5_104C_000B_714A(); return;
}
...
void f__B4B5_105D_001D_B706()
{
	...
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x38AE), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x38AC), emu_dx);
	emu_movw(&emu_ax, 0x1);
	f__B4B5_0011_0003_9539(); return;
}
