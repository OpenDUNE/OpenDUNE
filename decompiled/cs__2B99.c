...
void f__2B99_0002_0012_E0C1()
{
	...
	/* Unresolved jump */ emu_ip = 0x0018; emu_last_cs = 0x2B99; emu_last_ip = 0x0012; emu_last_length = 0x0012; emu_last_crc = 0xE0C1; emu_call();
}
...
void f__2B99_0018_0016_016B()
{
	...
	/* Unresolved jump */ emu_ip = 0x0032; emu_last_cs = 0x2B99; emu_last_ip = 0x002C; emu_last_length = 0x0016; emu_last_crc = 0x016B; emu_call();
}
...
void f__2B99_0032_0019_5301()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x004B; emu_last_cs = 0x2B99; emu_last_ip = 0x003B; emu_last_length = 0x0019; emu_last_crc = 0x5301; emu_call(); return; }
