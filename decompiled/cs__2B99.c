...
void f__2B99_0002_0012_E0C1()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x0014; emu_last_cs = 0x2B99; emu_last_ip = 0x0006; emu_last_length = 0x0012; emu_last_crc = 0xE0C1; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_cx.x, emu_get_memory16(emu_ds, 0x00,  0x706E));
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__2B99_0018_0016_016B(); return; }
	emu_movw(&emu_cx.x, emu_get_memory16(emu_ds, 0x00,  0x706E));
	emu_ip = 0x0018; emu_last_cs = 0x2B99; emu_last_ip = 0x0012; emu_last_length = 0x0012; emu_last_crc = 0xE0C1; emu_call(); // Jump does not resolve
}
...
void f__2B99_0018_0016_016B()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x002E; emu_last_cs = 0x2B99; emu_last_ip = 0x0020; emu_last_length = 0x0016; emu_last_crc = 0x016B; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x7072));
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__2B99_0032_0019_5301(); return; }
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x7072));
	emu_ip = 0x0032; emu_last_cs = 0x2B99; emu_last_ip = 0x002C; emu_last_length = 0x0016; emu_last_crc = 0x016B; emu_call(); // Jump does not resolve
}
...
void f__2B99_0032_0019_5301()
{
	...
	if (emu_flags.zf) { emu_ip = 0x004B; emu_last_cs = 0x2B99; emu_last_ip = 0x003B; emu_last_length = 0x0019; emu_last_crc = 0x5301; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x7068), 0x1);
	if (!emu_flags.zf) { emu_ip = 0x0046; emu_last_cs = 0x2B99; emu_last_ip = 0x0042; emu_last_length = 0x0019; emu_last_crc = 0x5301; emu_call(); return; } // Jump does not resolve
	emu_shlw(&emu_cx.x, 0x1);
	emu_movw(&emu_ax.x, 0x4);
	emu_pushf(); emu_flags.inf = 0; emu_push(emu_cs); emu_cs = 0x0070; emu_push(0x004B); f__0070_0198_0005_E61B();
	f__2B99_004B_001E_8FB8();
}
...
void f__2B99_004B_001E_8FB8()
{
	...
	if (!emu_flags.zf) { f__2B99_005D_000C_9EC2(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x7062));
	emu_cmpw(&emu_get_memory16(emu_ds, 0x00,  0x707E), emu_ax.x);
	if (emu_flags.zf) { emu_ip = 0x007A; emu_last_cs = 0x2B99; emu_last_ip = 0x005B; emu_last_length = 0x001E; emu_last_crc = 0x8FB8; emu_call(); return; } // Jump does not resolve
...
void f__2B99_007B_0019_5737()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x0086; emu_last_cs = 0x2B99; emu_last_ip = 0x008B; emu_last_length = 0x0019; emu_last_crc = 0x5737; emu_call(); return; } // Jump does not resolve
	emu_incw(&emu_get_memory16(emu_ds, 0x00,  0x705E));
	emu_push(0x0094); f__2B99_0002_0012_E0C1();
	f__2B99_0094_0008_0A2F();
}
