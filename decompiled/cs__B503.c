...
void f__B503_003C_0011_AE34()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x004D; emu_last_cs = 0xB503; emu_last_ip = 0x0043; emu_last_length = 0x0011; emu_last_crc = 0xAE34; emu_call(); return; }
...
{
	emu_addw(&emu_sp, 0x6);
	emu_movw(&emu_ax, 0x8F);
	emu_push(emu_ax);
	emu_movw(&emu_ax, 0x137);
	emu_push(emu_ax);
...
void f__B503_0129_001A_AA1B()
{
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0143); emu_cs = 0x01F7; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0143_002B_640D(); return;
}
...
void f__B503_0143_002B_640D()
{
	...
	emu_push(emu_dx);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x81BA);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x016E); emu_cs = 0x01F7; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_016E_0016_9A37(); return;
}
...
void f__B503_016E_0016_9A37()
{
	...
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x81C6);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0184); emu_cs = 0x01F7; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0184_0023_CE81(); return;
}
...
void f__B503_01CB_0012_E385()
{
	...
	emu_cmpw(&emu_ax, 0x1);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0206; emu_last_cs = 0xB503; emu_last_ip = 0x01D4; emu_last_length = 0x0012; emu_last_crc = 0xE385; emu_call(); return; }
	emu_cmpw(&emu_ax, 0x2);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x01DD; emu_last_cs = 0xB503; emu_last_ip = 0x01D9; emu_last_length = 0x0012; emu_last_crc = 0xE385; emu_call(); return; }
...
{
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81B4), 0x0);
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0x8), 0x0);
	if (!emu_flags.zf) { f__B503_0295_0008_E8E9(); return; }
	f__B503_03F2_0005_7F8C(); return;
}
...
/**
 * Decompiled function f__B503_03F2_0005_7F8C()
 *
 * @name f__B503_03F2_0005_7F8C
 * @implements B503:03F2:0005:7F8C ()
 *
 * Called From: B503:029A:0008:E8E9
 */
void f__B503_03F2_0005_7F8C()
{
	emu_push(emu_cs);
	emu_push(0x03F7); f__B503_1029_000F_8100();
	f__B503_03F7_001E_A1B7(); return;
}
...
void f__B503_044B_0028_9194()
{
	...
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	/* Unresolved jump */ emu_ip = 0x0473; emu_last_cs = 0xB503; emu_last_ip = 0x046E; emu_last_length = 0x0028; emu_last_crc = 0x9194; emu_call();
}
...
void f__B503_04BA_0013_3B9E()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x04CE; emu_last_cs = 0xB503; emu_last_ip = 0x04C3; emu_last_length = 0x0013; emu_last_crc = 0x3B9E; emu_call(); return; }
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_cs);
	emu_push(0x04CD); f__B503_0CB3_001A_FEEE();
	f__B503_04CD_0006_E56C(); return;
}
...
void f__B503_04D3_0012_2CFC()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { /* Unresolved jump */ emu_ip = 0x04FB; emu_last_cs = 0xB503; emu_last_ip = 0x04DA; emu_last_length = 0x0012; emu_last_crc = 0x2CFC; emu_call(); return; }
	emu_movw(&emu_ax, 0x11E);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x04E5); emu_cs = 0x0FCB; f__0FCB_005F_001C_FDC4();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_04E5_0008_2522(); return;
}
...
void f__B503_0529_001A_2E3C()
{
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3C34));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0543); emu_cs = 0x01F7; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0543_0012_7598(); return;
}
...
void f__B503_0668_0039_8E6A()
{
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
	if (!emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0672; emu_last_cs = 0xB503; emu_last_ip = 0x066B; emu_last_length = 0x0039; emu_last_crc = 0x8E6A; emu_call(); return; }
...
void f__B503_071D_0008_831B()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { f__B503_0725_0017_C95A(); return; }
...
void f__B503_0725_0017_C95A()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0xE), emu_ax);
	emu_xorw(&emu_si, emu_si);
	/* Unresolved jump */ emu_ip = 0x0751; emu_last_cs = 0xB503; emu_last_ip = 0x073A; emu_last_length = 0x0017; emu_last_crc = 0xC95A; emu_call();
}
...
void f__B503_07A0_0037_C389()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x07DA; emu_last_cs = 0xB503; emu_last_ip = 0x07A7; emu_last_length = 0x0037; emu_last_crc = 0xC389; emu_call(); return; }
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_movw(&emu_ax, 0x2);
	emu_push(emu_ax);
...
void f__B503_0845_000C_45BE()
{
	...
	emu_pop(&emu_cx);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x2B1D);
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0851); f__B503_0F0C_0010_028B();
	f__B503_0851_000E_13B7(); return;
}
...
void f__B503_089B_0008_2C18()
{
	...
	f__B503_089F_0004_F2B9(); return;
}

/**
 * Decompiled function f__B503_089F_0004_F2B9()
 *
 * @name f__B503_089F_0004_F2B9
 * @implements B503:089F:0004:F2B9 ()
 *
 * Called From: B503:08B6:0010:6CEF
 */
void f__B503_089F_0004_F2B9()
{
	emu_xorw(&emu_ax, emu_ax);
 ...
 * Called From: B503:08B4:0010:6CEF
 */
void f__B503_08B8_0020_4B31()
{
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x7066));
	emu_addw(&emu_ax, 0xFFE8);
	emu_movw(&emu_dx, 0x130);
	emu_imuluw(&emu_ax, emu_dx);
	emu_movw(&emu_bx, emu_get_memory16(emu_ds, 0x00, 0x7064));
	emu_addw(&emu_bx, emu_ax);
	emu_movw(&emu_es, emu_get_memory16(emu_ds, 0x00, 0x81D8));
	emu_addw(&emu_bx, emu_get_memory16(emu_ds, 0x00, 0x81D6));
	emu_movb(&emu_al, emu_get_memory8(emu_es, emu_bx, 0xFFF8));
 ...
 * Called From: B503:08A1:0004:F2B9
 */
...
/**
 * Decompiled function f__B503_0B75_0009_8B36()
 *
 * @name f__B503_0B75_0009_8B36
 * @implements B503:0B75:0009:8B36 ()
 *
 * Called From: B503:0BA8:001A:2779
 * Called From: B503:0BA8:001D:2AE3
 */
void f__B503_0B75_0009_8B36()
{
	emu_push(emu_si);
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	...
	f__B503_0B7E_000C_88DF(); return;
}

/**
 * Decompiled function f__B503_0B7E_000C_88DF()
 *
 * @name f__B503_0B7E_000C_88DF
 * @implements B503:0B7E:000C:88DF ()
 *
 */
void f__B503_0B7E_000C_88DF()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_si);
	...
	f__B503_0B8A_000C_8BD0(); return;
}

/**
 * Decompiled function f__B503_0B8A_000C_8BD0()
 *
 * @name f__B503_0B8A_000C_8BD0
 * @implements B503:0B8A:000C:8BD0 ()
 *
 */
void f__B503_0B8A_000C_8BD0()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_si);
	...
	f__B503_0B96_000C_8DD5(); return;
}

/**
 * Decompiled function f__B503_0B96_000C_8DD5()
 *
 * @name f__B503_0B96_000C_8DD5
 * @implements B503:0B96:000C:8DD5 ()
 *
 */
void f__B503_0B96_000C_8DD5()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_si);
	...
	f__B503_0BA2_001D_2AE3(); return;
}

/**
 * Decompiled function f__B503_0BA2_001D_2AE3()
 *
 * @name f__B503_0BA2_001D_2AE3
 * @implements B503:0BA2:001D:2AE3 ()
 *
 */
void f__B503_0BA2_001D_2AE3()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_incw(&emu_si);
...
void f__B503_0BA5_001A_2779()
{
	...
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__B503_0B75_0009_8B36(); return; }
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x81D4));
	emu_movw(&emu_dx, emu_get_memory16(emu_ds, 0x00, 0x81D2));
	emu_addw(&emu_dx, 0x2);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_ax);
 ...
 * Called From: B503:0BE6:0017:FDD1
 */
void f__B503_0BBF_0018_8CAA()
{
	...
	f__B503_0BD7_0017_FDD1(); return;
}

/**
 * Decompiled function f__B503_0BD7_0017_FDD1()
 *
 * @name f__B503_0BD7_0017_FDD1
 * @implements B503:0BD7:0017:FDD1 ()
 *
 */
void f__B503_0BD7_0017_FDD1()
{
	emu_addw(&emu_sp, 0x6);
	f__B503_0BDA_0014_ECE4(); return;
}
 ...
 * Called From: B503:0BBD:001D:2AE3
 */
...
void f__B503_0BEE_002A_B077()
{
	...
	emu_movw(&emu_ax, emu_bp - 0x8);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0C18); emu_cs = 0x01F7; f__01F7_39C4_0031_EE87();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0C18_0019_4C6C(); return;
}

/**
 * Decompiled function f__B503_0C18_0019_4C6C()
 *
 * @name f__B503_0C18_0019_4C6C
 * @implements B503:0C18:0019:4C6C ()
 *
 */
void f__B503_0C18_0019_4C6C()
{
	emu_addw(&emu_sp, 0xA);
	...
	emu_movw(&emu_ax, 0x9939);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0C31); emu_cs = 0x01F7; f__01F7_378D_0020_0F64();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0C31_0029_A705(); return;
}

/**
 * Decompiled function f__B503_0C31_0029_A705()
 *
 * @name f__B503_0C31_0029_A705
 * @implements B503:0C31:0029:A705 ()
 *
 */
void f__B503_0C31_0029_A705()
{
	emu_addw(&emu_sp, 0xA);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x81DC));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x81DA));
	...
	emu_movw(&emu_ax, 0x9939);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0C5A); emu_cs = 0x34FC; ovl__34FC(1);
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0C5A_001E_FA7B(); return;
}

/**
 * Decompiled function f__B503_0C5A_001E_FA7B()
 *
 * @name f__B503_0C5A_001E_FA7B
 * @implements B503:0C5A:001E:FA7B ()
 *
 */
void f__B503_0C5A_001E_FA7B()
{
	emu_addw(&emu_sp, 0x16);
	emu_orw(&emu_ax, emu_dx);
	if (emu_flags.zf) { f__B503_0CAD_0006_F7CE(); return; }
	emu_movw(&emu_ax, emu_bp - 0x6D);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_ss);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	f__B503_0C6A_000E_2E19(); return;
}

/**
 * Decompiled function f__B503_0C6A_000E_2E19()
 *
 * @name f__B503_0C6A_000E_2E19
 * @implements B503:0C6A:000E:2E19 ()
 *
 * Called From: B503:0CAB:0024:12AC
 */
void f__B503_0C6A_000E_2E19()
{
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0C78); emu_cs = 0x01F7; f__01F7_2252_0045_03CB();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_0C78_0017_B83B(); return;
}

/**
 * Decompiled function f__B503_0C78_0017_B83B()
 *
 * @name f__B503_0C78_0017_B83B
 * @implements B503:0C78:0017:B83B ()
 *
 */
void f__B503_0C78_0017_B83B()
{
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_movw(&emu_di, emu_ax);
	...
	f__B503_0C8D_0002_C1BA(); return;
}

/**
 * Decompiled function f__B503_0C8D_0002_C1BA()
 *
 * @name f__B503_0C8D_0002_C1BA
 * @implements B503:0C8D:0002:C1BA ()
 *
 * Called From: B503:0C7E:0017:B83B
 */
void f__B503_0C8D_0002_C1BA()
{
	f__B503_0C92_0021_EA5C(); return;
}

/**
 * Decompiled function f__B503_0C8F_0024_12AC()
 *
 * @name f__B503_0C8F_0024_12AC
 * @implements B503:0C8F:0024:12AC ()
 *
 * Called From: B503:0CA2:0021:EA5C
 * Called From: B503:0CA2:0024:12AC
 */
void f__B503_0C8F_0024_12AC()
{
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x4));
	f__B503_0C92_0021_EA5C(); return;
}
...
/**
 * Decompiled function f__B503_0C92_0021_EA5C()
 *
 * @name f__B503_0C92_0021_EA5C
 * @implements B503:0C92:0021:EA5C ()
 *
 * Called From: B503:0C8D:0017:B83B
 * Called From: B503:0C8D:0002:C1BA
 */
void f__B503_0C92_0021_EA5C()
{
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	...
	if (!emu_flags.zf) {
		...
		if (!emu_flags.zf) { f__B503_0C8F_0024_12AC(); return; }
	}
	f__B503_0CA4_000F_E66C(); return;
}

/**
 * Decompiled function f__B503_0CA4_000F_E66C()
 *
 * @name f__B503_0CA4_000F_E66C
 * @implements B503:0CA4:000F:E66C ()
 *
 * Called From: B503:0C99:0024:12AC
 * Called From: B503:0C99:0021:EA5C
 */
void f__B503_0CA4_000F_E66C()
{
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpb(&emu_get_memory8(emu_es, emu_bx, 0x0), 0x2C);
	if (emu_flags.zf) { f__B503_0C6A_000E_2E19(); return; }
	f__B503_0CAD_0006_F7CE(); return;
}

/**
 * Decompiled function f__B503_0CAD_0006_F7CE()
 *
 * @name f__B503_0CAD_0006_F7CE
 * @implements B503:0CAD:0006:F7CE ()
 *
 * Called From: B503:0C5F:001E:FA7B
 */
void f__B503_0CAD_0006_F7CE()
{
	emu_pop(&emu_di);
	emu_pop(&emu_si);
	emu_movw(&emu_sp, emu_bp);
...
void f__B503_0D51_0024_968B()
{
	...
	emu_movw(&emu_di, emu_ax);
	emu_orw(&emu_di, emu_di);
	if (emu_flags.zf) { f__B503_0DC1_0002_C1BA(); return; }
	emu_push(emu_di);
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x37B6));
	emu_movb(&emu_cl, 0x2);
	emu_shlw(&emu_ax, emu_cl);
...
{
	emu_addw(&emu_sp, 0x6);
	f__B503_0DC1_0002_C1BA(); return;
}

/**
 * Decompiled function f__B503_0DC1_0002_C1BA()
 *
 * @name f__B503_0DC1_0002_C1BA
 * @implements B503:0DC1:0002:C1BA ()
 *
 * Called From: B503:0D57:0024:968B
 */
void f__B503_0DC1_0002_C1BA()
{
 ...
 * Called From: B503:0DC1:0002:C1BA
 */
 ...
 * Called From: B503:0DCD:001E:D498
 */
...
void f__B503_0EB1_0011_8F4C()
{
	...
	if (emu_flags.zf) { f__B503_0F07_0005_8BCF(); return; }
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0EC2); f__B503_13C2_0008_C4BB();
	f__B503_0EC2_0008_3318(); return;
}
...
{
	emu_addw(&emu_sp, 0x10);
	f__B503_0F07_0005_8BCF(); return;
}

/**
 * Decompiled function f__B503_0F07_0005_8BCF()
 *
 * @name f__B503_0F07_0005_8BCF
 * @implements B503:0F07:0005:8BCF ()
 *
 * Called From: B503:0EB8:0011:8F4C
 */
void f__B503_0F07_0005_8BCF()
{
	emu_pop(&emu_si);
	emu_movw(&emu_sp, emu_bp);
	emu_pop(&emu_bp);
...
void f__B503_0F9C_0020_EDC6()
{
	...
	if (emu_flags.cf) { f__B503_0F9C_0020_EDC6(); return; }
	if (emu_flags.zf) {
		emu_cmpw(&emu_dx, emu_get_memory16(emu_ds, 0x00, 0x2B0C));
		if (emu_flags.cf) { f__B503_0F9C_0020_EDC6(); return; }
	}
	f__B503_0FB7_0005_7741(); return;
}

/**
 * Decompiled function f__B503_0FB7_0005_7741()
 *
 * @name f__B503_0FB7_0005_7741
 * @implements B503:0FB7:0005:7741 ()
 *
 * Called From: B503:0FAF:0020:EDC6
 */
void f__B503_0FB7_0005_7741()
{
 ...
 * Called From: B503:1005:0027:CFE0
 */
 ...
 * Called From: B503:0FBA:0005:7741
 */
void f__B503_1001_0022_259B()
{
	...
	emu_addw(&emu_dx, 0x5A);
	emu_adcw(&emu_ax, 0x0);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x2B0E), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x2B0C), emu_dx);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs); emu_push(0x1023); emu_cs = 0x2598; f__2598_0000_0017_EB80();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_1023_0006_EFCE(); return;
}
...
void f__B503_1038_0026_D203()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81D8), emu_dx);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81D6), emu_ax);
	emu_xorw(&emu_ax, emu_ax);
	emu_xorw(&emu_dx, emu_dx);
	emu_push(emu_ax);
	emu_push(emu_dx);
...
void f__B503_1083_001F_216D()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_dx);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81E4), emu_dx);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81E2), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x2B75);
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x10A2); f__B503_11BE_0016_067A();
	f__B503_10A2_0018_95A5(); return;
}
...
void f__B503_10BA_001F_94FC()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_dx);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81E0), emu_dx);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81DE), emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x2B80);
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x10D9); f__B503_11BE_0016_067A();
	f__B503_10D9_0018_95A5(); return;
}
...
void f__B503_10F1_0031_8BDC()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_dx);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81DC), emu_dx);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81DA), emu_ax);
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x3A38));
	emu_movw(&emu_dx, 0x1E);
	emu_imuluw(&emu_ax, emu_dx);
	emu_movw(&emu_bx, emu_ax);
...
void f__B503_114D_0014_2120()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_dx);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81D4), emu_dx);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81D2), emu_ax);
	emu_push(emu_cs);
	emu_push(0x1161); f__B503_122D_002D_E562();
	f__B503_1161_000E_6657(); return;
}
...
void f__B503_118A_0015_612E()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x119F); emu_cs = 0x01F7; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_119F_001A_722E(); return;
}
...
void f__B503_122D_002D_E562()
{
	...
	emu_push(emu_dx);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x2B9D);
	emu_push(emu_ax);
	emu_push(emu_ds);
	emu_movw(&emu_ax, 0x2B98);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x125A); emu_cs = 0x34FC; ovl__34FC(1);
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_125A_0017_1F8F(); return;
}
...
void f__B503_128F_0018_4412()
{
	...
	emu_movw(&emu_get_memory16(emu_es, emu_bx, 0x0), 0xFFFF);
	emu_incw(&emu_si);
	f__B503_129C_000B_0623(); return;
}
...
void f__B503_12BF_001B_3D87()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_ax);
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0x8), 0x0);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x12DA; emu_last_cs = 0xB503; emu_last_ip = 0x12C9; emu_last_length = 0x001B; emu_last_crc = 0x3D87; emu_call(); return; }
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x2AF6));
	emu_movw(&emu_dx, emu_get_memory16(emu_ds, 0x00, 0x2AF4));
...
{
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x2AF6), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x2AF4), emu_dx);
	emu_movw(&emu_sp, emu_bp);
	emu_pop(&emu_bp);
...
void f__B503_1315_0026_0E6A()
{
	...
	emu_movw(&emu_ax, 0x1);
	/* Unresolved jump */ emu_ip = 0x133D; emu_last_cs = 0xB503; emu_last_ip = 0x1339; emu_last_length = 0x0026; emu_last_crc = 0x0E6A; emu_call();
}
...
void f__B503_1343_003B_6432()
{
	emu_push(emu_bp);
	emu_movw(&emu_bp, emu_sp);
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x81B8));
	emu_movw(&emu_dx, emu_get_memory16(emu_ds, 0x00, 0x81B6));
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x76AE));
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__B503_13C0_0002_2597(); return; }
	...
	f__B503_135B_0023_539C(); return;
}

/**
 * Decompiled function f__B503_135B_0023_539C()
 *
 * @name f__B503_135B_0023_539C
 * @implements B503:135B:0023:539C ()
 *
 * Called From: B503:1353:003B:6432
 */
void f__B503_135B_0023_539C()
{
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x76AE));
	emu_movw(&emu_dx, emu_get_memory16(emu_ds, 0x00, 0x76AC));
	emu_addw(&emu_dx, 0x7);
	emu_adcw(&emu_ax, 0x0);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81B8), emu_ax);
	emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81B6), emu_dx);
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x2B10));
	emu_incw(&emu_ax);
	emu_cmpw(&emu_ax, 0x4);
 ...
 * Called From: B503:1376:0023:539C
 */
 ...
 * Called From: B503:137C:0023:539C
 */
void f__B503_1384_0021_5375()
{
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3C34));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x13A5); emu_cs = 0x01F7; emu_Tools_Memmove();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	f__B503_13A5_0018_11EB(); return;
}
...
{
	emu_addw(&emu_sp, 0xA);
	emu_movw(&emu_ax, 0xFE);
	emu_push(emu_ax);
	emu_movw(&emu_ax, 0xFB);
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3C34));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3C32));
 ...
 *
 * Called From: B503:1351:003B:6432
...
void f__B503_13D3_0015_3017()
{
	...
	if (emu_flags.zf) {
		emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x81B4));
		emu_negw(&emu_ax, emu_ax);
		emu_sbbw(&emu_ax, emu_ax);
		emu_incw(&emu_ax);
		emu_movw(&emu_get_memory16(emu_ds, 0x00, 0x81B4), emu_ax);
		emu_push(emu_cs); emu_push(0x13E8); emu_cs = 0x29E8; emu_Input_History_Clear();
		/* Check if this overlay should be reloaded */
		if (emu_cs == 0x3503) { ovl__3503(0xFF); }
	}
	f__B503_13E8_0005_9519(); return;
}
