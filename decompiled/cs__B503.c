...
l__001F:
	...
	emu_ax = 0x1D;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0029); emu_cs = 0x3483; overlay(0x3483, 0); f__B483_0283_0014_983A();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0029;
l__0029:
...
l__003C:
	...
	if (emu_get_memory16(emu_ss, emu_bp,  0x8) == 0x0) { /* Unresolved jump */ emu_ip = 0x004D; emu_last_cs = 0xB503; emu_last_ip = 0x0043; emu_last_length = 0x0011; emu_last_crc = 0xAE34; emu_call(); return; }
	emu_ax = emu_si;
	emu_decw(&emu_ax);
...
l__0097:
	...
	emu_ax = 0x2B12;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x00B7); emu_cs = 0x34CA; overlay(0x34CA, 0); f__B4CA_020F_0017_A939();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__00B7;
l__00B7:
...
l__01CB:
	...
	emu_cmpw(&emu_ax, 0x1);
	if (emu_ax == 0x1) { /* Unresolved jump */ emu_ip = 0x0206; emu_last_cs = 0xB503; emu_last_ip = 0x01D4; emu_last_length = 0x0012; emu_last_crc = 0xE385; emu_call(); return; }
	emu_cmpw(&emu_ax, 0x2);
	if (emu_ax == 0x2) { /* Unresolved jump */ emu_ip = 0x01DD; emu_last_cs = 0xB503; emu_last_ip = 0x01D9; emu_last_length = 0x0012; emu_last_crc = 0xE385; emu_call(); return; }
	goto l__0222;
l__0222:
	goto l__0224;
l__0224:
...
l__029D:
	...
	emu_ax = 0x2B1E;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x02BB); emu_cs = 0x34CA; overlay(0x34CA, 0); f__B4CA_020F_0017_A939();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__02BB;
l__02BB:
...
l__033B:
	...
	emu_ax = 0x2B29;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0359); emu_cs = 0x34CA; overlay(0x34CA, 0); f__B4CA_020F_0017_A939();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0359;
l__0359:
...
l__03F7:
	...
	emu_ax = 0x2B35;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0415); emu_cs = 0x34CA; overlay(0x34CA, 0); f__B4CA_020F_0017_A939();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0415;
l__0415:
...
l__04BA:
	...
	if (emu_ax == emu_get_memory16(emu_ss, emu_bp, -0x4)) { /* Unresolved jump */ emu_ip = 0x04CE; emu_last_cs = 0xB503; emu_last_ip = 0x04C3; emu_last_length = 0x0013; emu_last_crc = 0x3B9E; emu_call(); return; }
...
l__05F4:
	...
	emu_movw(&emu_ax, emu_bp - 0x24);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x061D); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__061D;
l__061D:
...
l__0668:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax != 0) { /* Unresolved jump */ emu_ip = 0x0672; emu_last_cs = 0xB503; emu_last_ip = 0x066B; emu_last_length = 0x0039; emu_last_crc = 0x8E6A; emu_call(); return; }
...
l__07A0:
	...
	if (emu_get_memory16(emu_es, emu_bx, 0x0) == 0x0) { /* Unresolved jump */ emu_ip = 0x07DA; emu_last_cs = 0xB503; emu_last_ip = 0x07A7; emu_last_length = 0x0037; emu_last_crc = 0xC389; emu_call(); return; }
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_ax = 0x2;
	emu_push(emu_ax);
...
l__0973:
	...
	emu_ax = 0x2B5B;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x099C); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__099C;
l__099C:
...
l__0C31:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0C5A); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0C5A;
l__0C5A:
...
l__0D03:
	...
	emu_movw(&emu_ax, emu_bp - 0x14);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D30); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0D30;
l__0D30:
...
l__0D75:
	...
	emu_movw(&emu_ax, emu_bp - 0x14);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D9E); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0D9E;
l__0D9E:
...
l__0E22:
	...
	emu_ax = 0x2B5B;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0E4B); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__0E4B;
l__0E4B:
...
l__122D:
	...
	emu_ax = 0x2B98;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x125A); emu_cs = 0x34FC; overlay(0x34FC, 0); f__B4FC_03C8_002C_9251();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__125A;
l__125A:
...
l__12AC:
	...
	emu_push(emu_cs); emu_push(0x12BF); emu_cs = 0x01F7; emu_Math_Shld();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__12BF;
l__12BF:
	...
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0x8), 0x0);
	if (emu_get_memory16(emu_ss, emu_bp,  0x8) == 0x0) { /* Unresolved jump */ emu_ip = 0x12DA; emu_last_cs = 0xB503; emu_last_ip = 0x12C9; emu_last_length = 0x001B; emu_last_crc = 0x3D87; emu_call(); return; }
...
l__1302:
	...
	emu_ax = 0x1;
	emu_cl = emu_get_memory8(emu_ss, emu_bp,  0x6);
	emu_push(emu_cs); emu_push(0x1315); emu_cs = 0x01F7; emu_Math_Shld();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
	goto l__1315;
l__1315:
