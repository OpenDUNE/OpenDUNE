...
l__0050:
	...
	emu_ax = 0x4;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x005C); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__005C:
	emu_pop(&emu_cx);
	...
	emu_movw(&emu_ax, emu_bp - 0x30A);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x006F); emu_cs = 0x259E; emu_Unknown_259E_0006();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__006F:
	emu_addw(&emu_sp, 0x6);
...
l__0184:
	...
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x01A7); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__01A7:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x01CB); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__01CB:
	emu_addw(&emu_sp, 0x10);
...
l__01F7:
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0201); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__0201:
	emu_addw(&emu_sp, 0x10);
...
l__024A:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x026A); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__026A:
	emu_addw(&emu_sp, 0x10);
	...
	emu_push(emu_cs); emu_push(0x027E); emu_cs = 0x259E; emu_Unknown_259E_0006();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__027E:
	emu_addw(&emu_sp, 0x6);
...
l__0430:
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x043C); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__043C:
	emu_pop(&emu_cx);
...
l__044B:
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0473); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__0473:
	goto l__0497;
...
l__0497:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x04BA); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__04BA:
	emu_addw(&emu_sp, 0x10);
...
l__0505:
	...
	emu_push(emu_cs); emu_push(0x050D); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__050D:
	emu_pop(&emu_cx);
...
l__0543:
	...
	emu_movw(&emu_ax, emu_bp - 0x30A);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0555); emu_cs = 0x259E; emu_Unknown_259E_0006();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__0555:
	emu_addw(&emu_sp, 0x6);
...
l__0586:
	...
	emu_push(emu_cs); emu_push(0x059D); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Unknown_B4B8_110D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__059D:
	emu_pop(&emu_cx);
...
l__08DB:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A38));
	emu_push(emu_cs); emu_push(0x08EF); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Unknown_B4B8_110D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3503) { overlay(0x3503, 1); }
l__08EF:
	emu_pop(&emu_cx);
