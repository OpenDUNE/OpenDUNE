...
l__047C:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_cs);
	emu_push(0x0483); f__AB00_050D_0013_8F78();
l__0483:
...
/**
 * Decompiled function f__AB00_0499_0014_F091()
 *
 * @name f__AB00_0499_0014_F091
 * @implements AB00:0499:0014:F091 ()
 * @implements AB00:04A1:000C:AB40
 * @implements AB00:04AD:0002:C03A
 * @implements AB00:04AF:0002:C03A
 * @implements AB00:04B1:000D:D6A1
 * @implements AB00:04BE:000B:AFA3
 *
 * Called From: AB00:092A:0008:11DF
 * Called From: AB00:0932:0008:08A1
 * Called From: AB00:094C:001A:3495
 * Called From: AB00:0CC7:0016:9B28
 * Called From: AB00:0CD8:0011:538D
 * Called From: AB00:0CE9:0011:932B
 * Called From: AB00:0CFA:0011:D32B
 * Called From: AB00:0D0B:0011:1326
 * Called From: AB00:0D15:000A:3DBD
 * Called From: AB00:0D1F:000A:BD90
 * Called From: AB00:0D29:000A:3DA6
 * Called From: AB00:0D5C:0033:315C
 * Called From: AB00:0D5C:0015:3DD1
 * Called From: AB00:0D74:0013:4E5F
 * Called From: AB00:0D85:0011:92CA
 */
void f__AB00_0499_0014_F091()
{
l__0499:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	emu_dx = emu_get_memory16(emu_cs, 0x00, 0x441);
l__04A1:
	emu_inb(&emu_al, emu_dx);
	emu_testb(&emu_al, 0x40);
	if ((emu_al & 0x40) == 0) goto l__04BE;
	emu_testb(&emu_al, 0x80);
	if ((emu_al & 0x80) != 0) goto l__04A1;
	emu_sti();
	goto l__04AD;
l__04AD:
	goto l__04AF;
l__04AF:
	goto l__04B1;
l__04B1:
	emu_dx = emu_get_memory16(emu_cs, 0x00, 0x43F);
	emu_inb(&emu_al, emu_dx);
	emu_dx = emu_get_memory16(emu_cs, 0x00, 0x441);
	goto l__04A1;
l__04BE:
...
/**
 * Decompiled function f__AB00_04C9_0016_446A()
 *
 * @name f__AB00_04C9_0016_446A
 * @implements AB00:04C9:0016:446A ()
 * @implements AB00:04D6:0009:8943
 * @implements AB00:04DF:0022:D2AE
 * @implements AB00:04E6:001B:5898
 * @implements AB00:04FA:0007:6DBD
 * @implements AB00:04FC:0005:C47A
 * @implements AB00:0501:000A:91BD
 * @implements AB00:0504:0007:3FBD
 * @implements AB00:050B:0002:2597
 *
 * Called From: AB00:051D:0013:8F78
 * Called From: AB00:0532:0015:559C
 * Called From: AB00:0553:0013:0ECE
 */
void f__AB00_04C9_0016_446A()
{
l__04C9:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
l__04D6:
	emu_inb(&emu_al, emu_dx);
	emu_testb(&emu_al, 0x40);
	if ((emu_al & 0x40) == 0) goto l__04DF;
	if (--emu_cx != 0) goto l__04D6;
	goto l__04FC;
l__04DF:
	emu_al = emu_get_memory8(emu_ss, emu_bp,  0x6);
	emu_outb(emu_dx, emu_al);
...
l__04E6:
	...
	if ((emu_al & 0x80) == 0) {
		...
		if (emu_al == 0xFE) goto l__0501;
	}
l__04FA:
	if (--emu_cx != 0) goto l__04E6;
l__04FC:
	emu_ax = 0x0;
	goto l__0504;
l__0501:
...
l__0504:
	emu_orb(&emu_bh, 0x0);
	emu_push(emu_cs);
	emu_push(0x050B); f__AB00_0505_0001_6780();
l__050B:
	emu_pop(&emu_bp);
...
/**
 * Decompiled function f__AB00_0505_0001_6780()
 *
 * @name f__AB00_0505_0001_6780
 * @implements AB00:0505:0001:6780 ()
 *
 * Called From: AB00:0508:0007:3FBD
 * Called From: AB00:0508:000A:91BD
 */
void f__AB00_0505_0001_6780()
{
l__0505:
...
/**
 * Decompiled function f__AB00_050D_0013_8F78()
 *
 * @name f__AB00_050D_0013_8F78
 * @implements AB00:050D:0013:8F78 ()
 * @implements AB00:0520:0015:559C
 * @implements AB00:0535:000A:1D1F
 * @implements AB00:0538:0007:3FBD
 * @implements AB00:053F:0004:5E42
 *
 * Called From: AB00:0480:0007:6C67
 * Called From: AB00:201E:0007:9E7E
 * Called From: AB00:2179:0007:DD91
 */
void f__AB00_050D_0013_8F78()
{
l__050D:
	emu_push(emu_ds);
	emu_push(emu_si);
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0520); f__AB00_04C9_0016_446A();
l__0520:
	emu_addw(&emu_sp, 0x2);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax != 0) goto l__0538;
	emu_push(emu_ax);
	emu_push(emu_bp);
	emu_bp = emu_sp;
	emu_get_memory16(emu_ss, emu_bp,  0x2) = 0xFF;
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0535); f__AB00_04C9_0016_446A();
l__0535:
	emu_addw(&emu_sp, 0x2);
l__0538:
	emu_orb(&emu_bh, 0x0);
	emu_push(emu_cs);
	emu_push(0x053F); f__AB00_0539_0001_6780();
l__053F:
	emu_pop(&emu_di);
	emu_pop(&emu_si);
	emu_pop(&emu_ds);
...
/**
 * Decompiled function f__AB00_0539_0001_6780()
 *
 * @name f__AB00_0539_0001_6780
 * @implements AB00:0539:0001:6780 ()
 *
 * Called From: AB00:053C:000A:1D1F
 * Called From: AB00:053C:0007:3FBD
 */
void f__AB00_0539_0001_6780()
{
l__0539:
...
/**
 * Decompiled function f__AB00_0543_0013_0ECE()
 *
 * @name f__AB00_0543_0013_0ECE
 * @implements AB00:0543:0013:0ECE ()
 * @implements AB00:0556:000A:1D1F
 * @implements AB00:0560:0004:5E42
 *
 * Called From: AB00:2022:0004:0F87
 */
void f__AB00_0543_0013_0ECE()
{
l__0543:
	emu_push(emu_ds);
	emu_push(emu_si);
	...
	emu_push(emu_bp);
	emu_bp = emu_sp;
	emu_get_memory16(emu_ss, emu_bp,  0x2) = 0x3F;
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0556); f__AB00_04C9_0016_446A();
l__0556:
	emu_addw(&emu_sp, 0x2);
	emu_orb(&emu_bh, 0x0);
	emu_push(emu_cs);
	emu_push(0x0560); f__AB00_055A_0001_6780();
l__0560:
	emu_pop(&emu_di);
	emu_pop(&emu_si);
	emu_pop(&emu_ds);
...
/**
 * Decompiled function f__AB00_055A_0001_6780()
 *
 * @name f__AB00_055A_0001_6780
 * @implements AB00:055A:0001:6780 ()
 *
 * Called From: AB00:055D:000A:1D1F
 */
void f__AB00_055A_0001_6780()
{
l__055A:
...
l__0925:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x092D); f__AB00_0499_0014_F091();
l__092D:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x0935); f__AB00_0499_0014_F091();
l__0935:
	emu_addw(&emu_sp, 0x2);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs);
	emu_push(0x094F); f__AB00_0499_0014_F091();
l__094F:
	emu_addw(&emu_sp, 0x2);
l__0952:
	emu_pop(&emu_di);
...
l__0CB4:
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0CCA); f__AB00_0499_0014_F091();
l__0CCA:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_ax);
	emu_push(emu_bp);
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0CDB); f__AB00_0499_0014_F091();
l__0CDB:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_ax);
	emu_push(emu_bp);
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0CEC); f__AB00_0499_0014_F091();
l__0CEC:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_ax);
	emu_push(emu_bp);
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0CFD); f__AB00_0499_0014_F091();
l__0CFD:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_ax);
	emu_push(emu_bp);
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0D0E); f__AB00_0499_0014_F091();
l__0D0E:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_cs);
	emu_push(0x0D18); f__AB00_0499_0014_F091();
l__0D18:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs);
	emu_push(0x0D22); f__AB00_0499_0014_F091();
l__0D22:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xC));
	emu_push(emu_cs);
	emu_push(0x0D2C); f__AB00_0499_0014_F091();
l__0D2C:
	emu_addw(&emu_sp, 0x2);
...
l__0D4A:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0D5F); f__AB00_0499_0014_F091();
l__0D5F:
	emu_addw(&emu_sp, 0x2);
	goto l__0D4A;
l__0D64:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0D77); f__AB00_0499_0014_F091();
l__0D77:
	emu_addw(&emu_sp, 0x2);
	emu_push(emu_ax);
	emu_push(emu_bp);
	...
	emu_pop(&emu_bp);
	emu_push(emu_cs);
	emu_push(0x0D88); f__AB00_0499_0014_F091();
l__0D88:
	emu_addw(&emu_sp, 0x2);
...
l__1CEE:
	...
	/* Unresolved jump */ emu_ip = 0x1DAE; emu_last_cs = 0xAB00; emu_last_ip = 0x1D00; emu_last_length = 0x0015; emu_last_crc = 0x5BCF; emu_call();
l__1D03:
...
l__1D34:
	...
	if ((emu_flags.sf != emu_flags.of)) { /* Unresolved jump */ emu_ip = 0x1D94; emu_last_cs = 0xAB00; emu_last_ip = 0x1D5E; emu_last_length = 0x0081; emu_last_crc = 0x3E00; emu_call(); return; }
	emu_get_memory16(emu_ds, emu_si, 0x30) = emu_ax;
...
l__1D8C:
	emu_ax = emu_get_memory16(emu_ds, emu_si, 0x30);
	emu_subw(&emu_ax, 0x64);
	if (!(emu_flags.sf != emu_flags.of)) { /* Unresolved jump */ emu_ip = 0x1D60; emu_last_cs = 0xAB00; emu_last_ip = 0x1D92; emu_last_length = 0x0029; emu_last_crc = 0x452B; emu_call(); return; }
	emu_ax = emu_get_memory16(emu_ds, emu_si, 0x32);
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ds, emu_si, 0x34));
	if (emu_ax != emu_get_memory16(emu_ds, emu_si, 0x34)) { /* Unresolved jump */ emu_ip = 0x1DB5; emu_last_cs = 0xAB00; emu_last_ip = 0x1D9A; emu_last_length = 0x0029; emu_last_crc = 0x452B; emu_call(); return; }
...
l__1E49:
	...
	if (emu_di >= 0x8000) { /* Unresolved jump */ emu_ip = 0x1E2A; emu_last_cs = 0xAB00; emu_last_ip = 0x1E50; emu_last_length = 0x004D; emu_last_crc = 0x4A38; emu_call(); return; }
	emu_al = emu_get_memory8(emu_es, emu_di, 0x0);
	emu_ah = 0x0;
...
l__1E9D:
	...
	emu_push(emu_si);
	emu_push(emu_cs);
	/* Unresolved call */ emu_push(0x1EA8); emu_ip = 0x1C49; emu_last_cs = 0xAB00; emu_last_ip = 0x1EA5; emu_last_length = 0x000B; emu_last_crc = 0x73D5; emu_call();
	/* Unresolved jump */ emu_ip = 0x1EA8; emu_last_cs = 0xAB00; emu_last_ip = 0x1EA8; emu_last_length = 0x000B; emu_last_crc = 0x73D5; emu_call();
l__1EAF:
	emu_push(emu_ds);
	emu_push(emu_si);
	emu_push(emu_cs);
...
l__1F7F:
	...
	emu_ax = emu_get_memory16(emu_ds, emu_si, 0x24);
	if ((emu_flags.sf != emu_flags.of)) { /* Unresolved jump */ emu_ip = 0x1F91; emu_last_cs = 0xAB00; emu_last_ip = 0x1F87; emu_last_length = 0x0012; emu_last_crc = 0x7B88; emu_call(); return; }
	emu_subw(&emu_ax, emu_cx);
	emu_cmpw(&emu_ax, emu_bx);
	if ((int16)emu_ax >= (int16)emu_bx) goto l__1F99;
	/* Unresolved jump */ emu_ip = 0x1F97; emu_last_cs = 0xAB00; emu_last_ip = 0x1F8F; emu_last_length = 0x0012; emu_last_crc = 0x7B88; emu_call();
l__1F99:
...
l__201A:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_cs);
	emu_push(0x2021); f__AB00_050D_0013_8F78();
l__2021:
	emu_push(emu_cs);
	emu_push(0x2025); f__AB00_0543_0013_0ECE();
l__2025:
	emu_push(emu_cs);
...
l__2175:
	emu_addw(&emu_sp, 0x6);
	emu_push(emu_cs);
	emu_push(0x217C); f__AB00_050D_0013_8F78();
l__217C:
