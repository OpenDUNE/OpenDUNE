...
void f__B48B_0000_001E_7E97()
{
	...
	if (emu_flags.zf) { emu_ip = 0x001E; emu_last_cs = 0xB48B; emu_last_ip = 0x000C; emu_last_length = 0x001E; emu_last_crc = 0x7E97; emu_call(); return; } // Jump does not resolve
...
void f__B48B_0088_0029_3A68()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x8));
	if (emu_flags.zf) { emu_ip = 0x00B3; emu_last_cs = 0xB48B; emu_last_ip = 0x0091; emu_last_length = 0x0029; emu_last_crc = 0x3A68; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
...
void f__B48B_00BD_0029_3530()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x8));
	if (emu_flags.zf) { emu_ip = 0x00E8; emu_last_cs = 0xB48B; emu_last_ip = 0x00C6; emu_last_length = 0x0029; emu_last_crc = 0x3530; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_testw(&emu_get_memory16(emu_es, emu_bx.x,  0xE), 0x8);
...
void f__B48B_0115_0010_C2D5()
{
	...
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_ip = 0x0125; emu_last_cs = 0xB48B; emu_last_ip = 0x0123; emu_last_length = 0x0010; emu_last_crc = 0xC2D5; emu_call(); // Jump does not resolve
}
...
void f__B48B_0127_000E_E325()
{
	...
	emu_ip = 0x01C4; emu_last_cs = 0xB48B; emu_last_ip = 0x0132; emu_last_length = 0x000E; emu_last_crc = 0xE325; emu_call(); // Jump does not resolve
}
...
void f__B48B_0135_000E_EE25()
{
	...
	emu_ip = 0x01C4; emu_last_cs = 0xB48B; emu_last_ip = 0x0140; emu_last_length = 0x000E; emu_last_crc = 0xEE25; emu_call(); // Jump does not resolve
}
...
void f__B48B_01A0_0022_19B9()
{
	...
	if (emu_flags.zf) { emu_ip = 0x01C4; emu_last_cs = 0xB48B; emu_last_ip = 0x01B3; emu_last_length = 0x0022; emu_last_crc = 0x19B9; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
...
void f__B48B_01CE_002B_7574()
{
	...
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_testw(&emu_get_memory16(emu_es, emu_bx.x,  0xE), 0x8);
	if (!emu_flags.zf) { emu_ip = 0x0238; emu_last_cs = 0xB48B; emu_last_ip = 0x01E2; emu_last_length = 0x002B; emu_last_crc = 0x7574; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_testw(&emu_get_memory16(emu_es, emu_bx.x,  0x2E), 0x1);
...
void f__B48B_0214_0022_19B9()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x30));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x32));
	if (emu_flags.zf) { emu_ip = 0x0238; emu_last_cs = 0xB48B; emu_last_ip = 0x0227; emu_last_length = 0x0022; emu_last_crc = 0x19B9; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
...
void f__B48B_0259_0010_340C()
{
	...
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_ip = 0x0256; emu_last_cs = 0xB48B; emu_last_ip = 0x0267; emu_last_length = 0x0010; emu_last_crc = 0x340C; emu_call(); // Jump does not resolve
}
...
void f__B48B_0269_0034_5F53()
{
	...
	emu_movw(&emu_get_memory16(emu_es, emu_bx.x,  0x2), emu_ax.x);
	emu_movw(&emu_get_memory16(emu_es, emu_bx.x,  0x0), emu_dx.x);
	emu_ip = 0x0250; emu_last_cs = 0xB48B; emu_last_ip = 0x029B; emu_last_length = 0x0034; emu_last_crc = 0x5F53; emu_call(); // Jump does not resolve
}
...
void f__B48B_02A2_0058_1F2E()
{
	...
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x4));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0305; emu_last_cs = 0xB48B; emu_last_ip = 0x02E8; emu_last_length = 0x0058; emu_last_crc = 0x1F2E; emu_call(); return; } // Jump does not resolve
...
void f__B48B_02BE_003C_DD44()
{
	...
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x4));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x02DA; emu_last_cs = 0xB48B; emu_last_ip = 0x02CC; emu_last_length = 0x003C; emu_last_crc = 0xDD44; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x0));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x2));
	if (!emu_flags.zf) { f__B48B_02A2_0058_1F2E(); return; }
	...
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x4));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0305; emu_last_cs = 0xB48B; emu_last_ip = 0x02E8; emu_last_length = 0x003C; emu_last_crc = 0xDD44; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xC));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
...
void f__B48B_02DA_0020_1036()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs);
	emu_push(0x02FA); emu_ip = 0x0000; emu_last_cs = 0xB48B; emu_last_ip = 0x02F7; emu_last_length = 0x0020; emu_last_crc = 0x1036; emu_call(); // Jump does not resolve
	f__B48B_02FA_000B_4C0E();
}
