...
void f__0C3A_0009_0029_BF94()
{
	...
	emu_push(emu_cs); emu_push(0x0032); emu_cs = 0x1082; Memory_Building_Allocate();
...
void f__0C3A_04EF_0011_FFC9()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0500); emu_cs = 0x1082; Memory_Building_Free();
...
void f__0C3A_117B_000B_C6E5()
{
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x1186); emu_cs = 0x1082; Memory_Building_Free();
	f__0C3A_1186_000D_A5C0();
}
...
void f__0C3A_1E9D_0012_F3F8()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_cs); emu_push(0x1EAF); emu_cs = 0x1082; Memory_Building_Free();
