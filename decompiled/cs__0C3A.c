...
l__07F1:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0803); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_B4CD_0750();
l__0803:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0xD);
...
l__081B:
	...
	emu_push(emu_cs); emu_push(0x0837); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_B4CD_0750();
l__0837:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0xB);
...
l__0849:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_cs); emu_push(0x086D); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_B4CD_0750();
l__086D:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0xB);
	if (emu_ax == 0xB) {
...
l__087D:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_cs); emu_push(0x0885); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_B4CD_0750();
l__0885:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0xD);
	if (emu_ax == 0xD) {
...
l__08AC:
	...
	emu_push(emu_ax);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0918); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_Update();
l__0918:
	emu_addw(&emu_sp, 0x6);
	emu_ax = 0x1;
l__091E:
...
l__1AB8:
	emu_push(emu_cs); emu_push(0x1ABD); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__1ABD:
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x1B0B); emu_Structure_SetAnimation();
l__1B0B:
	emu_addw(&emu_sp, 0x6);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x3A38));
	...
	emu_ax = 0x89;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B26); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__1B26:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1B33:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B44); emu_cs = 0x10E4; emu_GUI_DisplayText();
l__1B44:
	emu_addw(&emu_sp, 0x6);
l__1B47:
	emu_ax = 0x1;
...
l__1B4F:
	...
	emu_ax = 0x88;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B65); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__1B65:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B6D); emu_cs = 0x10E4; emu_GUI_DisplayText();
l__1B6D:
	emu_addw(&emu_sp, 0x6);
l__1B70:
	goto l__1440;
...
l__252D:
	...
	emu_di = emu_ax;
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x2544); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_B4CD_0750();
l__2544:
	emu_pop(&emu_cx);
...
l__2561:
	...
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x256C); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Map_B4CD_0750();
l__256C:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0xB);
...
l__29C2:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x29DF); emu_cs = 0x104B; emu_Team_FindFirst();
l__29DF:
	emu_addw(&emu_sp, 0x6);
	goto l__2A03;
l__29E4:
...
l__29F6:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x2A01); emu_cs = 0x104B; emu_Team_FindNext();
l__2A01:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
l__2A03:
