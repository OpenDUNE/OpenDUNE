...
l__0DA1:
	...
	emu_get_memory16(emu_ss, emu_bp, -0xA) = emu_ax;
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_push(emu_cs); emu_push(0x0DB2); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_Get_ByPackedTile();
l__0DB2:
	emu_pop(&emu_cx);
...
l__1AB8:
	emu_push(emu_cs); emu_push(0x1ABD); emu_cs = 0x0FCB; emu_String_GetString();
l__1ABD:
	emu_pop(&emu_cx);
...
l__1B0B:
	...
	emu_ax = 0x89;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B26); emu_cs = 0x0FCB; emu_String_GetString();
l__1B26:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__1B4F:
	...
	emu_ax = 0x88;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1B65); emu_cs = 0x0FCB; emu_String_GetString();
l__1B65:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__2744:
	...
	emu_ax = 0x8C;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x276E); emu_cs = 0x0FCB; emu_String_GetString();
l__276E:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__279E:
	...
	emu_ax = 0x8D;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x27D2); emu_cs = 0x0FCB; emu_String_GetString();
l__27D2:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__2851:
	...
	emu_ax = 0x8A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x287B); emu_cs = 0x0FCB; emu_String_GetString();
l__287B:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__28AC:
	...
	emu_ax = 0x8B;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x28F8); emu_cs = 0x0FCB; emu_String_GetString();
l__28F8:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
