...
l__021D:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x0227); emu_Structure_IsValidBuildLocation();
l__0227:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__02C2:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x02CC); emu_Structure_ConnectWall();
l__02CC:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__032A:
	...
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x0341); emu_Structure_IsValidBuildLocation();
l__0341:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__0427:
	...
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x043E); emu_Structure_IsValidBuildLocation();
l__043E:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__0508:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x0517); emu_Structure_IsValidBuildLocation();
l__0517:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__058B:
	...
	emu_push(emu_cs); emu_push(0x05DB); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__05DB:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_sarw(&emu_ax, 0x1);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x05F2); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__05F2:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
...
l__0727:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0732); emu_Structure_UpdateMap();
l__0732:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0742); emu_Structure_GetStructuresBuilt();
l__0742:
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	emu_push(emu_dx);
