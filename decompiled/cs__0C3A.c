...
/**
 * Decompiled function emu_Structure_Create()
 *
...
l__0009:
	...
	emu_push(emu_cs); emu_push(0x0032); emu_cs = 0x1082; emu_Structure_Allocate();
l__0032:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__018D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x019F); emu_cs = 0x1082; emu_Structure_Free();
l__019F:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__05DB:
	...
	emu_sarw(&emu_ax, 0x1);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x05F2); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_PercentToValue();
l__05F2:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
...
l__0F4C:
	...
	emu_push(emu_cs); emu_push(0x0F6F); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_PercentToValue();
l__0F6F:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__1F23:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x16));
	emu_push(emu_cs); emu_push(0x1F37); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_PercentToValue();
l__1F37:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_ax);
...
l__202D:
	...
	emu_negw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x203F); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_PercentToValue();
l__203F:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	goto l__204C;
...
l__214C:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x10));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x10));
	emu_push(emu_cs); emu_push(0x217F); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_PercentToValue();
l__217F:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0xC));
