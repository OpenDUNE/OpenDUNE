...
l__13E4:
	...
	emu_xorw(&emu_dx, emu_dx);
	emu_ax = 0x1;
	emu_push(emu_cs); emu_push(0x1400); emu_cs = 0x01F7; emu_Math_Shld();
	goto l__1400;
l__1400:
...
l__1562:
	...
	emu_push(emu_cs); emu_push(0x156F); emu_cs = 0x01F7; emu_Math_Shld();
	goto l__156F;
l__156F:
...
l__1634:
	...
	if (emu_ax == 0) { /* Unresolved jump */ emu_ip = 0x1691; emu_last_cs = 0x0C3A; emu_last_ip = 0x1647; emu_last_length = 0x005D; emu_last_crc = 0x8B99; emu_call(); return; }
	emu_si = 0x1;
...
l__1728:
	...
	emu_ax = 0x1;
	emu_cl = emu_get_memory8(emu_ss, emu_bp, -0x1A);
	emu_push(emu_cs); emu_push(0x1735); emu_cs = 0x01F7; emu_Math_Shld();
	goto l__1735;
l__1735:
	emu_bx = emu_get_memory16(emu_ss, emu_bp, -0x20);
	emu_cx = emu_get_memory16(emu_ss, emu_bp, -0x22);
...
l__1DA0:
	...
	emu_push(emu_cs); emu_push(0x1DFB); emu_cs = 0x01F7; emu_Math_Shld();
	goto l__1DFB;
l__1DFB:
