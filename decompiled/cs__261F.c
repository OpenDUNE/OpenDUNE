 ...
 * Called From: 3511:0025:0002:0000
...
l__0008:
	...
	emu_push(emu_cs); emu_push(0x003B); emu_cs = 0x01F7; emu_File_LowLevel_Close_Wrapper();
...
l__003C:
	...
	emu_ax = 0x9882;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x004A); emu_cs = 0x01F7; emu_File_LowLevel_Open_Wrapper();
l__004A:
	emu_addw(&emu_sp, 0x6);
...
l__0119:
	...
	emu_ax = 0x9882;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x012A); emu_cs = 0x01F7; emu_File_LowLevel_Open_Wrapper();
l__012A:
	emu_addw(&emu_sp, 0x6);
	emu_dx = 0x33F4;
	emu_es = emu_dx;
...
l__0185:
	...
	emu_es = emu_ax;
	emu_push(emu_get_memory16(emu_es, 0x00, 0x128));
	emu_push(emu_cs); emu_push(0x019F); emu_cs = 0x01F7; emu_File_LowLevel_Close_Wrapper();
l__019F:
	emu_pop(&emu_cx);
	emu_ax = 0x33F4;
	emu_es = emu_ax;
