...
l__0043:
	...
	if (emu_flags.zf) goto l__005F;
	emu_movw(&emu_ax, emu_get_memory16(emu_ds, 0x00, 0x3900));
	goto l__0066;
l__005F:
	emu_movw(&emu_ax, 0x4);
...
l__0066:
	...
	emu_cmpw(&emu_bx, 0x4);
	if (!(emu_flags.cf || emu_flags.zf)) goto l__0082;
	emu_shlw(&emu_bx, 0x1);
...
l__008E:
	...
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) goto l__0098;
	emu_movw(&emu_ax, emu_dx);
	goto l__009A;
l__0098:
