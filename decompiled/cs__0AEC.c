...
l__065B:
	...
	emu_ax = 0x14C;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0691); emu_cs = 0x0FCB; emu_String_GetString();
l__0691:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__06BE:
	...
	emu_ax = 0x87;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x06CB); emu_cs = 0x0FCB; emu_String_GetString();
l__06CB:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	goto l__070D;
...
l__06DC:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x10));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x06E9); emu_cs = 0x0FCB; emu_String_GetString();
l__06E9:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_ax = 0x86;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x06F5); emu_cs = 0x0FCB; emu_String_GetString();
l__06F5:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__0826:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A02));
	emu_push(emu_cs); emu_push(0x082F); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_Get_ByPackedTile();
l__082F:
	emu_pop(&emu_cx);
...
l__0AEF:
	...
	emu_push(emu_dx);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x16));
	emu_push(emu_cs); emu_push(0x0B0B); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_ValueToPercent();
l__0B0B:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	emu_ax = 0x64;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0B17); emu_cs = 0x34C1; overlay(0x34C1, 0); emu_Math_PercentToValue();
l__0B17:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x12) = emu_ax;
...
l__0B2E:
	...
	emu_push(emu_cs); emu_push(0x0B69); emu_cs = 0x0FCB; emu_String_GetString();
l__0B69:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__0BA1:
	...
	emu_push(emu_dx);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x97E5));
	emu_push(emu_cs); emu_push(0x0BC1); emu_cs = 0x0FCB; emu_String_GetString();
l__0BC1:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__0BC9:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x97E5));
l__0BD0:
	emu_push(emu_cs); emu_push(0x0BD5); emu_cs = 0x0FCB; emu_String_GetString();
l__0BD5:
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	emu_es = emu_dx;
...
l__0BE4:
	...
	emu_ax = 0x28;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0BFC); emu_cs = 0x0FCB; emu_String_GetString();
l__0BFC:
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	emu_es = emu_dx;
...
l__0CF2:
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x3A02));
	emu_push(emu_cs); emu_push(0x0CFB); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_Get_ByPackedTile();
l__0CFB:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
...
l__0F24:
	...
	emu_push(emu_dx);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xE));
	emu_push(emu_cs); emu_push(0x0F44); emu_cs = 0x0FCB; emu_String_GetString();
l__0F44:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__0F4C:
	emu_addw(&emu_sp, 0xE);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xE));
	emu_push(emu_cs); emu_push(0x0F57); emu_cs = 0x0FCB; emu_String_GetString();
l__0F57:
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	emu_es = emu_dx;
