...
l__0B69:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0B71); emu_cs = 0x10E4; emu_GUI_DrawText();
l__0B71:
...
l__0BC1:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0BC9); emu_cs = 0x10E4; emu_GUI_DrawText();
l__0BC9:
	emu_addw(&emu_sp, 0x10);
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x97E5));
l__0BD0:
	emu_push(emu_cs); emu_push(0x0BD5); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
l__0BD5:
	emu_pop(&emu_cx);
	emu_bx = emu_ax;
	emu_es = emu_dx;
...
l__0F44:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0F4C); emu_cs = 0x10E4; emu_GUI_DrawText();
l__0F4C:
	emu_addw(&emu_sp, 0xE);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xE));
