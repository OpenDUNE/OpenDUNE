...
void f__0AEC_0AB2_0015_61FE()
{
	...
	/* Unresolved jump */ emu_ip = 0x0AC7; emu_last_cs = 0x0AEC; emu_last_ip = 0x0AC2; emu_last_length = 0x0015; emu_last_crc = 0x61FE; emu_call();
}
