...
/**
 * Decompiled function emu_Drive_Get_Default_NoInput()
 *
 * @name emu_Drive_Get_Default_NoInput
 ...
 * Called From: 1FB5:166D:0004:C9A5
 */
void emu_Drive_Get_Default_NoInput()
{
l__0005:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
/**
 * Decompiled function emu_Drive_Set_Default_NoInput()
 *
 * @name emu_Drive_Set_Default_NoInput
 * @implements 1FB5:0024:0012:C761 ()
 * @implements 1FB5:0036:000D:EA19
 * @implements 1FB5:0043:0004:893F
 *
 * Called From: 1FB5:1688:000A:4DBB
 */
void emu_Drive_Set_Default_NoInput()
{
l__0024:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
/**
 * Decompiled function emu_File_Close_NoInput()
 *
 * @name emu_File_Close_NoInput
...
l__0047:
	...
	emu_incb(&emu_get_memory8(emu_ds, 0x00, 0x986C));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0059); emu_cs = 0x01F7; emu_File_LowLevel_Close_Wrapper();
l__0059:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_ax;
	emu_decb(&emu_get_memory8(emu_ds, 0x00, 0x986C));
...
/**
 * Decompiled function emu_File_Delete_NoInput()
 *
 * @name emu_File_Delete_NoInput
...
l__006A:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x007F); emu_cs = 0x01F7; emu_File_LowLevel_Delete();
l__007F:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_ax;
...
/**
 * Decompiled function emu_File_Seek_NoInput()
 *
 * @name emu_File_Seek_NoInput
...
/**
 * Decompiled function emu_File_Read_NoInput()
 *
 * @name emu_File_Read_NoInput
...
l__00C5:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x00E0); emu_cs = 0x01F7; emu_File_LowLevel_Read_Wrapper();
l__00E0:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_ax;
	emu_decb(&emu_get_memory8(emu_ds, 0x00, 0x986C));
...
/**
 * Decompiled function emu_File_Write_NoInput()
 *
 * @name emu_File_Write_NoInput
...
/**
 * Decompiled function emu_File_Open_NoInput()
 *
 * @name emu_File_Open_NoInput
 ...
 * Called From: 1FB5:169B:0013:0FF1
 */
void emu_File_Open_NoInput()
{
l__0121:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x013C); emu_cs = 0x01F7; emu_File_LowLevel_Open_Wrapper();
l__013C:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_ax;
	emu_decb(&emu_get_memory8(emu_ds, 0x00, 0x986C));
 ...
 * @implements 1FB5:021F:001A:4B10
 ...
 * @implements 1FB5:066F:0094:F75C
 ...
 * @implements 1FB5:08DE:000A:1953
 * @implements 1FB5:08E8:0006:6338
 * @implements 1FB5:08EE:002D:BCFB
 * @implements 1FB5:091B:0009:4D1E
...
l__020A:
	...
	if (emu_get_memory16(emu_es, emu_bx, 0x0) == 0x0) goto l__021F;
	goto l__0225;
l__021F:
	emu_incw(&emu_di);
l__0220:
...
l__0247:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0263); emu_File_Open_NoInput();
l__0263:
	emu_addw(&emu_sp, 0x8);
	emu_si = emu_ax;
	...
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x0272); emu_File_Close_NoInput();
l__0272:
	emu_pop(&emu_cx);
...
l__031D:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x0334); emu_File_ReadBlock();
l__0334:
	emu_addw(&emu_sp, 0xA);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0352); emu_FileInfo_FindIndex_ByName();
l__0352:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__0491:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x04A3); emu_File_ReadBlock();
l__04A3:
	emu_addw(&emu_sp, 0xA);
...
l__04B1:
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x10), 0xFFFF);
	if (emu_get_memory16(emu_ss, emu_bp, -0x10) == 0xFFFF) goto l__04F8;
	emu_push(emu_di);
	emu_push(emu_cs);
...
l__0570:
	...
	emu_cmpw(&emu_ax, 0x3);
	if (emu_ax == 0x3) goto l__0590;
	goto l__059E;
l__0589:
	emu_get_memory16(emu_ss, emu_bp, -0x4) = 0x8001;
	goto l__05B2;
l__0590:
	emu_get_memory16(emu_ss, emu_bp, -0x4) = 0x8004;
	goto l__05B2;
l__0597:
...
l__059E:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x05AD); f__1FB5_1B8D_0010_8159();
	/* Unresolved jump */ emu_ip = 0x05AD; emu_last_cs = 0x1FB5; emu_last_ip = 0x05AD; emu_last_length = 0x000F; emu_last_crc = 0xC3C2; emu_call();
l__05B2:
	emu_testw(&emu_get_memory16(emu_ss, emu_bp,  0xA), 0x2);
...
l__0727:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0732); emu_File_Exists();
l__0732:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
l__0734:
...
l__0748:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0756); emu_File_Open_NoInput();
l__0756:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_ax;
...
l__07BE:
	...
	emu_push(emu_cs);
	emu_push(0x07D5); emu_File_Seek_NoInput();
l__07D5:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_ax);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs);
	emu_push(0x0805); emu_File_Seek_NoInput();
l__0805:
	emu_addw(&emu_sp, 0x8);
l__0808:
	emu_bx = emu_di;
...
l__08C4:
	...
	if ((emu_get_memory8(emu_es, emu_bx, 0x12) & 0x6) != 0) goto l__08DE;
	goto l__09B8;
l__08DE:
	emu_testw(&emu_get_memory16(emu_ss, emu_bp,  0xA), 0x2);
	if ((emu_get_memory16(emu_ss, emu_bp,  0xA) & 0x2) == 0) goto l__08E8;
	goto l__09B8;
l__08E8:
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x08EE); f__1FB5_16D5_006A_679B();
l__08EE:
	emu_pop(&emu_cx);
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x091B); emu_cs = 0x2649; f__2649_02B9_000E_DFE0();
l__091B:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_dx, emu_get_memory16(emu_ss, emu_bp, -0xA));
	if (emu_dx >= emu_get_memory16(emu_ss, emu_bp, -0xA)) { /* Unresolved jump */ emu_ip = 0x0924; emu_last_cs = 0x1FB5; emu_last_ip = 0x091F; emu_last_length = 0x0009; emu_last_crc = 0x4D1E; emu_call(); return; }
	goto l__09B8;
l__09B8:
	emu_decb(&emu_get_memory8(emu_ds, 0x00, 0x986C));
	emu_ax = emu_di;
...
l__0A6F:
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x2));
	emu_push(emu_cs);
	emu_push(0x0A83); emu_File_Close_NoInput();
l__0A83:
	emu_pop(&emu_cx);
	emu_bx = emu_di;
	emu_cl = 0x4;
...
/**
 * Decompiled function emu_File_ReadBlock()
 *
 * @name emu_File_ReadBlock
...
l__0D73:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs);
	emu_push(0x0D81); emu_File_Read_NoInput();
l__0D81:
	emu_addw(&emu_sp, 0x8);
...
/**
 * Decompiled function emu_File_WriteBlock()
 *
 * @name emu_File_WriteBlock
 ...
 *
 * Called From: 29E8:0D1E:003C:E58A
...
l__0EC5:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0F0F); f__1FB5_1B8D_0010_8159();
...
l__10EA:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs);
	emu_push(0x10F8); emu_File_Write_NoInput();
l__10F8:
	emu_addw(&emu_sp, 0x8);
	emu_get_memory16(emu_ss, emu_bp, -0x8) = 0x0;
	emu_get_memory16(emu_ss, emu_bp, -0xA) = emu_ax;
 ...
 * @implements 1FB5:1263:000F:791E
 * @implements 1FB5:127A:0014:0ADF
 * @implements 1FB5:128E:0028:602F
 * @implements 1FB5:134B:001E:DBF7
 ...
 * Called From: 1FB5:0567:0072:1AA4
...
l__1230:
	...
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_ax;
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x2), 0x0);
	if (emu_get_memory16(emu_ss, emu_bp, -0x2) == 0x0) goto l__1263;
	goto l__1369;
l__1263:
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0xC);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax == 0) goto l__127A;
	emu_cmpw(&emu_ax, 0x1);
	if (emu_ax != 0x1) { /* Unresolved jump */ emu_ip = 0x1272; emu_last_cs = 0x1FB5; emu_last_ip = 0x126D; emu_last_length = 0x000F; emu_last_crc = 0x791E; emu_call(); return; }
	/* Unresolved jump */ emu_ip = 0x1326; emu_last_cs = 0x1FB5; emu_last_ip = 0x126F; emu_last_length = 0x000F; emu_last_crc = 0x791E; emu_call();
l__127A:
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0xA), 0x0);
	if ((int16)emu_get_memory16(emu_ss, emu_bp,  0xA) > (int16)0x0) goto l__128E;
	if ((int16)emu_get_memory16(emu_ss, emu_bp,  0xA) < (int16)0x0) { /* Unresolved jump */ emu_ip = 0x1288; emu_last_cs = 0x1FB5; emu_last_ip = 0x1280; emu_last_length = 0x0014; emu_last_crc = 0x0ADF; emu_call(); return; }
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp,  0x8), 0x0);
	if (emu_get_memory16(emu_ss, emu_bp,  0x8) >= 0x0) goto l__128E;
	emu_xorw(&emu_dx, emu_dx);
	emu_xorw(&emu_ax, emu_ax);
	/* Unresolved jump */ emu_ip = 0x1294; emu_last_cs = 0x1FB5; emu_last_ip = 0x128C; emu_last_length = 0x0014; emu_last_crc = 0x0ADF; emu_call();
l__128E:
	emu_dx = emu_get_memory16(emu_ss, emu_bp,  0xA);
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0x8);
	emu_get_memory16(emu_ss, emu_bp,  0xA) = emu_dx;
...
l__138C:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs);
	emu_push(0x13BD); emu_File_Seek_NoInput();
l__13BD:
	emu_addw(&emu_sp, 0x8);
	emu_bx = emu_di;
	emu_cl = 0x4;
...
l__1463:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs);
	emu_push(0x14B7); emu_File_Seek_NoInput();
l__14B7:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x4);
	emu_dx = 0x13;
...
l__14F6:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_cs);
	emu_push(0x1506); emu_File_Seek_NoInput();
l__1506:
	emu_addw(&emu_sp, 0x8);
	emu_bx = emu_di;
	emu_cl = 0x4;
 ...
 * @implements 1FB5:1594:0009:8F30
...
l__1594:
	emu_addw(&emu_sp, 0x6);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax != 0) goto l__159D;
	/* Unresolved jump */ emu_ip = 0x157F; emu_last_cs = 0x1FB5; emu_last_ip = 0x159B; emu_last_length = 0x0009; emu_last_crc = 0x8F30; emu_call();
l__159D:
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x15A8); emu_File_Exists();
l__15A8:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
/**
 * Decompiled function emu_File_Exists()
 *
 ...
 * @implements 1FB5:166C:0004:C9A5
 * @implements 1FB5:1670:000B:BBC3
 * @implements 1FB5:167B:0006:D8ED
 * @implements 1FB5:1681:000A:4DBB
 * @implements 1FB5:168B:0013:0FF1
 * @implements 1FB5:169E:000F:51F7
 * @implements 1FB5:16BA:000E:80D8
 * @implements 1FB5:16BB:000D:81E0
 * @implements 1FB5:16C8:0004:B21B
...
l__15CA:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x15E2); emu_File_Open_NoInput();
l__15E2:
	emu_addw(&emu_sp, 0x8);
	emu_di = emu_ax;
	emu_cmpw(&emu_di, 0xFFFF);
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x15F1); emu_File_Close_NoInput();
l__15F1:
	emu_pop(&emu_cx);
	emu_push(emu_cs);
	emu_push(0x15F6); emu_Drive_Get_Default_NoInput();
l__15F6:
	emu_incw(&emu_ax);
	goto l__15C7;
l__15F9:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x1604); emu_FileInfo_FindIndex_ByName();
l__1604:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs);
	emu_push(0x165C); emu_File_Exists();
l__165C:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	goto l__15C7;
l__1661:
	...
	emu_ax = (int8)emu_al;
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax != 0) goto l__166C;
	goto l__15C5;
l__166C:
	emu_push(emu_cs);
	emu_push(0x1670); emu_Drive_Get_Default_NoInput();
l__1670:
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
	emu_al = emu_get_memory8(emu_ds, 0x00, 0x986E);
	emu_ax = (int8)emu_al;
	emu_si = emu_ax;
	goto l__16BB;
l__167B:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x1681); emu_cs = 0x28FD; f__28FD_003D_0012_41DC();
l__1681:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax == 0) goto l__16BA;
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x168B); emu_Drive_Set_Default_NoInput();
l__168B:
	emu_pop(&emu_cx);
	emu_ax = 0x100;
	emu_push(emu_ax);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x169E); emu_File_Open_NoInput();
l__169E:
	emu_addw(&emu_sp, 0x8);
	emu_di = emu_ax;
	emu_cmpw(&emu_di, 0xFFFF);
	if (emu_di == 0xFFFF) goto l__16BA;
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x16AD); emu_File_Close_NoInput();
	/* Unresolved jump */ emu_ip = 0x16AD; emu_last_cs = 0x1FB5; emu_last_ip = 0x16AD; emu_last_length = 0x000F; emu_last_crc = 0x51F7; emu_call();
l__16BA:
	emu_decw(&emu_si);
l__16BB:
	emu_cmpw(&emu_si, 0xFFFF);
...
l__175A:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x1769); emu_FileInfo_FindIndex_ByName();
l__1769:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
 ...
 *
 * Called From: 257A:0064:000F:3F8D
 * Called From: 257A:00B5:000E:7879
 ...
 *
 * Called From: 257A:0073:000F:0422
...
l__180F:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x181E); emu_FileInfo_FindIndex_ByName();
l__181E:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__187C:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x1886); emu_File_Delete_NoInput();
l__1886:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
/**
 * Decompiled function f__1FB5_189B_0010_8453()
 *
 * @name f__1FB5_189B_0010_8453
 * @implements 1FB5:189B:0010:8453 ()
 * @implements 1FB5:18A9:0002:D2BA
 * @implements 1FB5:18AB:000E:354E
 * @implements 1FB5:18B9:000F:8967
 * @implements 1FB5:18C8:0006:DC7B
 * @implements 1FB5:18D0:0003:2E57
 *
 * Called From: 257A:0080:000D:1790
 */
void f__1FB5_189B_0010_8453()
{
l__189B:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
l__18AB:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x18B9); emu_File_Open();
l__18B9:
	emu_addw(&emu_sp, 0x6);
	emu_si = emu_ax;
	emu_cmpw(&emu_si, 0xFFFF);
	if (emu_si == 0xFFFF) { /* Unresolved jump */ emu_ip = 0x18CE; emu_last_cs = 0x1FB5; emu_last_ip = 0x18C1; emu_last_length = 0x000F; emu_last_crc = 0x8967; emu_call(); return; }
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x18C8); emu_File_Close();
l__18C8:
	emu_pop(&emu_cx);
	emu_ax = 0x1;
	goto l__18A9;
...
l__1910:
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1923); emu_cs = 0x2649; f__2649_02B9_000E_DFE0();
...
/**
 * Decompiled function emu_Empty6()
 *
 * @name emu_Empty6
...
l__1A6C:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x1A8C); f__1FB5_1B8D_0010_8159();
...
l__1A8F:
	...
	emu_push(emu_di);
	emu_push(emu_cs);
	emu_push(0x1AAE); f__1FB5_1B8D_0010_8159();
...
/**
 * Decompiled function f__1FB5_1B8D_0010_8159()
 *
 * @name f__1FB5_1B8D_0010_8159
 * @implements 1FB5:1B8D:0010:8159 ()
 *
 * Called From: 1FB5:0236:0014:D290
 * Called From: 1FB5:05AA:000F:C3C2
 */
void f__1FB5_1B8D_0010_8159()
{
l__1B8D:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	/* Unresolved jump */ emu_ip = 0x1B9D; emu_last_cs = 0x1FB5; emu_last_ip = 0x1B9D; emu_last_length = 0x0010; emu_last_crc = 0x8159; emu_call();
}
