...
l__0008:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x001C); emu_cs = 0x167E; emu_Tools_Index_IsValid();
l__001C:
	emu_pop(&emu_cx);
	...
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x0027); emu_cs = 0x167E; emu_Tools_Index_IsValid();
l__0027:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__0031:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0037); emu_cs = 0x167E; emu_Tools_Index_GetStructureOrUnit();
l__0037:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x0044); emu_cs = 0x167E; emu_Tools_Index_GetStructureOrUnit();
l__0044:
	emu_pop(&emu_cx);
...
l__0194:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x01A1); emu_cs = 0x167E; emu_Tools_Index_GetStructureOrUnit();
l__01A1:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
...
l__020C:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0212); emu_cs = 0x167E; emu_Tools_Index_GetStructure();
l__0212:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_dx);
	if (emu_ax == 0) goto l__0224;
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x021D); emu_cs = 0x167E; emu_Tools_Index_GetStructure();
l__021D:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
