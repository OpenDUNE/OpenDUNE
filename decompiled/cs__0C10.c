...
l__0031:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0037); emu_cs = 0x167E; emu_Tools_Index_GetObject();
l__0037:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x0044); emu_cs = 0x167E; emu_Tools_Index_GetObject();
l__0044:
	emu_pop(&emu_cx);
...
l__0194:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x01A1); emu_cs = 0x167E; emu_Tools_Index_GetObject();
l__01A1:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
