...
void f__0C10_0212_000B_6134()
{
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_dx);
	if (emu_flags.zf) { f__0C10_0224_001E_CED9(); return; }
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x021D); emu_cs = 0x167E; f__167E_02AE_000C_CC85();
	f__0C10_021D_0025_6A21(); return;
}
