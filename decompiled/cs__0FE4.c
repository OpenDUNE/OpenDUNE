...
void f__0FE4_018D_0012_A3C7()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x019F); emu_cs = 0x10BE; emu_House_FindFirst();
...
void f__0FE4_01A1_0014_E02C()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x01B5); emu_cs = 0x10BE; emu_House_FindNext();
...
void f__0FE4_01CF_002F_536D()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x01FE); emu_cs = 0x10BE; emu_House_Get_ByIndex();
 ...
 * Called From: 1423:0EB8:000F:99F1
 ...
 * Called From: 1A34:13D9:0047:54FE
 * Called From: 1A34:1615:0026:EDA4
 ...
 * Called From: 07D4:07B6:000D:6567
 ...
 * Called From: 1A34:164B:0021:E7E1
 * Called From: 1A34:164B:000A:B112
 * Called From: 1A34:2290:000B:799F
 * Called From: 1A34:2C07:000B:799F
 * Called From: 1A34:36DE:000A:B13A
 * Called From: B50B:03FE:000E:5B75
 * Called From: B511:0190:000E:5BF5
 * Called From: B511:0190:000B:799F
 * Called From: B518:101F:000B:799F
 * Called From: B518:101F:001B:6B56
 */
 ...
 * Called From: 0FE4:0560:0009:5BBE
 * Called From: 0FE4:0560:0079:7205
 */
...
void f__0FE4_03DA_0008_EB39()
{
	...
	emu_push(emu_cs); emu_push(0x03E2); emu_cs = 0x10BE; emu_House_Get_ByIndex();
...
void f__0FE4_03E2_004F_999F()
{
	...
	if (emu_flags.zf) { f__0FE4_0431_0037_C235(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_movw(&emu_dx.x, 0x5A);
	emu_imuluw(&emu_ax.x, emu_dx.x);
	emu_movw(&emu_dx.x, 0x2D07);
 ...
 * Called From: 0FE4:040E:004F:999F
 * Called From: 0FE4:0425:004F:999F
 * Called From: 0FE4:042C:004F:999F
 */
 ...
 * Called From: 0FE4:049A:0008:B54A
 */
...
/**
 * Decompiled function f__0FE4_055A_0009_5BBE()
 *
 * @name f__0FE4_055A_0009_5BBE
 * @implements 0FE4:055A:0009:5BBE ()
 *
 * Called From: 0FE4:04CE:000B:ECCA
 */
void f__0FE4_055A_0009_5BBE()
{
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	f__0FE4_03CB_0003_5D85(); return;
 ...
 *
 * Called From: 0C3A:1EE3:0012:8463
...
void f__0FE4_0590_002A_6D7E()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x05BA); emu_cs = 0x10BE; emu_House_Get_ByIndex();
 ...
 *
 * Called From: 0FE4:05A1:002A:6D7E
 ...
 * Called From: 0C3A:0EF8:0006:8FC7
 * Called From: 0C3A:1ED1:000E:0022
 * Called From: 0EDB:0407:0020:629E
 * Called From: 1391:02A5:0012:8793
 ...
 * Called From: 176C:0A89:000F:3D0A
 * Called From: 176C:0C58:001A:6D30
