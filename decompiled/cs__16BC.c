...
void f__16BC_0001_0018_AE47()
{
	...
	/* Unresolved jump */ emu_ip = 0x0041; emu_last_cs = 0x16BC; emu_last_ip = 0x0017; emu_last_length = 0x0018; emu_last_crc = 0xAE47; emu_call();
}
...
void f__16BC_0019_0028_89C5()
{
	...
	emu_incb(&emu_ax.l);
	emu_pop(&emu_es);
	emu_movb(&emu_get_memory8(emu_es, emu_bx.x,  0x6F), emu_ax.l);
 ...
 *
 * Called From: 16BC:006B:0027:CB92
 */
void f__16BC_006B_0026_801B()
{
	...
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_movb(&emu_get_memory8(emu_es, emu_bx.x,  0x6F), 0x0);
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x8));
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_subw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x4));
