...
void f__07AE_0000_00DF_A32C()
{
	...
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x992D), emu_ax.x);
	emu_addws(&emu_get_memory16(emu_ss, emu_bp, -0x6), 0x2);
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x0));
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x992B), emu_ax.x);
	emu_addws(&emu_get_memory16(emu_ss, emu_bp, -0x6), 0x2);
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x0));
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x992F), emu_ax.x);
	emu_addws(&emu_get_memory16(emu_ss, emu_bp, -0x6), 0x2);
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x0));
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x9931), emu_ax.x);
	emu_addws(&emu_get_memory16(emu_ss, emu_bp, -0x6), 0x2);
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_es, emu_bx.x,  0x0));
...
void f__07AE_014F_001B_3CCB()
{
	...
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x8225), emu_ax.x);
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x9935), emu_ax.x);
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x9933), 0x0);
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x3196), 0x0);
	emu_movw(&emu_sp, emu_bp);
	emu_pop(&emu_bp);
