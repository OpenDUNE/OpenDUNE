...
l__049D:
	...
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x04AA); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__04AA:
	emu_pop(&emu_cx);
...
l__05A8:
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x05B1); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__05B1:
	emu_pop(&emu_cx);
...
l__05E5:
	...
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x05F1); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__05F1:
	emu_pop(&emu_cx);
...
l__0625:
	...
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0631); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0631:
	emu_pop(&emu_cx);
...
l__0665:
	...
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0671); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0671:
	emu_pop(&emu_cx);
...
l__06A5:
	...
	emu_ax = 0x3;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x06B1); emu_cs = 0x252E; emu_Unknown_252E_0001();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__06B1:
	emu_pop(&emu_cx);
...
/**
 * Decompiled function emu_Save_Main()
 *
 * @name emu_Save_Main
...
l__093D:
	...
	emu_push(emu_dx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0959); emu_cs = 0x34B1; overlay(0x34B1, 0); emu_Save_Chunk();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0959:
	emu_addw(&emu_sp, 0xE);
...
l__0977:
	...
	emu_push(emu_dx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0993); emu_cs = 0x34B1; overlay(0x34B1, 0); emu_Save_Chunk();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0993:
	emu_addw(&emu_sp, 0xE);
...
l__09B1:
	...
	emu_push(emu_dx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x09CD); emu_cs = 0x34B1; overlay(0x34B1, 0); emu_Save_Chunk();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__09CD:
	emu_addw(&emu_sp, 0xE);
...
l__09EB:
	...
	emu_push(emu_dx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0A07); emu_cs = 0x34B1; overlay(0x34B1, 0); emu_Save_Chunk();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0A07:
	emu_addw(&emu_sp, 0xE);
...
l__0A25:
	...
	emu_push(emu_dx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0A41); emu_cs = 0x34B1; overlay(0x34B1, 0); emu_Save_Chunk();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0A41:
	emu_addw(&emu_sp, 0xE);
...
l__0A5F:
	...
	emu_push(emu_dx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0A7B); emu_cs = 0x34B1; overlay(0x34B1, 0); emu_Save_Chunk();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0A7B:
	emu_addw(&emu_sp, 0xE);
...
l__0CDA:
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0CE9); emu_cs = 0x29DA; emu_GUI_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0CE9:
	emu_pop(&emu_cx);
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0CF4); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Window_Widget_Allocate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0CF4:
	emu_addw(&emu_sp, 0xE);
...
l__0D18:
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D27); emu_cs = 0x29DA; emu_GUI_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0D27:
	emu_pop(&emu_cx);
	...
	emu_ax = 0x2;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0D32); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Window_Widget_Allocate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0D32:
	emu_addw(&emu_sp, 0xE);
...
l__10A9:
	...
	emu_ax = 0x2BE4;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x10C5); emu_cs = 0x0642; emu_String_GenerateFilename();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__10C5:
	emu_pop(&emu_cx);
...
l__1132:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_cs); emu_push(0x113D); emu_cs = 0x34A2; overlay(0x34A2, 0); emu_GUI_Widget_HandleEvents();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__113D:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0xE) = emu_ax;
	emu_push(emu_cs); emu_push(0x1147); emu_cs = 0x0642; emu_GUI_PaletteAnimate();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1147:
...
l__1212:
	...
	emu_ax = 0x6B;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1236); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1236:
	emu_pop(&emu_cx);
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1245); emu_cs = 0x29DA; emu_GUI_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1245:
	emu_pop(&emu_cx);
...
l__126A:
	...
	emu_ax = 0x6C;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x128E); emu_cs = 0x0FCB; emu_String_Get_ByIndex();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__128E:
	emu_pop(&emu_cx);
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x129D); emu_cs = 0x29DA; emu_GUI_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__129D:
	emu_pop(&emu_cx);
...
l__12EC:
	...
	emu_ax = 0x9939;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1308); emu_cs = 0x0642; emu_String_GenerateFilename();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1308:
	emu_pop(&emu_cx);
...
l__1311:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x38DC));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x38DA));
	emu_push(emu_cs); emu_push(0x1329); emu_cs = 0x2502; emu_String_TranslateSpecial();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1329:
	emu_addw(&emu_sp, 0x8);
...
l__1366:
	...
	emu_ax = 0x2C0A;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1387); emu_cs = 0x0642; emu_String_GenerateFilename();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1387:
	emu_pop(&emu_cx);
