 ...
 *
 * Called From: B511:000E:000E:B463
 */
void f__B511_000E_000E_C19A()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x001C; emu_last_cs = 0xB511; emu_last_ip = 0x0015; emu_last_length = 0x000E; emu_last_crc = 0xC19A; emu_call(); return; } // Jump does not resolve
	emu_push(emu_cs);
 ...
 *
 * Called From: B511:001C:000E:C19A
 */
 ...
 *
 * Called From: B511:002E:0010:AE09
 */
 ...
 *
 * Called From: B511:0034:0006:5897
 */
...
void f__B511_0041_000B_5F37()
{
	...
	if (emu_flags.zf) { emu_ip = 0x006B; emu_last_cs = 0xB511; emu_last_ip = 0x0045; emu_last_length = 0x000B; emu_last_crc = 0x5F37; emu_call(); return; } // Jump does not resolve
	emu_push(emu_cs);
 ...
 *
 * Called From: B511:004C:000B:5F37
 */
void f__B511_004C_001F_8760()
{
	emu_cmpws(&emu_si, 0x5);
	if (!emu_flags.cf) { emu_ip = 0x0069; emu_last_cs = 0xB511; emu_last_ip = 0x004F; emu_last_length = 0x001F; emu_last_crc = 0x8760; emu_call(); return; } // Jump does not resolve
...
void f__B511_0091_001D_9C25()
{
	...
	emu_push(emu_cs); emu_push(0x00AE); emu_cs = 0x1082; f__1082_000F_0012_A3C7();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:00AE:001D:9C25
 */
void f__B511_00AE_0005_D341()
{
	emu_push(emu_cs); emu_push(0x00B3); emu_cs = 0x0FE4; f__0FE4_018D_0012_A3C7();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:00B3:0005:D341
 */
void f__B511_00B3_0005_ACC2()
{
	emu_push(emu_cs); emu_push(0x00B8); emu_cs = 0x104B; f__104B_0006_0011_631B();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:00B8:0005:ACC2
 */
 ...
 *
 * Called From: 261F:01B9:001B:EDBF
 * Called From: B511:00C3:0006:22E8
 */
void f__B511_00C3_0031_A63E()
{
	...
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x00F4); emu_cs = 0x34CD; emu_ip = 0x01AA; emu_last_cs = 0xB511; emu_last_ip = 0x00EF; emu_last_length = 0x0031; emu_last_crc = 0xA63E; emu_call(); // Jump does not resolve
 ...
 *
 * Called From: B511:00F4:0017:80BE
 * Called From: B511:00F4:0006:62E9
 */
void f__B511_00F4_0048_84FE()
{
	...
	if (emu_flags.zf) { emu_ip = 0x013E; emu_last_cs = 0xB511; emu_last_ip = 0x0130; emu_last_length = 0x0048; emu_last_crc = 0x84FE; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x3A38));
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x013C); emu_cs = 0x34CD; emu_ip = 0x0206; emu_last_cs = 0xB511; emu_last_ip = 0x0137; emu_last_length = 0x0048; emu_last_crc = 0x84FE; emu_call(); // Jump does not resolve
...
void f__B511_011F_001D_05F8()
{
	...
	emu_addw(&emu_bx.x, emu_ax.x);
	emu_testb(&emu_get_memory8(emu_es, emu_bx.x,  0x2), 0x8);
	if (emu_flags.zf) { emu_ip = 0x013E; emu_last_cs = 0xB511; emu_last_ip = 0x0130; emu_last_length = 0x001D; emu_last_crc = 0x05F8; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x3A38));
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x013C); emu_cs = 0x34CD; ovl__34CD(34);
	/* Check if this overlay should be reloaded */
 ...
 *
 * Called From: B511:013C:002E:C197
 * Called From: B511:013C:001D:05F8
 */
void f__B511_013C_000C_1A4E()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0148; emu_last_cs = 0xB511; emu_last_ip = 0x0143; emu_last_length = 0x000C; emu_last_crc = 0x1A4E; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpw(&emu_di, 0x1000);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x0148; emu_last_cs = 0xB511; emu_last_ip = 0x0143; emu_last_length = 0x0009; emu_last_crc = 0x2E15; emu_call(); return; } // Jump does not resolve
	f__B511_00BD_0006_22E8(); return;
}
...
void f__B511_0148_0013_5F86()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x015B); emu_cs = 0x0FE4; f__0FE4_0243_003A_D5F2();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:015B:0013:5F86
 */
...
void f__B511_0160_0016_EAC5()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x018A; emu_last_cs = 0xB511; emu_last_ip = 0x0169; emu_last_length = 0x0016; emu_last_crc = 0xEAC5; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B511:0176:0016:EAC5
 */
 ...
 *
 * Called From: B511:0187:0011:2C4F
 */
void f__B511_0187_000E_5BF5()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0195); emu_cs = 0x0FE4; f__0FE4_0283_0038_4950();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0195:000E:5BF5
 */
void f__B511_0195_0023_CF90()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x01B8); emu_cs = 0x1082; f__1082_00FD_003A_D7E0();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
...
void f__B511_0197_0021_84A6()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x01B8); emu_cs = 0x1082; emu_ip = 0x02B5; emu_last_cs = 0xB511; emu_last_ip = 0x01B3; emu_last_length = 0x0021; emu_last_crc = 0x84A6; emu_call(); // Jump does not resolve
	f__B511_01B8_0006_D78F();
}
 ...
 *
 * Called From: B511:01B8:0023:CF90
 */
...
void f__B511_01BE_000E_2B7B()
{
	...
	emu_ip = 0x02E6; emu_last_cs = 0xB511; emu_last_ip = 0x01C9; emu_last_length = 0x000E; emu_last_crc = 0x2B7B; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:01D7:000B:5450
 */
void f__B511_01D7_0024_B3E5()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0258; emu_last_cs = 0xB511; emu_last_ip = 0x01EB; emu_last_length = 0x0024; emu_last_crc = 0xB3E5; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_movb(&emu_ax.l, emu_get_memory8(emu_es, emu_bx.x,  0x3));
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x01FB); emu_cs = 0x0FE4; emu_ip = 0x07F8; emu_last_cs = 0xB511; emu_last_ip = 0x01F6; emu_last_length = 0x0024; emu_last_crc = 0xB3E5; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B511:0270:0018:7FFC
 */
void f__B511_0270_001B_5DD0()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x028B); emu_cs = 0x10BE; emu_ip = 0x0436; emu_last_cs = 0xB511; emu_last_ip = 0x0286; emu_last_length = 0x001B; emu_last_crc = 0x5DD0; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__B511_02A3_000E_EBD1()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x02B1); emu_cs = 0x10BE; f__10BE_01AB_002F_0E7B();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:02B1:000E:EBD1
 */
void f__B511_02B1_001D_CE78()
{
	...
	emu_movws(&emu_ax.x, emu_ax.l);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x02CE); emu_cs = 0x10BE; f__10BE_01AB_002F_0E7B();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:02CE:001D:CE78
 */
 ...
 *
 * Called From: B511:02F1:0023:44EC
 * Called From: B511:02F1:000B:166D
 */
...
void f__B511_02F3_0011_CEBD()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x6));
	if (emu_flags.zf) { emu_ip = 0x0304; emu_last_cs = 0xB511; emu_last_ip = 0x02FF; emu_last_length = 0x0011; emu_last_crc = 0xCEBD; emu_call(); return; } // Jump does not resolve
	f__B511_01BE_000E_2B7B(); return;
}
...
void f__B511_0304_000B_E66F()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x030F); emu_cs = 0x10BE; f__10BE_01E2_0027_6596();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:030F:000B:E66F
 */
 ...
 *
 * Called From: B511:031C:000B:3CA9
 */
 ...
 *
 * Called From: B511:0333:0017:D892
 */
 ...
 *
 * Called From: B511:033F:000C:E8B5
 */
void f__B511_033F_000C_3391()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x034B); emu_cs = 0x10BE; f__10BE_020F_004E_633B();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 * Called From: B511:034B:000C:3391
 */
 ...
 *
 * Called From: B511:0379:0015:3476
 */
 ...
 *
 * Called From: B511:038B:0012:C11C
 */
void f__B511_038B_0011_D3A9()
{
	...
	emu_push(emu_cs); emu_push(0x039C); emu_cs = 0x1082; emu_ip = 0x073D; emu_last_cs = 0xB511; emu_last_ip = 0x0397; emu_last_length = 0x0011; emu_last_crc = 0xD3A9; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__B511_03A6_002C_6CEA()
{
	...
	emu_push(emu_cs); emu_push(0x03D2); emu_cs = 0x0F78; emu_ip = 0x0657; emu_last_cs = 0xB511; emu_last_ip = 0x03CD; emu_last_length = 0x002C; emu_last_crc = 0x6CEA; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B511:03DE:0009:6093
 */
 ...
 *
 * Called From: B511:040B:002D:9F7E
 */
...
void f__B511_0446_0013_E4E5()
{
	...
	emu_ip = 0x071E; emu_last_cs = 0xB511; emu_last_ip = 0x0456; emu_last_length = 0x0013; emu_last_crc = 0xE4E5; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:0462:0009:C151
 */
 ...
 *
 * Called From: B511:0468:0006:5E88
 */
 ...
 *
 * Called From: B511:0477:000F:1E3D
 */
void f__B511_0477_000B_28F6()
{
	...
	emu_push(emu_cs); emu_push(0x0482); emu_cs = 0x3500; emu_ip = 0x04A2; emu_last_cs = 0xB511; emu_last_ip = 0x047D; emu_last_length = 0x000B; emu_last_crc = 0x28F6; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B511:049D:000B:4489
 */
 ...
 *
 * Called From: B511:04AA:000D:5685
 */
 ...
 *
 * Called From: B511:04CD:0023:7B53
 */
void f__B511_04CD_000C_4C78()
{
	...
	emu_ip = 0x06FA; emu_last_cs = 0xB511; emu_last_ip = 0x04D6; emu_last_length = 0x000C; emu_last_crc = 0x4C78; emu_call(); // Jump does not resolve
}
...
void f__B511_04D9_000D_34BA()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x04E6; emu_last_cs = 0xB511; emu_last_ip = 0x04E1; emu_last_length = 0x000D; emu_last_crc = 0x34BA; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B511:059E:000C:E98C
 */
void f__B511_059E_000A_88AF()
{
	...
	emu_ip = 0x06EA; emu_last_cs = 0xB511; emu_last_ip = 0x05A5; emu_last_length = 0x000A; emu_last_crc = 0x88AF; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:05B1:0009:C506
 */
 ...
 *
 * Called From: B511:05D4:0023:4CA4
 */
 ...
 *
 * Called From: B511:05E5:0011:66E3
 */
 ...
 *
 * Called From: B511:05F1:000C:4CAE
 */
 ...
 *
 * Called From: B511:0614:0023:84C2
 */
 ...
 *
 * Called From: B511:0625:0011:96E3
 */
 ...
 *
 * Called From: B511:0631:000C:4CAE
 */
 ...
 *
 * Called From: B511:0654:0023:05E3
 */
 ...
 *
 * Called From: B511:0665:0011:C6E3
 */
 ...
 *
 * Called From: B511:0671:000C:4CAE
 */
 ...
 *
 * Called From: B511:0694:0023:6912
 */
 ...
 *
 * Called From: B511:06A5:0011:76E2
 */
 ...
 *
 * Called From: B511:06B1:000C:4CAE
 */
 ...
 *
 * Called From: B511:06D4:0023:C436
 */
 ...
 *
 * Called From: B511:06E5:0011:A6E2
 */
 ...
 *
 * Called From: B511:070E:0006:42FE
 */
void f__B511_070E_000C_C3E1()
{
	emu_pop(&emu_cx.x);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x38BE), 0x1);
	if (emu_flags.zf) { emu_ip = 0x071A; emu_last_cs = 0xB511; emu_last_ip = 0x0714; emu_last_length = 0x000C; emu_last_crc = 0xC3E1; emu_call(); return; } // Jump does not resolve
	emu_push(emu_cs);
 ...
 *
 * Called From: B511:071A:000C:C3E1
 */
...
void f__B511_0729_0016_F168()
{
	...
	emu_incw(&emu_get_memory16(emu_ds, 0x00,  0x38BC));
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x37A0), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x073F; emu_last_cs = 0xB511; emu_last_ip = 0x073A; emu_last_length = 0x0016; emu_last_crc = 0xF168; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B511:080F:000F:842C
 */
 ...
 *
 * Called From: B511:0830:0021:E6D5
 */
 ...
 *
 * Called From: B511:084F:001F:5866
 */
 ...
 *
 * Called From: B511:086E:001F:AE21
 */
void f__B511_086E_000E_C613()
{
	...
	emu_ip = 0x0922; emu_last_cs = 0xB511; emu_last_ip = 0x0879; emu_last_length = 0x000E; emu_last_crc = 0xC613; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:0898:001C:2075
 */
 ...
 *
 * Called From: B511:08A6:000E:9B98
 */
 ...
 *
 * Called From: B511:08C1:001B:5CCA
 */
 ...
 *
 * Called From: B511:08DB:001A:7CEF
 */
 ...
 *
 * Called From: B511:08F0:0015:0963
 */
void f__B511_08F0_002F_3CDB()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0922; emu_last_cs = 0xB511; emu_last_ip = 0x0901; emu_last_length = 0x002F; emu_last_crc = 0x3CDB; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B511:091F:002F:3CDB
 */
 ...
 *
 * Called From: B511:092B:000C:4FAE
 */
 ...
 *
 * Called From: B511:093D:0012:F13A
 */
 ...
 *
 * Called From: B511:0959:001C:1421
 */
 ...
 *
 * Called From: B511:0965:000C:4EAE
 */
 ...
 *
 * Called From: B511:0977:0012:513A
 */
 ...
 *
 * Called From: B511:0993:001C:EBB0
 */
 ...
 *
 * Called From: B511:099F:000C:4EAE
 */
 ...
 *
 * Called From: B511:09B1:0012:013A
 */
 ...
 *
 * Called From: B511:09CD:001C:6A91
 */
 ...
 *
 * Called From: B511:09D9:000C:4EAE
 */
 ...
 *
 * Called From: B511:09EB:0012:B13B
 */
 ...
 *
 * Called From: B511:0A07:001C:0660
 */
 ...
 *
 * Called From: B511:0A13:000C:4EAE
 */
 ...
 *
 * Called From: B511:0A25:0012:A13A
 */
 ...
 *
 * Called From: B511:0A41:001C:23D6
 */
 ...
 *
 * Called From: B511:0A4D:000C:4EAE
 */
 ...
 *
 * Called From: B511:0A5F:0012:613B
 */
 ...
 *
 * Called From: B511:0A7B:001C:AB44
 */
 ...
 *
 * Called From: B511:0A84:0009:260D
 */
...
void f__B511_0A8F_000E_EE64()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0A9D); emu_cs = 0x0FE4; f__0FE4_013F_001C_39CA();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0A9D:000E:EE64
 */
void f__B511_0A9D_000D_8BD5()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0AAA); emu_cs = 0x1082; f__1082_0098_001C_39E2();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0AAA:000D:8BD5
 */
void f__B511_0AAA_000D_9BEB()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0AB7); emu_cs = 0x104B; f__104B_005D_001C_39F6();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0AB7:000D:9BEB
 */
void f__B511_0AB7_000D_CBD3()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0AC4); emu_cs = 0x10BE; f__10BE_000C_0020_F10F();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0AC4:000D:CBD3
 */
void f__B511_0AC4_0016_9707()
{
	...
	emu_push(emu_cs); emu_push(0x0ADA); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0ADA:0016:9707
 */
void f__B511_0ADA_0017_3E92()
{
	...
	emu_push(emu_cs); emu_push(0x0AF1); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0AF1:0017:3E92
 */
void f__B511_0AF1_0017_AFF4()
{
	...
	emu_push(emu_cs); emu_push(0x0B08); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B08:0017:AFF4
 */
void f__B511_0B08_0014_F77F()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B1C); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B1C:0014:F77F
 */
void f__B511_0B1C_0014_F773()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B30); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B30:0014:F773
 */
void f__B511_0B30_0014_F777()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B44); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B44:0014:F777
 */
void f__B511_0B44_0014_F74B()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B58); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B58:0014:F74B
 */
void f__B511_0B58_0014_F74F()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B6C); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B6C:0014:F74F
 */
void f__B511_0B6C_001D_7B37()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B89); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B89:001D:7B37
 */
void f__B511_0B89_0014_F14D()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0B9D); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0B9D:0014:F14D
 */
 ...
 *
 * Called From: B511:0BA9:000C:4B79
 */
 ...
 *
 * Called From: B511:0C01:0058:9298
 */
 ...
 *
 * Called From: B511:0C30:002A:8725
 */
 ...
 *
 * Called From: B511:0C5F:002A:C70F
 */
...
void f__B511_0C93_0014_2A98()
{
	...
	emu_ip = 0x0E3F; emu_last_cs = 0xB511; emu_last_ip = 0x0CA4; emu_last_length = 0x0014; emu_last_crc = 0x2A98; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:0CDA:001E:3AA6
 */
 ...
 *
 * Called From: B511:0CE9:000F:E74D
 */
 ...
 *
 * Called From: B511:0CF4:000B:6BAA
 */
 ...
 *
 * Called From: B511:0D18:0024:CF16
 */
 ...
 *
 * Called From: B511:0D27:000F:E74D
 */
 ...
 *
 * Called From: B511:0D32:000B:68AA
 */
 ...
 *
 * Called From: B511:0D4C:001A:F3E0
 */
 ...
 *
 * Called From: B511:0D5E:0012:77BF
 */
 ...
 *
 * Called From: B511:0D6A:000C:5509
 */
 ...
 *
 * Called From: B511:0D72:0008:8F41
 */
 ...
 *
 * Called From: B511:0D95:0023:911C
 * Called From: B511:0D95:0022:9A3C
 */
 ...
 *
 * Called From: B511:0DB1:001C:BDE5
 */
 ...
 *
 * Called From: B511:0DBA:0009:DAE3
 */
 ...
 *
 * Called From: B511:0DD2:0018:314D
 */
 ...
 *
 * Called From: B511:0DF2:0020:BA81
 */
 ...
 *
 * Called From: B511:0E0F:000B:9749
 */
 ...
 *
 * Called From: B511:0E1C:000D:4AD9
 */
void f__B511_0E1C_000C_15CC()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0E28; emu_last_cs = 0xB511; emu_last_ip = 0x0E21; emu_last_length = 0x000C; emu_last_crc = 0x15CC; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B511:0E28:000C:15CC
 */
 ...
 *
 * Called From: B511:0E3C:0014:36BE
 */
 ...
 *
 * Called From: B511:0E50:000C:24F5
 */
 ...
 *
 * Called From: B511:0E6B:000C:DD83
 */
 ...
 *
 * Called From: B511:0E75:000A:9968
 */
void f__B511_0E75_0023_E3A4()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0xC));
	if (emu_flags.zf) { emu_ip = 0x0EE0; emu_last_cs = 0xB511; emu_last_ip = 0x0E7C; emu_last_length = 0x0023; emu_last_crc = 0xE3A4; emu_call(); return; } // Jump does not resolve
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_xorw(&emu_dx.x, emu_dx.x);
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
 ...
 *
 * Called From: B511:0E98:0023:E3A4
 */
 ...
 *
 * Called From: B511:0EA6:000E:204B
 */
 ...
 *
 * Called From: B511:0ED0:002A:894B
 */
 ...
 *
 * Called From: B511:0EDE:000E:1EBD
 */
 ...
 *
 * Called From: B511:0EE9:000B:1AF2
 */
 ...
 *
 * Called From: B511:0EF2:0009:E4DB
 */
 ...
 *
 * Called From: B511:0EF8:0006:0569
 */
 ...
 *
 * Called From: B511:0F18:0020:001D
 */
 ...
 *
 * Called From: B511:0F20:0008:43E5
 */
 ...
 *
 * Called From: B511:0F31:0011:9942
 */
 ...
 *
 * Called From: B511:0F6D:0018:A36B
 */
 ...
 *
 * Called From: B511:0F7A:000D:C913
 * Called From: B511:0F7A:000B:0481
 */
 ...
 *
 * Called From: B511:0F83:0009:0F5C
 */
 ...
 *
 * Called From: 261F:01B9:001B:EDBF
 * Called From: B511:0F8B:0008:4C65
 */
void f__B511_0F8B_000C_C06C()
{
	...
	emu_push(emu_cs); emu_push(0x0F97); emu_cs = 0x29E8; f__29E8_073F_000E_6816();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0F97:0005:E089
 * Called From: B511:0F97:000C:C06C
 */
 ...
 *
 * Called From: B511:0FA2:000B:9995
 */
...
void f__B511_0FB0_0028_02A0()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0FD8); emu_cs = 0x01F7; f__01F7_2947_0014_02B8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:0FD8:0028:02A0
 */
 ...
 *
 * Called From: B511:0FE6:000E:7213
 */
 ...
 *
 * Called From: B511:0FF1:000B:EDE5
 */
 ...
 *
 * Called From: 261F:01B9:001B:EDBF
 * Called From: B511:1007:0016:1AAC
 */
 ...
 *
 * Called From: B511:101F:0010:D0C5
 */
 ...
 *
 * Called From: B511:1062:0043:8F6D
 */
 ...
 *
 * Called From: 261F:01B9:001B:EDBF
 * Called From: B511:1097:0035:7C26
 */
...
{
	emu_cmpws(&emu_di, 0x2);
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x10A9; emu_last_cs = 0xB511; emu_last_ip = 0x10A4; emu_last_length = 0x0008; emu_last_crc = 0x5BBF; emu_call(); return; } // Jump does not resolve
	f__B511_100F_0010_D0C5(); return;
}
 ...
 *
 * Called From: B511:10C5:001C:9617
 */
 ...
 *
 * Called From: B511:10CE:0009:0769
 */
 ...
 *
 * Called From: B511:10E9:001B:4375
 */
 ...
 *
 * Called From: B511:10F1:0008:C3E0
 */
 ...
 *
 * Called From: B511:1111:0020:001D
 */
 ...
 *
 * Called From: B511:1125:0014:B1CE
 */
 ...
 *
 * Called From: B511:112D:0008:1BE5
 */
 ...
 *
 * Called From: 261F:01B9:001B:EDBF
 * Called From: B511:113D:000B:D4F4
 */
 ...
 *
 * Called From: B511:1147:000A:C086
 */
void f__B511_1147_0020_6FFF()
{
	...
	if (emu_flags.zf) { emu_ip = 0x1167; emu_last_cs = 0xB511; emu_last_ip = 0x1159; emu_last_length = 0x0020; emu_last_crc = 0x6FFF; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_ax.x, 0x8002);
	if (emu_flags.zf) { emu_ip = 0x116C; emu_last_cs = 0xB511; emu_last_ip = 0x115E; emu_last_length = 0x0020; emu_last_crc = 0x6FFF; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_ax.x, 0x8003);
	if (emu_flags.zf) { emu_ip = 0x1171; emu_last_cs = 0xB511; emu_last_ip = 0x1163; emu_last_length = 0x0020; emu_last_crc = 0x6FFF; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x1175; emu_last_cs = 0xB511; emu_last_ip = 0x1165; emu_last_length = 0x0020; emu_last_crc = 0x6FFF; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:1181:000A:673D
 */
void f__B511_1181_0014_18D0()
{
	...
	emu_movw(&emu_ax.x, emu_bp - 0x314);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x1195); emu_cs = 0x259E; emu_ip = 0x119B; emu_last_cs = 0xB511; emu_last_ip = 0x1190; emu_last_length = 0x0014; emu_last_crc = 0x18D0; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__B511_119B_0012_75BC()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x11AD); emu_cs = 0x3483; emu_ip = 0x11D7; emu_last_cs = 0xB511; emu_last_ip = 0x11A8; emu_last_length = 0x0012; emu_last_crc = 0x75BC; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
 ...
 *
 * Called From: B511:11D6:001B:9F2E
 */
...
void f__B511_11E4_0017_51C5()
{
	...
	emu_movw(&emu_ax.x, emu_bp - 0x314);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x11FB); emu_cs = 0x259E; emu_ip = 0x1201; emu_last_cs = 0xB511; emu_last_ip = 0x11F6; emu_last_length = 0x0017; emu_last_crc = 0x51C5; emu_call(); // Jump does not resolve
	f__B511_11FB_0014_EDAC();
}
 ...
 *
 * Called From: B511:11FB:0025:9022
 */
void f__B511_11FB_0014_EDAC()
{
	emu_addws(&emu_sp, 0x6);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x37AE), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x120C; emu_last_cs = 0xB511; emu_last_ip = 0x1203; emu_last_length = 0x0014; emu_last_crc = 0xEDAC; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x37A0), 0x0);
	if (emu_flags.zf) { f__B511_1212_0024_1AEB(); return; }
	emu_ip = 0x14AC; emu_last_cs = 0xB511; emu_last_ip = 0x120C; emu_last_length = 0x0014; emu_last_crc = 0xEDAC; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B511:1236:0024:1AEB
 */
 ...
 *
 * Called From: B511:1245:000F:E74D
 */
 ...
 *
 * Called From: B511:126A:001A:4715
 */
 ...
 *
 * Called From: B511:128E:0024:2BD7
 */
 ...
 *
 * Called From: B511:129D:000F:E74D
 */
 ...
 *
 * Called From: 261F:01B9:001B:EDBF
 * Called From: B511:12A8:000B:68AA
 */
 ...
 *
 * Called From: B511:12C2:001A:4715
 */
 ...
 *
 * Called From: B511:12EC:002A:D28B
 */
 ...
 *
 * Called From: B511:1308:001C:D688
 */
 ...
 *
 * Called From: B511:1311:0009:DAE3
 */
 ...
 *
 * Called From: B511:1329:0018:314D
 */
 ...
 *
 * Called From: B511:133A:0011:4468
 */
 ...
 *
 * Called From: B511:1343:0009:70CE
 */
 ...
 *
 * Called From: B511:1366:0023:0A38
 */
 ...
 *
 * Called From: B511:1387:0021:27D9
 */
 ...
 *
 * Called From: B511:1390:0009:0769
 */
 ...
 *
 * Called From: B511:1398:0008:DBE0
 */
 ...
 *
 * Called From: B511:13B8:0020:F01E
 */
 ...
 *
 * Called From: B511:13E4:002C:FE1E
 */
 ...
 *
 * Called From: B511:13F2:000E:0FF5
 */
...
void f__B511_1422_0019_858B()
{
	...
	if (emu_flags.zf) { emu_ip = 0x13F9; emu_last_cs = 0xB511; emu_last_ip = 0x142D; emu_last_length = 0x0019; emu_last_crc = 0x858B; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B511:143B:0019:858B
 */
 ...
 *
 * Called From: B511:144C:000F:CDB2
 */
 ...
 *
 * Called From: B511:146C:001B:8EEC
 */
...
void f__B511_147A_000D_5E94()
{
	...
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0xE));
	if (!emu_flags.zf) { f__B511_1451_001B_8EEC(); return; }
	emu_push(emu_cs); emu_push(0x1487); emu_cs = 0x34DA; emu_ip = 0x14AC; emu_last_cs = 0xB511; emu_last_ip = 0x1482; emu_last_length = 0x000D; emu_last_crc = 0x5E94; emu_call(); // Jump does not resolve
	f__B511_1487_0005_8EFD();
}
 ...
 *
 * Called From: B511:1487:001B:0682
 */
 ...
 *
 * Called From: B511:1494:0008:1199
 */
 ...
 *
 * Called From: B511:149C:0005:7A4B
 */
void f__B511_149C_000D_A79B()
{
	emu_orw(&emu_ax.x, emu_ax.x);
	if (!emu_flags.zf) { emu_ip = 0x1497; emu_last_cs = 0xB511; emu_last_ip = 0x149E; emu_last_length = 0x000D; emu_last_crc = 0xA79B; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0xC), 0x8001);
 ...
 *
 * Called From: B511:14B4:0008:FC73
 */
 ...
 *
 * Called From: B511:14D0:0015:3476
 */
void f__B511_14D0_0008_4201()
{
	emu_addws(&emu_sp, 0x8);
	emu_push(emu_cs); emu_push(0x14D8); emu_cs = 0x29E8; f__29E8_073F_000E_6816();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { ovl__3511(0xFF); }
 ...
 *
 * Called From: B511:14D8:0008:4201
 */
 ...
 *
 * Called From: B511:14DD:0005:816D
 */
 ...
 *
 * Called From: B511:14EC:000F:CDB2
 */
