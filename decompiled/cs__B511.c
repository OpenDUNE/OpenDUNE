...
l__0D6A:
	...
	emu_pop(&emu_cx);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0D72); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__0D72:
	emu_pop(&emu_cx);
...
l__0FF1:
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1007); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Sprites_Load();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1007:
	emu_addw(&emu_sp, 0x8);
...
l__100F:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x101F); emu_cs = 0x23E1; emu_Tools_Malloc();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__101F:
	emu_addw(&emu_sp, 0x6);
...
l__1236:
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1245); emu_cs = 0x29DA; emu_GUI_Widget_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1245:
	emu_pop(&emu_cx);
...
l__128E:
	...
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x129D); emu_cs = 0x29DA; emu_GUI_Widget_GetShortcut();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__129D:
	emu_pop(&emu_cx);
...
l__1308:
	...
	emu_push(emu_dx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1311); emu_cs = 0x0FCB; emu_String_LoadFile();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__1311:
	emu_addw(&emu_sp, 0xC);
...
l__14AC:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x14B4); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__14B4:
	emu_pop(&emu_cx);
...
l__14BB:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x14D0); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Sprites_Load();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3511) { overlay(0x3511, 1); }
l__14D0:
	emu_addw(&emu_sp, 0x8);
