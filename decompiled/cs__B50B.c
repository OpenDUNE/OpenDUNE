 ...
 *
 * Called From: B50B:0029:0029:BDBF
 */
 ...
 *
 * Called From: B50B:003F:0016:86FA
 */
 ...
 *
 * Called From: B50B:0055:0016:62F4
 */
 ...
 *
 * Called From: B50B:006B:0016:9CED
 */
 ...
 *
 * Called From: B50B:0082:0017:B5C0
 */
 ...
 *
 * Called From: B50B:0098:0016:ADF0
 */
 ...
 *
 * Called From: B50B:00AE:0016:245F
 */
void f__B50B_00AE_0013_EDAA()
{
	...
	emu_ip = 0x00C5; emu_last_cs = 0xB50B; emu_last_ip = 0x00BF; emu_last_length = 0x0013; emu_last_crc = 0xEDAA; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B50B:00D4:0013:414D
 */
void f__B50B_00D4_0015_3423()
{
	...
	if (emu_flags.zf) { emu_ip = 0x00E9; emu_last_cs = 0xB50B; emu_last_ip = 0x00DE; emu_last_length = 0x0015; emu_last_crc = 0x3423; emu_call(); return; } // Jump does not resolve
 ...
 *
 * Called From: B50B:00FC:000F:E9BC
 */
void f__B50B_00FC_0015_81F6()
{
	...
	emu_push(emu_get_memory16(emu_es, emu_bx.x,  0x0));
	emu_ip = 0x0115; emu_last_cs = 0xB50B; emu_last_ip = 0x010F; emu_last_length = 0x0015; emu_last_crc = 0x81F6; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B50B:0124:0013:4159
 */
 ...
 *
 * Called From: B50B:013A:0016:277C
 */
 ...
 *
 * Called From: B50B:0154:001A:18B9
 */
 ...
 *
 * Called From: B50B:016A:0016:6470
 */
 ...
 *
 * Called From: B50B:0180:0016:856A
 */
 ...
 *
 * Called From: B50B:019A:001A:4934
 */
 ...
 *
 * Called From: B50B:01B4:001A:CD0D
 */
 ...
 *
 * Called From: B50B:01D7:0023:77E2
 */
 ...
 *
 * Called From: B50B:01ED:0016:25CF
 */
 ...
 *
 * Called From: B50B:0208:001B:FE86
 */
 ...
 *
 * Called From: B50B:021E:0016:60C3
 */
void f__B50B_021E_0015_C5E6()
{
	...
	emu_push(emu_get_memory16(emu_es, emu_bx.x,  0x0));
	emu_ip = 0x0237; emu_last_cs = 0xB50B; emu_last_ip = 0x0231; emu_last_length = 0x0015; emu_last_crc = 0xC5E6; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B50B:0246:0013:C2E1
 */
 ...
 *
 * Called From: B50B:025C:0016:AAF3
 */
...
void f__B50B_0292_0055_5B5D()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0311; emu_last_cs = 0xB50B; emu_last_ip = 0x02D5; emu_last_length = 0x0055; emu_last_crc = 0x5B5D; emu_call(); return; } // Jump does not resolve
	emu_push(emu_di);
	emu_push(emu_ss);
	emu_movw(&emu_ax.x, emu_bp - 0x2);
	emu_push(emu_ax.x);
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs);
	emu_push(0x02E7); emu_ip = 0x05AA; emu_last_cs = 0xB50B; emu_last_ip = 0x02E4; emu_last_length = 0x0055; emu_last_crc = 0x5B5D; emu_call(); // Jump does not resolve
...
void f__B50B_0294_0053_5AC9()
{
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x1);
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x0);
	if (emu_flags.zf) { emu_ip = 0x0311; emu_last_cs = 0xB50B; emu_last_ip = 0x02D5; emu_last_length = 0x0053; emu_last_crc = 0x5AC9; emu_call(); return; } // Jump does not resolve
	emu_push(emu_di);
	emu_push(emu_ss);
	emu_movw(&emu_ax.x, emu_bp - 0x2);
	emu_push(emu_ax.x);
...
void f__B50B_02CC_001B_88F6()
{
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x1);
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x0);
	if (emu_flags.zf) { emu_ip = 0x0311; emu_last_cs = 0xB50B; emu_last_ip = 0x02D5; emu_last_length = 0x001B; emu_last_crc = 0x88F6; emu_call(); return; } // Jump does not resolve
	emu_push(emu_di);
	emu_push(emu_ss);
	emu_movw(&emu_ax.x, emu_bp - 0x2);
	emu_push(emu_ax.x);
 ...
 *
 * Called From: B50B:02E7:0016:7810
 * Called From: B50B:02E7:001B:88F6
 * Called From: B50B:02E7:0053:5AC9
 */
 ...
 *
 * Called From: B50B:030E:0027:EA0A
 */
void f__B50B_030E_000D_6B9A()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x031B; emu_last_cs = 0xB50B; emu_last_ip = 0x0316; emu_last_length = 0x000D; emu_last_crc = 0x6B9A; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpw(&emu_di, 0x1000);
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x031B; emu_last_cs = 0xB50B; emu_last_ip = 0x0316; emu_last_length = 0x0009; emu_last_crc = 0xAE1F; emu_call(); return; } // Jump does not resolve
	f__B50B_027A_0018_B4ED(); return;
}
...
void f__B50B_0326_0016_CD5C()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x033C); emu_cs = 0x10BE; f__10BE_01E2_0027_6596();
 ...
 *
 * Called From: B50B:033C:0016:CD5C
 */
 ...
 *
 * Called From: B50B:0352:0014:33ED
 */
 ...
 *
 * Called From: B50B:036D:001B:EC40
 */
void f__B50B_036D_000E_14EB()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x037B); emu_cs = 0x10BE; f__10BE_020F_004E_633B();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { ovl__350B(0xFF); }
 ...
 * Called From: B50B:037B:000E:14EB
 */
...
void f__B50B_0394_001F_01AF()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x03B3); emu_cs = 0x0FE4; f__0FE4_0243_003A_D5F2();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { ovl__350B(0xFF); }
 ...
 *
 * Called From: B50B:03B3:001F:01AF
 */
 ...
 *
 * Called From: B50B:03CD:0015:A7EC
 */
 ...
 *
 * Called From: B50B:03DA:000D:2F88
 */
 ...
 *
 * Called From: B50B:03F5:001B:6333
 */
void f__B50B_03F5_000E_5B75()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0403); emu_cs = 0x0FE4; f__0FE4_0283_0038_4950();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { ovl__350B(0xFF); }
 ...
 *
 * Called From: B50B:0403:000E:5B75
 */
...
void f__B50B_0405_0013_AD82()
{
	...
	if (!emu_flags.zf) { f__B50B_03B8_0015_A7EC(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_ip = 0x0418; emu_last_cs = 0xB50B; emu_last_ip = 0x0416; emu_last_length = 0x0013; emu_last_crc = 0xAD82; emu_call(); // Jump does not resolve
}
...
void f__B50B_041C_001E_0374()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x043A); emu_cs = 0x1082; f__1082_00FD_003A_D7E0();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { ovl__350B(0xFF); }
 ...
 *
 * Called From: B50B:043A:001E:0374
 */
 ...
 *
 * Called From: B50B:0453:0014:3099
 */
 ...
 *
 * Called From: B50B:0460:000D:AF5A
 */
 ...
 *
 * Called From: B50B:047A:001A:6788
 */
void f__B50B_047A_000E_3487()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0488); emu_cs = 0x1082; f__1082_013D_0038_4AF1();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { ovl__350B(0xFF); }
 ...
 *
 * Called From: B50B:0488:000E:3487
 */
...
void f__B50B_048A_0013_A582()
{
	...
	if (!emu_flags.zf) { f__B50B_043F_0014_3099(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_ip = 0x049D; emu_last_cs = 0xB50B; emu_last_ip = 0x049B; emu_last_length = 0x0013; emu_last_crc = 0xA582; emu_call(); // Jump does not resolve
}
...
void f__B50B_04A1_001A_1AA9()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x04BB); emu_cs = 0x104B; f__104B_00C2_0030_20A6();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { ovl__350B(0xFF); }
 ...
 *
 * Called From: B50B:04BB:001A:1AA9
 */
...
void f__B50B_050B_0013_A582()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	if (!emu_flags.zf) { emu_ip = 0x04C0; emu_last_cs = 0xB50B; emu_last_ip = 0x0517; emu_last_length = 0x0013; emu_last_crc = 0xA582; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
...
void f__B50B_0522_0036_7E4C()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0562; emu_last_cs = 0xB50B; emu_last_ip = 0x052F; emu_last_length = 0x0036; emu_last_crc = 0x7E4C; emu_call(); return; } // Jump does not resolve
	emu_xorw(&emu_ax.x, emu_ax.x);
 ...
 *
 * Called From: B50B:0558:0036:7E4C
 */
 ...
 *
 * Called From: B50B:0634:002C:0256
 */
