...
l__00AE:
	...
	if (emu_get_memory16(emu_ds, 0x00, 0x38E2) == 0xFFFF) goto l__00C1;
...
l__027A:
	...
	if ((emu_get_memory8(emu_es, emu_bx, 0x2) & 0x78) == 0) goto l__0292;
	emu_ax = 0x1;
	goto l__0294;
l__0292:
...
l__0294:
	...
	if ((emu_get_memory16(emu_es, emu_bx, 0x323F) & 0x8000) == 0) {
		emu_bx = emu_di;
		emu_shlw(&emu_bx, 0x1);
		emu_ax = 0x2E9C;
		emu_dx = emu_di;
		...
		if (emu_get_memory16(emu_es, emu_bx, 0x323F) == emu_dx) goto l__02D1;
	}
l__02CC:
	emu_get_memory16(emu_ss, emu_bp, -0x4) = 0x1;
l__02D1:
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x0);
	if (emu_get_memory16(emu_ss, emu_bp, -0x4) == 0x0) goto l__0311;
	emu_push(emu_di);
	emu_push(emu_ss);
	emu_movw(&emu_ax, emu_bp - 0x2);
	emu_push(emu_ax);
...
l__0312:
	...
	if ((int16)emu_di >= (int16)0x1000) goto l__031B;
	goto l__027A;
l__031B:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x2);
	goto l__0320;
...
l__033E:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0352); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__0352:
	emu_addw(&emu_sp, 0xA);
...
l__03B8:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x03CD); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__03CD:
	emu_addw(&emu_sp, 0xA);
...
l__041C:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x043A); emu_cs = 0x1082; emu_Structure_FindFirst();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__043A:
	emu_addw(&emu_sp, 0x8);
...
l__043F:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0453); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__0453:
	emu_addw(&emu_sp, 0xA);
...
l__047A:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x0488); emu_cs = 0x1082; emu_Structure_FindNext();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__0488:
	emu_pop(&emu_cx);
...
l__04C0:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x04D4); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__04D4:
	emu_addw(&emu_sp, 0xA);
...
l__0522:
	...
	emu_push(emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x0558); emu_cs = 0x01F7; emu_Tools_Divd();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__0558:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
...
l__0608:
	...
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x0634); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x350B) { overlay(0x350B, 1); }
l__0634:
	emu_addw(&emu_sp, 0xA);
