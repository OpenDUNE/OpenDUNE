...
l__00BD:
	...
	emu_cmpw(&emu_bx, 0x4);
	if (!(emu_flags.cf || emu_flags.zf)) goto l__0133;
	emu_shlw(&emu_bx, 0x1);
...
l__0252:
	...
	emu_cmpw(&emu_bx, 0x4);
	if ((emu_flags.cf || emu_flags.zf)) goto l__025E;
	goto l__031C;
l__025E:
	emu_shlw(&emu_bx, 0x1);
