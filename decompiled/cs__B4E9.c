...
l__0380:
	...
	emu_push(emu_cs); emu_push(0x0395); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E9) { overlay(0x34E9, 1); }
l__0395:
	emu_pop(&emu_cx);
...
l__039B:
	...
	emu_ax = 0x1;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x03B0); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Sprites_Load();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E9) { overlay(0x34E9, 1); }
l__03B0:
	emu_addw(&emu_sp, 0x8);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x03BA); emu_Unknown_B4E9_0000();
l__03BA:
	emu_pop(&emu_cx);
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
...
l__03C3:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x03CC); emu_Unknown_B4E9_0000();
l__03CC:
	emu_pop(&emu_cx);
	emu_ax = 0x1;
	emu_push(emu_ax);
...
l__03D6:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x03EB); emu_cs = 0x34B8; overlay(0x34B8, 0); emu_Sprites_Load();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E9) { overlay(0x34E9, 1); }
l__03EB:
	emu_addw(&emu_sp, 0x8);
...
l__0401:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x040E); emu_cs = 0x2537; emu_Tools_RandomRange();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E9) { overlay(0x34E9, 1); }
l__040E:
	emu_pop(&emu_cx);
	...
	emu_addw(&emu_ax, 0x8);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0419); emu_cs = 0x3483; overlay(0x3483, 0); emu_Sound_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34E9) { overlay(0x34E9, 1); }
l__0419:
	emu_pop(&emu_cx);
