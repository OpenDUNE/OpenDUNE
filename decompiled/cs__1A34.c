...
l__032F:
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x0335); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__0335:
	emu_pop(&emu_cx);
...
l__07A3:
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x07A9); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__07A9:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x16) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x18) = emu_ax;
...
l__0F2E:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0F34); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__0F34:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_dx);
...
l__1AD2:
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x1AD8); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__1AD8:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x8) = emu_ax;
 ...
 * Called From: 1A34:24AA:0013:9FB3
 */
...
l__1B68:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x1B81); emu_cs = 0x167E; emu_Tools_Index_IsValid();
l__1B81:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__1B95:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x1B9B); emu_cs = 0x167E; emu_Tools_Index_GetType();
l__1B9B:
	emu_pop(&emu_cx);
	emu_cmpw(&emu_ax, 0x1);
	if (emu_ax != 0x1) goto l__1C0C;
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x1BA7); emu_cs = 0x167E; emu_Tools_Index_Decode();
l__1BA7:
	emu_pop(&emu_cx);
	emu_di = emu_ax;
	emu_push(emu_di);
...
l__1BB0:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x1BDE); emu_cs = 0x167E; emu_Tools_Index_Encode();
l__1BDE:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
...
l__1BE4:
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x1BEA); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__1BEA:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x8) = emu_ax;
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x1C08); emu_cs = 0x167E; emu_Tools_Index_Encode();
l__1C08:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
l__1C0C:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x1C12); emu_cs = 0x167E; emu_Tools_Index_GetStructure();
l__1C12:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x8) = emu_ax;
...
l__1C71:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x1C80); emu_cs = 0x167E; emu_Tools_Index_Encode();
l__1C80:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x1C92); emu_cs = 0x167E; emu_Tools_Index_Encode();
l__1C92:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_push(emu_ax);
...
l__27DD:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x2809); emu_cs = 0x0FCB; emu_String_GetString();
l__2809:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__2820:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x2838); emu_cs = 0x0FCB; emu_String_GetString();
l__2838:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__283D:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_get_memory16(emu_es, emu_bx, 0x0));
	emu_push(emu_cs); emu_push(0x2848); emu_cs = 0x0FCB; emu_String_GetString();
l__2848:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__2906:
	...
	emu_addw(&emu_dx, emu_ax);
	emu_push(emu_dx);
	emu_push(emu_cs); emu_push(0x2910); emu_cs = 0x0FCB; emu_String_GetString();
l__2910:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
...
l__2FB4:
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x2FBA); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__2FBA:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_dx);
...
l__3246:
	emu_push(emu_di);
	emu_push(emu_cs); emu_push(0x324C); emu_cs = 0x34CD; overlay(0x34CD, 0); emu_Structure_GetByPackedTile();
l__324C:
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ss, emu_bp, -0x2) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_ax;
