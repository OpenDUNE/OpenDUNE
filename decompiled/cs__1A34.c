...
void f__1A34_0192_0052_7BDF()
{
	...
	/* Unresolved jump */ emu_ip = 0x01E4; emu_last_cs = 0x1A34; emu_last_ip = 0x01E4; emu_last_length = 0x0052; emu_last_crc = 0x7BDF; emu_call();
}
...
void f__1A34_0431_0011_C8E7()
{
	...
	/* Unresolved jump */ emu_ip = 0x0442; emu_last_cs = 0x1A34; emu_last_ip = 0x0442; emu_last_length = 0x0011; emu_last_crc = 0xC8E7; emu_call();
}
...
void f__1A34_067E_005F_83A6()
{
	...
	/* Unresolved jump */ emu_ip = 0x06DD; emu_last_cs = 0x1A34; emu_last_ip = 0x06DD; emu_last_length = 0x005F; emu_last_crc = 0x83A6; emu_call();
}
...
void f__1A34_08D3_0011_09E4()
{
	...
	/* Unresolved jump */ emu_ip = 0x08E4; emu_last_cs = 0x1A34; emu_last_ip = 0x08E4; emu_last_length = 0x0011; emu_last_crc = 0x09E4; emu_call();
}
...
void f__1A34_0A7C_001A_00FF()
{
	...
	/* Unresolved jump */ emu_ip = 0x0A96; emu_last_cs = 0x1A34; emu_last_ip = 0x0A96; emu_last_length = 0x001A; emu_last_crc = 0x00FF; emu_call();
}
...
void f__1A34_0D43_0019_C8A8()
{
	...
	/* Unresolved jump */ emu_ip = 0x0D5C; emu_last_cs = 0x1A34; emu_last_ip = 0x0D5C; emu_last_length = 0x0019; emu_last_crc = 0xC8A8; emu_call();
}
...
void f__1A34_0EBF_002A_B01D()
{
	...
	/* Unresolved jump */ emu_ip = 0x0EE9; emu_last_cs = 0x1A34; emu_last_ip = 0x0EE9; emu_last_length = 0x002A; emu_last_crc = 0xB01D; emu_call();
}
...
void f__1A34_1453_0023_D010()
{
	...
	/* Unresolved jump */ emu_ip = 0x1476; emu_last_cs = 0x1A34; emu_last_ip = 0x1476; emu_last_length = 0x0023; emu_last_crc = 0xD010; emu_call();
}
...
void f__1A34_22C8_001C_2671()
{
	...
	/* Unresolved jump */ emu_ip = 0x22E4; emu_last_cs = 0x1A34; emu_last_ip = 0x22E4; emu_last_length = 0x001C; emu_last_crc = 0x2671; emu_call();
}
...
void f__1A34_2426_000F_6B18()
{
	...
	/* Unresolved jump */ emu_ip = 0x2435; emu_last_cs = 0x1A34; emu_last_ip = 0x2435; emu_last_length = 0x000F; emu_last_crc = 0x6B18; emu_call();
}
...
void f__1A34_27DD_002C_C218()
{
	...
	/* Unresolved jump */ emu_ip = 0x2809; emu_last_cs = 0x1A34; emu_last_ip = 0x2809; emu_last_length = 0x002C; emu_last_crc = 0xC218; emu_call();
}
...
void f__1A34_2996_0022_D8ED()
{
	...
	/* Unresolved jump */ emu_ip = 0x29B8; emu_last_cs = 0x1A34; emu_last_ip = 0x29B8; emu_last_length = 0x0022; emu_last_crc = 0xD8ED; emu_call();
}
...
void f__1A34_2BB5_0025_30B8()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x2BDA); emu_cs = 0x0FE4; f__0FE4_0243_003A_D5F2();
...
void f__1A34_2BDF_0022_6DF3()
{
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpb(&emu_get_memory8(emu_es, emu_bx.x,  0x3), 0xFF);
	if (!emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x2C01; emu_last_cs = 0x1A34; emu_last_ip = 0x2BE7; emu_last_length = 0x0022; emu_last_crc = 0x6DF3; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpws(&emu_get_memory16(emu_es, emu_bx.x,  0x56), 0x0);
...
void f__1A34_2C0E_0038_AC99()
{
	...
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp,  0xC), 0x0);
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x2C64; emu_last_cs = 0x1A34; emu_last_ip = 0x2C20; emu_last_length = 0x0038; emu_last_crc = 0xAC99; emu_call(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x6));
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs);
	/* Unresolved call */ emu_push(0x2C46); emu_ip = 0x08FB; emu_last_cs = 0x1A34; emu_last_ip = 0x2C43; emu_last_length = 0x0038; emu_last_crc = 0xAC99; emu_call();
	/* Unresolved jump */ emu_ip = 0x2C46; emu_last_cs = 0x1A34; emu_last_ip = 0x2C46; emu_last_length = 0x0038; emu_last_crc = 0xAC99; emu_call();
}
...
void f__1A34_2C1C_002A_C573()
{
	...
	/* Unresolved jump */ emu_ip = 0x2C46; emu_last_cs = 0x1A34; emu_last_ip = 0x2C46; emu_last_length = 0x002A; emu_last_crc = 0xC573; emu_call();
}
...
void f__1A34_2C64_0020_54FF()
{
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x6));
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x2C87; emu_last_cs = 0x1A34; emu_last_ip = 0x2C6A; emu_last_length = 0x0020; emu_last_crc = 0x54FF; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0xA));
...
void f__1A34_3369_0025_D9FB()
{
	...
	/* Unresolved jump */ emu_ip = 0x338E; emu_last_cs = 0x1A34; emu_last_ip = 0x338E; emu_last_length = 0x0025; emu_last_crc = 0xD9FB; emu_call();
}
 ...
 * Called From: 176C:237A:002F:540B
 * Called From: 176C:239C:0022:A116
 * Called From: 176C:24FE:0010:1142
