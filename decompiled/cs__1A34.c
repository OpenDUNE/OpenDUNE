...
l__05D1:
	...
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x05D9); emu_cs = 0x34CD; ovl__34CD(13);
	goto l__05D9;
l__05D9:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__126E:
	...
	emu_pop(&emu_cx);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x1276); emu_cs = 0x34CD; ovl__34CD(9);
	goto l__1276;
l__1276:
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__2D76:
	...
	emu_push(emu_cs); emu_push(0x2DA9); emu_cs = 0x34C1; ovl__34C1(2);
	goto l__2DA9;
l__2DA9:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_shlw(&emu_ax, emu_cl);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x2DD1); emu_cs = 0x34C1; ovl__34C1(0);
	goto l__2DD1;
l__2DD1:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_si = emu_ax;
	emu_cmpw(&emu_si, 0x1);
	if (emu_si <= 0x1) { /* Unresolved jump */ emu_ip = 0x2DDE; emu_last_cs = 0x1A34; emu_last_ip = 0x2DD8; emu_last_length = 0x000D; emu_last_crc = 0x5E93; emu_call(); return; }
	emu_ax = emu_si;
	goto l__2DE1;
l__2DE1:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0xA));
...
l__2EDC:
	...
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_cmpb(&emu_get_memory8(emu_es, emu_bx, 0x3), 0xFF);
	if (emu_get_memory8(emu_es, emu_bx, 0x3) == 0xFF) { /* Unresolved jump */ emu_ip = 0x2F26; emu_last_cs = 0x1A34; emu_last_ip = 0x2EF3; emu_last_length = 0x0027; emu_last_crc = 0x8321; emu_call(); return; }
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_al = emu_get_memory8(emu_es, emu_bx, 0x3);
	emu_ax = (int8)emu_al;
	emu_push(emu_ax);
...
l__2F03:
	...
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x8);
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x6));
	if (emu_ax == 0) { /* Unresolved jump */ emu_ip = 0x2F26; emu_last_cs = 0x1A34; emu_last_ip = 0x2F10; emu_last_length = 0x001A; emu_last_crc = 0xC46A; emu_call(); return; }
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
...
l__37D6:
	...
	emu_ax = 0x4;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x380C); emu_cs = 0x34E9; ovl__34E9(2);
	goto l__380C;
l__380C:
	emu_pop(&emu_cx);
	goto l__380D;
