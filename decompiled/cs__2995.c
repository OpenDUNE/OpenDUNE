...
l__0004:
	...
	emu_cmpw(&emu_ax, 0x3);
	if (emu_ax != 0x3) { /* Unresolved jump */ emu_ip = 0x003D; emu_last_cs = 0x2995; emu_last_ip = 0x0018; emu_last_length = 0x001F; emu_last_crc = 0xFE17; emu_call(); return; }
	emu_ax = emu_get_memory16(emu_ds, 0x00, 0x6C91);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0023); emu_cs = 0x252E; f__252E_001B_0018_EA2C();
	goto l__0023;
l__0023:
	emu_pop(&emu_ax);
	emu_es = emu_dx;
	...
	emu_cmpw(&emu_cx, 0x0);
	if ((int16)emu_cx <= (int16)0x0) { /* Unresolved jump */ emu_ip = 0x003D; emu_last_cs = 0x2995; emu_last_ip = 0x002F; emu_last_length = 0x001A; emu_last_crc = 0x494D; emu_call(); return; }
	emu_cmpw(&emu_di, 0x140);
	if ((int16)emu_di >= (int16)0x140) { /* Unresolved jump */ emu_ip = 0x003D; emu_last_cs = 0x2995; emu_last_ip = 0x0035; emu_last_length = 0x001A; emu_last_crc = 0x494D; emu_call(); return; }
	emu_orw(&emu_di, emu_di);
	if (!emu_flags.sf) goto l__004C;
	/* Unresolved jump */ emu_ip = 0x0040; emu_last_cs = 0x2995; emu_last_ip = 0x003B; emu_last_length = 0x001A; emu_last_crc = 0x494D; emu_call();
l__004C:
	emu_bx = emu_cx;
...
l__005B:
	...
	emu_cmpw(&emu_si, 0x0);
	if ((int16)emu_si <= (int16)0x0) { /* Unresolved jump */ emu_ip = 0x00E0; emu_last_cs = 0x2995; emu_last_ip = 0x006C; emu_last_length = 0x0063; emu_last_crc = 0x0EF8; emu_call(); return; }
	emu_cmpw(&emu_bx, 0x140);
	if ((int16)emu_bx >= (int16)0x140) { /* Unresolved jump */ emu_ip = 0x00E0; emu_last_cs = 0x2995; emu_last_ip = 0x0072; emu_last_length = 0x0063; emu_last_crc = 0x0EF8; emu_call(); return; }
	emu_orw(&emu_bx, emu_bx);
	if (emu_flags.sf) {
		emu_addw(&emu_bx, emu_si);
		emu_cmpw(&emu_bx, 0x0);
		if ((int16)emu_bx <= (int16)0x0) { /* Unresolved jump */ emu_ip = 0x00E0; emu_last_cs = 0x2995; emu_last_ip = 0x007D; emu_last_length = 0x0063; emu_last_crc = 0x0EF8; emu_call(); return; }
		emu_si = emu_bx;
		emu_bx = 0x0;
	}
	goto l__0084;
