 ...
 * Called From: B491:06CB:002F:58AA
...
l__000A:
	...
	emu_bx = emu_get_memory16(emu_es, emu_di, 0x4);
	emu_xorb(&emu_ah, emu_ah);
	emu_al = emu_get_memory8(emu_es, emu_bx + emu_di, 0x4);
...
l__005B:
	...
	emu_get_memory8(emu_cs, 0x00, 0x8) = emu_al;
	emu_ax = 0x1;
	emu_push(emu_ax);
...
l__009B:
	...
	emu_es = emu_get_memory16(emu_ss, emu_bp, -0x2);
	emu_push(emu_bx);
	emu_bx = emu_get_memory16(emu_ss, emu_bp, -0x8);
	emu_addw(&emu_bx, emu_ax);
	emu_xorb(&emu_ah, emu_ah);
	emu_al = emu_get_memory8(emu_es, emu_bx + emu_di, 0x0);
	emu_pop(&emu_bx);
