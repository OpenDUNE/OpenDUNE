 ...
 * Called From: 1DD7:0283:0009:1647
...
l__0273:
	...
	emu_ax = emu_si;
	/* Unresolved jump */ emu_ip = 0x0280; emu_last_cs = 0x1DD7; emu_last_ip = 0x027B; emu_last_length = 0x000A; emu_last_crc = 0x426C; emu_call();
l__027D:
	emu_ax = 0xFF;
	emu_si = emu_ax;
l__0282:
