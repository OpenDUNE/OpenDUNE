...
void f__1DD7_002A_002F_A13F()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x0065; emu_last_cs = 0x1DD7; emu_last_ip = 0x0030; emu_last_length = 0x002F; emu_last_crc = 0xA13F; emu_call(); return; } // Jump does not resolve
	...
	if (!emu_flags.zf) { emu_ip = 0x005B; emu_last_cs = 0x1DD7; emu_last_ip = 0x004D; emu_last_length = 0x002F; emu_last_crc = 0xA13F; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6302), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x0065; emu_last_cs = 0x1DD7; emu_last_ip = 0x0030; emu_last_length = 0x002E; emu_last_crc = 0x813E; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6310));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6312));
	if (emu_flags.zf) { f__1DD7_0065_0005_BBA6(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6312));
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x6), emu_dx.x);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x700A), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x005B; emu_last_cs = 0x1DD7; emu_last_ip = 0x004D; emu_last_length = 0x002E; emu_last_crc = 0x813E; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x1);
	emu_movw(&emu_bx.x, 0x10);
	emu_pushf();
...
void f__1DD7_008B_002F_916D()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x00C6; emu_last_cs = 0x1DD7; emu_last_ip = 0x0091; emu_last_length = 0x002F; emu_last_crc = 0x916D; emu_call(); return; } // Jump does not resolve
	...
	if (!emu_flags.zf) { emu_ip = 0x00BC; emu_last_cs = 0x1DD7; emu_last_ip = 0x00AE; emu_last_length = 0x002F; emu_last_crc = 0x916D; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6344), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x00C6; emu_last_cs = 0x1DD7; emu_last_ip = 0x0091; emu_last_length = 0x002E; emu_last_crc = 0xB16C; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6352));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6354));
	if (emu_flags.zf) { f__1DD7_00C6_0005_BBA6(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6354));
	...
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x6), emu_dx.x);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x700C), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x00BC; emu_last_cs = 0x1DD7; emu_last_ip = 0x00AE; emu_last_length = 0x002E; emu_last_crc = 0xB16C; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, 0x2);
	emu_movw(&emu_bx.x, 0x10);
	emu_pushf();
...
void f__1DD7_01B2_000E_58D9()
{
	...
	emu_push(emu_cs); emu_push(0x01C0); emu_cs = 0x2756; emu_ip = 0x1002; emu_last_cs = 0x1DD7; emu_last_ip = 0x01BB; emu_last_length = 0x000E; emu_last_crc = 0x58D9; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_01C1_0014_43A1()
{
	...
	emu_push(emu_cs); emu_push(0x01D5); emu_cs = 0x23E1; emu_ip = 0x0397; emu_last_cs = 0x1DD7; emu_last_ip = 0x01D0; emu_last_length = 0x0014; emu_last_crc = 0x43A1; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_01EB_0013_9C3C()
{
	...
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6374));
	emu_push(emu_cs); emu_push(0x01FE); emu_cs = 0x2756; emu_ip = 0x1034; emu_last_cs = 0x1DD7; emu_last_ip = 0x01F9; emu_last_length = 0x0013; emu_last_crc = 0x9C3C; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0248_0014_9236()
{
	...
	emu_ip = 0x0396; emu_last_cs = 0x1DD7; emu_last_ip = 0x0259; emu_last_length = 0x0014; emu_last_crc = 0x9236; emu_call(); // Jump does not resolve
}
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6374), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x0266; emu_last_cs = 0x1DD7; emu_last_ip = 0x0261; emu_last_length = 0x000A; emu_last_crc = 0x861E; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_048A_0017_3EEB()
{
	...
	emu_ip = 0x05CC; emu_last_cs = 0x1DD7; emu_last_ip = 0x049E; emu_last_length = 0x0017; emu_last_crc = 0x3EEB; emu_call(); // Jump does not resolve
}
...
void f__1DD7_04A1_000F_E416()
{
	...
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x04B0; emu_last_cs = 0x1DD7; emu_last_ip = 0x04AB; emu_last_length = 0x000F; emu_last_crc = 0xE416; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x05CC; emu_last_cs = 0x1DD7; emu_last_ip = 0x04AD; emu_last_length = 0x000F; emu_last_crc = 0xE416; emu_call(); // Jump does not resolve
}
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6302), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x04BA; emu_last_cs = 0x1DD7; emu_last_ip = 0x04B5; emu_last_length = 0x000A; emu_last_crc = 0x3012; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6302), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x05F8; emu_last_cs = 0x1DD7; emu_last_ip = 0x05EA; emu_last_length = 0x0014; emu_last_crc = 0xF82C; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6310));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6312));
	if (!emu_flags.zf) { emu_ip = 0x05F8; emu_last_cs = 0x1DD7; emu_last_ip = 0x05F3; emu_last_length = 0x0014; emu_last_crc = 0xF82C; emu_call(); return; } // Jump does not resolve
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6344), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x0741; emu_last_cs = 0x1DD7; emu_last_ip = 0x0733; emu_last_length = 0x0014; emu_last_crc = 0x9BBE; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6352));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6354));
	if (!emu_flags.zf) { emu_ip = 0x0741; emu_last_cs = 0x1DD7; emu_last_ip = 0x073C; emu_last_length = 0x0014; emu_last_crc = 0x9BBE; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_088A_0026_5144()
{
	...
	if (emu_flags.zf) { emu_ip = 0x08C0; emu_last_cs = 0x1DD7; emu_last_ip = 0x08A1; emu_last_length = 0x0026; emu_last_crc = 0x5144; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x636C));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6344));
	emu_push(emu_cs); emu_push(0x08B0); emu_cs = 0x2756; emu_ip = 0x176A; emu_last_cs = 0x1DD7; emu_last_ip = 0x08AB; emu_last_length = 0x0026; emu_last_crc = 0x5144; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0901_001E_8420()
{
	...
	emu_movw(&emu_di, emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_orw(&emu_si, emu_si);
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x091C; emu_last_cs = 0x1DD7; emu_last_ip = 0x090E; emu_last_length = 0x001E; emu_last_crc = 0x8420; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_si, 0x78);
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { emu_ip = 0x091C; emu_last_cs = 0x1DD7; emu_last_ip = 0x0913; emu_last_length = 0x001E; emu_last_crc = 0x8420; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x700C), 0x0);
	if (!emu_flags.zf) { f__1DD7_091F_000A_F6B7(); return; }
	emu_ip = 0x09D6; emu_last_cs = 0x1DD7; emu_last_ip = 0x091C; emu_last_length = 0x001E; emu_last_crc = 0x8420; emu_call(); // Jump does not resolve
}
...
{
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6344), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x0929; emu_last_cs = 0x1DD7; emu_last_ip = 0x0924; emu_last_length = 0x000A; emu_last_crc = 0xF6B7; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_09BE_0014_613D()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs);
	emu_push(0x09D2); emu_ip = 0x1C3C; emu_last_cs = 0x1DD7; emu_last_ip = 0x09CF; emu_last_length = 0x0014; emu_last_crc = 0x613D; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_09DA_000F_D404()
{
	...
	emu_ip = 0x0A39; emu_last_cs = 0x1DD7; emu_last_ip = 0x09E7; emu_last_length = 0x000F; emu_last_crc = 0xD404; emu_call(); // Jump does not resolve
}
...
void f__1DD7_0A40_001D_A972()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0A65; emu_last_cs = 0x1DD7; emu_last_ip = 0x0A4E; emu_last_length = 0x001D; emu_last_crc = 0xA972; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6372));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6344));
	emu_push(emu_cs); emu_push(0x0A5D); emu_cs = 0x2756; emu_ip = 0x1983; emu_last_cs = 0x1DD7; emu_last_ip = 0x0A58; emu_last_length = 0x001D; emu_last_crc = 0xA972; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0A7B_001E_4A5A()
{
	...
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x636C), 0xFF);
	if (emu_flags.zf) { emu_ip = 0x0AB0; emu_last_cs = 0x1DD7; emu_last_ip = 0x0A8A; emu_last_length = 0x001E; emu_last_crc = 0x4A5A; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x636C));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6344));
	emu_push(emu_cs); emu_push(0x0A99); emu_cs = 0x2756; emu_ip = 0x1947; emu_last_cs = 0x1DD7; emu_last_ip = 0x0A94; emu_last_length = 0x001E; emu_last_crc = 0x4A5A; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0AB2_0018_0CC6()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs);
	emu_push(0x0ACA); emu_ip = 0x1C3C; emu_last_cs = 0x1DD7; emu_last_ip = 0x0AC7; emu_last_length = 0x0018; emu_last_crc = 0x0CC6; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0B53_0025_36F7()
{
	...
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x636C), 0xFF);
	if (emu_flags.zf) { emu_ip = 0x0B7B; emu_last_cs = 0x1DD7; emu_last_ip = 0x0B62; emu_last_length = 0x0025; emu_last_crc = 0x36F7; emu_call(); return; } // Jump does not resolve
	...
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x636C));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6344));
	emu_push(emu_cs); emu_push(0x0B78); emu_cs = 0x2756; emu_ip = 0x1A44; emu_last_cs = 0x1DD7; emu_last_ip = 0x0B73; emu_last_length = 0x0025; emu_last_crc = 0x36F7; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0B7D_0019_AE96()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs);
	emu_push(0x0B96); emu_ip = 0x1C3C; emu_last_cs = 0x1DD7; emu_last_ip = 0x0B93; emu_last_length = 0x0019; emu_last_crc = 0xAE96; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0EE2_003D_B019()
{
	...
	emu_push(emu_cs);
	emu_push(0x0F1F); emu_ip = 0x12CE; emu_last_cs = 0x1DD7; emu_last_ip = 0x0F1C; emu_last_length = 0x003D; emu_last_crc = 0xB019; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_0F43_004A_CF07()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (!emu_flags.zf) { emu_ip = 0x0F8D; emu_last_cs = 0x1DD7; emu_last_ip = 0x0F88; emu_last_length = 0x004A; emu_last_crc = 0xCF07; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_102C_001E_4902()
{
	...
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x636C), 0xFF);
	if (emu_flags.zf) { emu_ip = 0x1061; emu_last_cs = 0x1DD7; emu_last_ip = 0x103B; emu_last_length = 0x001E; emu_last_crc = 0x4902; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x636C));
	emu_push(emu_get_memory16(emu_ds, 0x00,  0x6344));
	emu_push(emu_cs); emu_push(0x104A); emu_cs = 0x2756; emu_ip = 0x1EF8; emu_last_cs = 0x1DD7; emu_last_ip = 0x1045; emu_last_length = 0x001E; emu_last_crc = 0x4902; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_107C_003F_0D91()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x10BB; emu_last_cs = 0x1DD7; emu_last_ip = 0x1087; emu_last_length = 0x003F; emu_last_crc = 0x0D91; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x6310));
	if (!emu_flags.zf) { emu_ip = 0x10BB; emu_last_cs = 0x1DD7; emu_last_ip = 0x108D; emu_last_length = 0x003F; emu_last_crc = 0x0D91; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_10C9_004D_AF4E()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (!emu_flags.zf) { emu_ip = 0x1116; emu_last_cs = 0x1DD7; emu_last_ip = 0x1111; emu_last_length = 0x004D; emu_last_crc = 0xAF4E; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_11E8_000E_E72A()
{
	...
	emu_push(emu_si);
	emu_cmpws(&emu_get_memory16(emu_ds, 0x00,  0x6302), 0xFF);
	if (!emu_flags.zf) { emu_ip = 0x11F6; emu_last_cs = 0x1DD7; emu_last_ip = 0x11F1; emu_last_length = 0x000E; emu_last_crc = 0xE72A; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_1280_003F_C31F()
{
	...
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x6352));
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6312));
	if (!emu_flags.zf) { emu_ip = 0x12BF; emu_last_cs = 0x1DD7; emu_last_ip = 0x128B; emu_last_length = 0x003F; emu_last_crc = 0xC31F; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x6310));
	if (!emu_flags.zf) { emu_ip = 0x12BF; emu_last_cs = 0x1DD7; emu_last_ip = 0x1291; emu_last_length = 0x003F; emu_last_crc = 0xC31F; emu_call(); return; } // Jump does not resolve
...
void f__1DD7_1696_0011_A4E3()
{
	...
	emu_ip = 0x1778; emu_last_cs = 0x1DD7; emu_last_ip = 0x16A4; emu_last_length = 0x0011; emu_last_crc = 0xA4E3; emu_call(); // Jump does not resolve
}
...
void f__1DD7_16A7_0016_CA70()
{
	...
	emu_push(emu_cs); emu_push(0x16BD); emu_cs = 0x2756; emu_ip = 0x2206; emu_last_cs = 0x1DD7; emu_last_ip = 0x16B8; emu_last_length = 0x0016; emu_last_crc = 0xCA70; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__1DD7_16D4_0029_9C96()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x16FF; emu_last_cs = 0x1DD7; emu_last_ip = 0x16DB; emu_last_length = 0x0029; emu_last_crc = 0x9C96; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp,  0x6));
...
void f__1DD7_1C3C_0020_9C6E()
{
	...
	emu_ip = 0x1DE1; emu_last_cs = 0x1DD7; emu_last_ip = 0x1C59; emu_last_length = 0x0020; emu_last_crc = 0x9C6E; emu_call(); // Jump does not resolve
}
...
void f__1DD7_1C5C_000B_2475()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x1C67; emu_last_cs = 0x1DD7; emu_last_ip = 0x1C62; emu_last_length = 0x000B; emu_last_crc = 0x2475; emu_call(); return; } // Jump does not resolve
