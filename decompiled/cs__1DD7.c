...
void f__1DD7_002A_002F_A13F()
{
	...
	/* Unresolved jump */ emu_ip = 0x0059; emu_last_cs = 0x1DD7; emu_last_ip = 0x0056; emu_last_length = 0x002F; emu_last_crc = 0xA13F; emu_call();
}
...
void f__1DD7_008B_002F_916D()
{
	...
	/* Unresolved jump */ emu_ip = 0x00BA; emu_last_cs = 0x1DD7; emu_last_ip = 0x00B7; emu_last_length = 0x002F; emu_last_crc = 0x916D; emu_call();
}
...
void f__1DD7_04A1_000F_E416()
{
	...
	if ((emu_flags.zf || emu_flags.sf != emu_flags.of)) { /* Unresolved jump */ emu_ip = 0x04B0; emu_last_cs = 0x1DD7; emu_last_ip = 0x04AB; emu_last_length = 0x000F; emu_last_crc = 0xE416; emu_call(); return; }
	f__1DD7_05CC_0004_DE52(); return;
}
