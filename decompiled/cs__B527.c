...
l__0035:
	...
	emu_al = 0x57;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x004B); emu_cs = 0x2521; emu_Font_GetWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { overlay(0x3527, 1); }
l__004B:
	emu_pop(&emu_cx);
...
l__006E:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x007D); emu_cs = 0x2521; emu_Font_GetWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { overlay(0x3527, 1); }
l__007D:
	emu_pop(&emu_cx);
...
l__00CF:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x00E1); emu_GUI_EditBox_BlinkCursor();
l__00E1:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__0117:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x012B); emu_GUI_EditBox_BlinkCursor();
l__012B:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__0185:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x019A); emu_GUI_EditBox_BlinkCursor();
l__019A:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_al = emu_get_memory8(emu_es, emu_bx, 0x0);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x01A8); emu_cs = 0x2521; emu_Font_GetWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { overlay(0x3527, 1); }
l__01A8:
	emu_pop(&emu_cx);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x01BA); emu_GUI_EditBox_BlinkCursor();
l__01BA:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x6));
...
l__01F5:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x01FE); emu_cs = 0x2521; emu_Font_GetWidth();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { overlay(0x3527, 1); }
l__01FE:
	emu_pop(&emu_cx);
...
l__0228:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0236); emu_GUI_EditBox_BlinkCursor();
l__0236:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_ax = 0x20;
...
l__0261:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0273); emu_GUI_EditBox_BlinkCursor();
l__0273:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x6));
