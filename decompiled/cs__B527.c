...
void f__B527_0000_0016_BBD9()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0016); emu_cs = 0x29E8; f__29E8_04AF_003C_ECA0();
 ...
 *
 * Called From: B527:0016:0016:BBD9
 */
void f__B527_0016_000A_F6B9()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0020); emu_cs = 0x29E8; f__29E8_04EB_0011_9CC8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { ovl__3527(0xFF); }
 ...
 *
 * Called From: B527:0020:000A:F6B9
 */
 ...
 *
 * Called From: B527:0029:0009:E4DB
 */
 ...
 *
 * Called From: B527:0035:000C:7CE1
 */
 ...
 *
 * Called From: B527:004B:0016:DA67
 */
...
void f__B527_0081_0025_7FAE()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x008F; emu_last_cs = 0xB527; emu_last_ip = 0x0084; emu_last_length = 0x0025; emu_last_crc = 0x7FAE; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_cmpb(&emu_get_memory8(emu_es, emu_bx.x,  0x0), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x006E; emu_last_cs = 0xB527; emu_last_ip = 0x008D; emu_last_length = 0x0025; emu_last_crc = 0x7FAE; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
 ...
 *
 * Called From: B527:00A6:0025:7FAE
 * Called From: B527:00A6:0005:6168
 */
 ...
 * Called From: B527:00B2:000C:6949
 */
 ...
 *
 * Called From: B527:00CF:001D:E367
 */
 ...
 *
 * Called From: B527:00E1:0012:9D7B
 */
 ...
 *
 * Called From: B527:00E8:0007:E5DE
 */
 ...
 *
 * Called From: B527:00FB:000B:FF42
 */
void f__B527_00FB_0011_1AD6()
{
	...
	emu_ip = 0x0281; emu_last_cs = 0xB527; emu_last_ip = 0x0109; emu_last_length = 0x0011; emu_last_crc = 0x1AD6; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B527:0117:000B:0481
 */
 ...
 *
 * Called From: B527:012B:0014:47BE
 */
...
void f__B527_0142_001B_D66A()
{
	...
	if (--emu_cx.x != 0) { f__B527_014E_000F_5E6F(); return; }
	emu_ip = 0x01C7; emu_last_cs = 0xB527; emu_last_ip = 0x015B; emu_last_length = 0x001B; emu_last_crc = 0xD66A; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B527:01CF:0008:8702
 */
void f__B527_01CF_0014_5990()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x01E3; emu_last_cs = 0xB527; emu_last_ip = 0x01DE; emu_last_length = 0x0014; emu_last_crc = 0x5990; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x027F; emu_last_cs = 0xB527; emu_last_ip = 0x01E0; emu_last_length = 0x0014; emu_last_crc = 0x5990; emu_call(); // Jump does not resolve
}
 ...
 *
 * Called From: B527:01FE:0009:A1E0
 */
void f__B527_01FE_002A_3E48()
{
	...
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x027F; emu_last_cs = 0xB527; emu_last_ip = 0x020A; emu_last_length = 0x002A; emu_last_crc = 0x3E48; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_di, emu_get_memory16(emu_ss, emu_bp,  0xA));
	if (!(emu_flags.sf != emu_flags.of)) { emu_ip = 0x027F; emu_last_cs = 0xB527; emu_last_ip = 0x020F; emu_last_length = 0x002A; emu_last_crc = 0x3E48; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_movb(&emu_ax.l, emu_get_memory8(emu_ss, emu_bp, -0x2));
 ...
 *
 * Called From: B527:0228:002A:3E48
 */
 ...
 *
 * Called From: B527:0236:000E:8F05
 */
 ...
 *
 * Called From: B527:0259:0023:ABEA
 */
 ...
 *
 * Called From: B527:0261:0008:3BE5
 */
 ...
 *
 * Called From: B527:0273:0012:440D
 */
...
void f__B527_028A_0009_E2B9()
{
	emu_movw(&emu_ax.x, 0x2);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x0293); emu_cs = 0x29E8; f__29E8_04EB_0011_9CC8();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { ovl__3527(0xFF); }
 ...
 *
 * Called From: B527:0293:0009:E2B9
 */
void f__B527_0293_000A_B6BD()
{
	...
	emu_movw(&emu_ax.x, 0x2000);
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x029D); emu_cs = 0x29E8; f__29E8_04AF_003C_ECA0();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3527) { ovl__3527(0xFF); }
 ...
 *
 * Called From: B527:029D:000A:B6BD
 */
 ...
 *
 * Called From: B527:02A6:0009:18B8
 */
 ...
 *
 * Called From: B527:02AF:0009:D1B5
 */
...
void f__B527_02CB_005E_FFA4()
{
	...
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0367; emu_last_cs = 0xB527; emu_last_ip = 0x02F7; emu_last_length = 0x005E; emu_last_crc = 0xFFA4; emu_call(); return; } // Jump does not resolve
	if (!emu_flags.zf) { emu_ip = 0x0301; emu_last_cs = 0xB527; emu_last_ip = 0x02F9; emu_last_length = 0x005E; emu_last_crc = 0xFFA4; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x76AC));
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0367; emu_last_cs = 0xB527; emu_last_ip = 0x02FF; emu_last_length = 0x005E; emu_last_crc = 0xFFA4; emu_call(); return; } // Jump does not resolve
	...
	emu_push(emu_cs); emu_push(0x0329); emu_cs = 0x2B6C; emu_ip = 0x0460; emu_last_cs = 0xB527; emu_last_ip = 0x0324; emu_last_length = 0x005E; emu_last_crc = 0xFFA4; emu_call(); // Jump does not resolve
...
void f__B527_02EC_003D_CE40()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x0301; emu_last_cs = 0xB527; emu_last_ip = 0x02F9; emu_last_length = 0x003D; emu_last_crc = 0xCE40; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x76AC));
	if (!(emu_flags.cf || emu_flags.zf)) { f__B527_0367_0004_DE52(); return; }
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x2C62));
	emu_negw(&emu_ax.x, emu_ax.x);
	...
	emu_movw(&emu_get_memory16(emu_ds, 0x00,  0x2C62), emu_ax.x);
	emu_orw(&emu_di, emu_di);
	if (emu_flags.zf) { emu_ip = 0x0324; emu_last_cs = 0xB527; emu_last_ip = 0x030E; emu_last_length = 0x003D; emu_last_crc = 0xCE40; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x76AE));
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x76AC));
	emu_addws(&emu_dx.x, 0x14);
	emu_adcw(&emu_ax.x, 0x0);
 ...
 *
 * Called From: B527:0329:003D:CE40
 * Called From: B527:0329:0005:6168
 */
 ...
 *
 * Called From: B527:034A:0015:ADC3
 * Called From: B527:034A:0012:356E
 */
 ...
 *
 * Called From: B527:035F:0015:34F5
 */
 ...
 * Called From: B527:0367:0008:2BE5
 */
