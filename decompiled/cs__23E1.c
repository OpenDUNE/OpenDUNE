...
void f__23E1_0018_001C_B654()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0040; emu_last_cs = 0x23E1; emu_last_ip = 0x0024; emu_last_length = 0x001C; emu_last_crc = 0xB654; emu_call(); return; } // Jump does not resolve
...
void f__23E1_001F_0015_7A84()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x0034); emu_cs = 0x2649; emu_ip = 0x0336; emu_last_cs = 0x23E1; emu_last_ip = 0x002F; emu_last_length = 0x0015; emu_last_crc = 0x7A84; emu_call(); // Jump does not resolve
	f__23E1_0034_000C_E591();
}
...
void f__23E1_0071_001F_EC67()
{
	...
	if (emu_flags.zf) { emu_ip = 0x0064; emu_last_cs = 0x23E1; emu_last_ip = 0x007B; emu_last_length = 0x001F; emu_last_crc = 0xEC67; emu_call(); return; } // Jump does not resolve
	...
	if (!emu_flags.zf) { emu_ip = 0x0090; emu_last_cs = 0x23E1; emu_last_ip = 0x008C; emu_last_length = 0x001F; emu_last_crc = 0xEC67; emu_call(); return; } // Jump does not resolve
	emu_ip = 0x009C; emu_last_cs = 0x23E1; emu_last_ip = 0x008E; emu_last_length = 0x001F; emu_last_crc = 0xEC67; emu_call(); // Jump does not resolve
}
...
void f__23E1_009C_000F_1B49()
{
	...
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_ip = 0x01BE; emu_last_cs = 0x23E1; emu_last_ip = 0x00A8; emu_last_length = 0x000F; emu_last_crc = 0x1B49; emu_call(); // Jump does not resolve
}
...
void f__23E1_0118_003B_3097()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x0142; emu_last_cs = 0x23E1; emu_last_ip = 0x0139; emu_last_length = 0x003B; emu_last_crc = 0x3097; emu_call(); return; } // Jump does not resolve
...
void f__23E1_012D_0026_6C1D()
{
	...
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp, -0x6), 0x0);
	if (!(emu_flags.cf || emu_flags.zf)) { f__23E1_0106_0012_D6D9(); return; }
	if (!emu_flags.zf) { emu_ip = 0x0142; emu_last_cs = 0x23E1; emu_last_ip = 0x0139; emu_last_length = 0x0026; emu_last_crc = 0x6C1D; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_get_memory16(emu_ss, emu_bp, -0x8), 0x7D00);
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0106; emu_last_cs = 0x23E1; emu_last_ip = 0x0140; emu_last_length = 0x0026; emu_last_crc = 0x6C1D; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_push(emu_ax.x);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xE));
...
void f__23E1_015B_0063_2E46()
{
	...
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0182; emu_last_cs = 0x23E1; emu_last_ip = 0x016B; emu_last_length = 0x0063; emu_last_crc = 0x2E46; emu_call(); return; } // Jump does not resolve
	...
	if (emu_flags.cf) { emu_ip = 0x01B1; emu_last_cs = 0x23E1; emu_last_ip = 0x0193; emu_last_length = 0x0063; emu_last_crc = 0x2E46; emu_call(); return; } // Jump does not resolve
	if (!(emu_flags.cf || emu_flags.zf)) { f__23E1_019D_0021_7B82(); return; }
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x66F4));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x01B1; emu_last_cs = 0x23E1; emu_last_ip = 0x019B; emu_last_length = 0x0063; emu_last_crc = 0x2E46; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x66FA));
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x66F8));
	emu_subw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0xC));
	emu_sbbw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0xA));
...
void f__23E1_0175_0049_9AC9()
{
	...
	emu_sbbw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_cmpw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x66F6));
	if (emu_flags.cf) { emu_ip = 0x01B1; emu_last_cs = 0x23E1; emu_last_ip = 0x0193; emu_last_length = 0x0049; emu_last_crc = 0x9AC9; emu_call(); return; } // Jump does not resolve
	if (!(emu_flags.cf || emu_flags.zf)) { f__23E1_019D_0021_7B82(); return; }
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x66F4));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x01B1; emu_last_cs = 0x23E1; emu_last_ip = 0x019B; emu_last_length = 0x0049; emu_last_crc = 0x9AC9; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x66FA));
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x66F8));
	emu_subw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0xC));
	emu_sbbw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0xA));
...
void f__23E1_0182_003C_8BCB()
{
	...
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x019D; emu_last_cs = 0x23E1; emu_last_ip = 0x0195; emu_last_length = 0x003C; emu_last_crc = 0x8BCB; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ds, 0x00,  0x66F4));
	...
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_ip = 0x00A8; emu_last_cs = 0x23E1; emu_last_ip = 0x01BB; emu_last_length = 0x003C; emu_last_crc = 0x8BCB; emu_call(); // Jump does not resolve
}
...
void f__23E1_01DE_0011_2432()
{
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x01EF); emu_cs = 0x2649; emu_ip = 0x05DF; emu_last_cs = 0x23E1; emu_last_ip = 0x01EA; emu_last_length = 0x0011; emu_last_crc = 0x2432; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
{
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp,  0x6), 0x0);
	if (emu_flags.zf) { emu_ip = 0x023B; emu_last_cs = 0x23E1; emu_last_ip = 0x0230; emu_last_length = 0x000F; emu_last_crc = 0xC150; emu_call(); return; } // Jump does not resolve
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_decw(&emu_ax.x);
...
void f__23E1_033F_000A_E287()
{
	...
	emu_push(emu_cs); emu_push(0x0349); emu_cs = 0x3500; emu_ip = 0x0020; emu_last_cs = 0x23E1; emu_last_ip = 0x0344; emu_last_length = 0x000A; emu_last_crc = 0xE287; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
...
void f__23E1_037E_002E_5E5E()
{
	...
	if (!(emu_flags.cf || emu_flags.zf)) { emu_ip = 0x0396; emu_last_cs = 0x23E1; emu_last_ip = 0x038F; emu_last_length = 0x002E; emu_last_crc = 0x5E5E; emu_call(); return; } // Jump does not resolve
	emu_cmpw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x03A2; emu_last_cs = 0x23E1; emu_last_ip = 0x0394; emu_last_length = 0x002E; emu_last_crc = 0x5E5E; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0xA));
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x2), emu_ax.x);
	emu_movw(&emu_get_memory16(emu_ss, emu_bp, -0x4), emu_dx.x);
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x03AC); emu_cs = 0x01F7; emu_ip = 0x1DE5; emu_last_cs = 0x23E1; emu_last_ip = 0x03A7; emu_last_length = 0x002E; emu_last_crc = 0x5E5E; emu_call(); // Jump does not resolve
...
void f__23E1_03AC_0025_E1A5()
{
	...
	if ((emu_flags.sf != emu_flags.of)) { emu_ip = 0x03D1; emu_last_cs = 0x23E1; emu_last_ip = 0x03BF; emu_last_length = 0x0025; emu_last_crc = 0xE1A5; emu_call(); return; } // Jump does not resolve
	if (!(emu_flags.zf || emu_flags.sf != emu_flags.of)) { f__23E1_03C9_0008_CA49(); return; }
	emu_cmpws(&emu_get_memory16(emu_ss, emu_bp, -0x4), 0x0);
	if ((emu_flags.cf || emu_flags.zf)) { emu_ip = 0x03D1; emu_last_cs = 0x23E1; emu_last_ip = 0x03C7; emu_last_length = 0x0025; emu_last_crc = 0xE1A5; emu_call(); return; } // Jump does not resolve
	emu_movw(&emu_dx.x, emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_ip = 0x03D5; emu_last_cs = 0x23E1; emu_last_ip = 0x03CF; emu_last_length = 0x0025; emu_last_crc = 0xE1A5; emu_call(); // Jump does not resolve
}
...
void f__23E1_03E6_000E_32CC()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_cs); emu_push(0x03F4); emu_cs = 0x263B; emu_ip = 0x002F; emu_last_cs = 0x23E1; emu_last_ip = 0x03EF; emu_last_length = 0x000E; emu_last_crc = 0x32CC; emu_call(); // Jump does not resolve
	emu_unknown_call();
}
