...
l__0013:
	...
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x002A); emu_cs = 0x1FB5; emu_File_ReadBlock();
l__002A:
	emu_addw(&emu_sp, 0xA);
...
l__00C0:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x00E3); emu_cs = 0x1FB5; emu_File_ReadBlock();
l__00E3:
	emu_addw(&emu_sp, 0xA);
	emu_push(emu_si);
...
l__00FA:
	...
	emu_push(emu_di);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs); emu_push(0x010A); emu_cs = 0x252E; emu_Unknown_252E_0001();
l__010A:
	emu_pop(&emu_cx);
...
l__0120:
	...
	emu_push(emu_ax);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0137); emu_cs = 0x1FB5; emu_File_ReadBlock();
l__0137:
	emu_addw(&emu_sp, 0xA);
	emu_xorw(&emu_ax, emu_ax);
	emu_dx = 0x8;
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x014D); emu_cs = 0x1FB5; emu_File_ReadBlock();
l__014D:
	emu_addw(&emu_sp, 0xA);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xE));
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x0177); emu_cs = 0x1FB5; emu_File_ReadBlock();
l__0177:
	emu_addw(&emu_sp, 0xA);
	goto l__018D;
l__017C:
...
l__01F6:
	...
	emu_push(emu_ax);
	emu_push(emu_si);
	emu_push(emu_cs); emu_push(0x020F); emu_cs = 0x1FB5; emu_File_ReadBlock();
l__020F:
	emu_addw(&emu_sp, 0xA);
	emu_push(emu_si);
...
l__0218:
	emu_pop(&emu_cx);
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xC));
	emu_push(emu_cs); emu_push(0x0221); emu_cs = 0x252E; emu_Unknown_252E_0001();
l__0221:
	emu_pop(&emu_cx);
	emu_push(emu_dx);
	emu_push(emu_ax);
