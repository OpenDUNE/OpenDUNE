...
l__082E:
	...
	emu_ax = 0x183F;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x084D); emu_cs = 0x34CA; overlay(0x34CA, 0); emu_Sprites_LoadImage();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__084D:
	emu_addw(&emu_sp, 0xE);
...
l__0891:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x089C); emu_cs = 0x3483; overlay(0x3483, 0); emu_Music_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__089C:
	emu_pop(&emu_cx);
...
l__08A2:
	emu_ax = 0x21;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x08AB); emu_cs = 0x3483; overlay(0x3483, 0); emu_Music_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__08AB:
	emu_pop(&emu_cx);
...
l__090B:
	...
	emu_ax = 0x184B;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0930); emu_cs = 0x34CA; overlay(0x34CA, 0); emu_Sprites_LoadImage();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__0930:
	emu_addw(&emu_sp, 0xE);
...
l__09E7:
	emu_ax = 0x21;
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x09F0); emu_cs = 0x3483; overlay(0x3483, 0); emu_Music_Play();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__09F0:
	emu_pop(&emu_cx);
