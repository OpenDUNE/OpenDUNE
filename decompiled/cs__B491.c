...
l__0082:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0185); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__0185:
...
l__01C2:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x01CD); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__01CD:
	emu_pop(&emu_cx);
...
l__05E9:
	...
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x992B));
	emu_push(emu_get_memory16(emu_ds, 0x00, 0x992D));
	emu_push(emu_cs); emu_push(0x060C); emu_cs = 0x24D0; emu_GUI_Unknown_24D0_000D();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__060C:
	emu_addw(&emu_sp, 0x10);
...
l__0617:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xE));
	emu_push(emu_cs); emu_push(0x066B); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__066B:
	emu_pop(&emu_cx);
...
l__06D0:
	...
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x06DB); emu_cs = 0x2598; emu_Unknown_Set_Global_6C91();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__06DB:
	emu_pop(&emu_cx);
...
l__07CC:
	...
	emu_push(emu_cs); emu_push(0x07DD); emu_cs = 0x259E; emu_Unknown_259E_0006();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x3491) { overlay(0x3491, 1); }
l__07DD:
	emu_addw(&emu_sp, 0x6);
