...
l__0044:
	emu_cmpw(&emu_si, 0xE);
	if ((emu_flags.sf != emu_flags.of)) goto l__0015;
...
l__0089:
	emu_cmpw(&emu_si, 0x6);
	if ((emu_flags.sf != emu_flags.of)) goto l__0061;
	goto l__008E;
l__008E:
	emu_movw(&emu_ax, 0xFFFF);
	goto l__0086;
...
l__00C3:
	emu_cmpw(&emu_si, 0x6);
	if ((emu_flags.sf != emu_flags.of)) goto l__009E;
	emu_movw(&emu_ax, 0xFFFF);
	goto l__00C0;
l__00CD:
	emu_pop(&emu_si);
...
l__00FD:
	emu_cmpw(&emu_si, 0x5);
	if ((emu_flags.sf != emu_flags.of)) goto l__00D8;
	emu_movw(&emu_ax, 0xFFFF);
