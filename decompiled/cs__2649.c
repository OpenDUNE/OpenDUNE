 ...
 */
void emu_Highmem_Internal_0003()
{
l__0003:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
l__0017:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_cs); emu_push(0x001F); emu_cs = 0x2BF2; emu_XMS_Init();
l__001F:
...
l__0029:
	emu_xorw(&emu_ax, emu_ax);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0031); emu_cs = 0x2BF2; emu_XMS_GetFreeMemory();
l__0031:
	emu_pop(&emu_cx);
	emu_xorw(&emu_dx, emu_dx);
	emu_cl = 0xA;
...
l__0053:
	...
	emu_push(emu_cs);
	emu_push(0x0070); emu_Highmem_Internal_0003();
l__0070:
	emu_orw(&emu_ax, emu_dx);
	if (emu_ax != 0) goto l__0079;
l__0074:
...
l__0146:
	...
	emu_push(emu_cs); emu_push(0x0154); emu_cs = 0x2BF2; emu_XMS_Allocate();
l__0154:
	emu_pop(&emu_cx);
...
l__018C:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0211); emu_Highmem_Internal_0EBE();
l__0211:
	emu_addw(&emu_sp, 0x8);
l__0214:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x8);
...
l__021F:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x02AC); emu_Highmem_Internal_0EBE();
l__02AC:
	emu_addw(&emu_sp, 0x8);
l__02AF:
	emu_ax = 0x1;
...
l__03B1:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x03C1); emu_Highmem_Internal_0EFC();
l__03C1:
	emu_addw(&emu_sp, 0x8);
...
l__0453:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0463); emu_Highmem_Internal_0EFC();
l__0463:
	emu_sp += 8;
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x16);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x18);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0482); emu_Highmem_Internal_0EBE();
l__0482:
	emu_sp += 8;
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0495); emu_Highmem_Internal_0EFC();
l__0495:
	emu_sp += 8;
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x12);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x14);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x04B4); emu_Highmem_Internal_0EBE();
l__04B4:
	emu_sp += 8;
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x16);
...
l__04C8:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x04E2); emu_Highmem_Internal_0EBE();
l__04E2:
	emu_sp += 8;
	goto l__05C0;
l__04E8:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x050A); emu_Highmem_Internal_0EBE();
l__050A:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0x8);
	emu_dx = emu_get_memory16(emu_ss, emu_bp,  0x6);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0551); emu_Highmem_Internal_0EBE();
l__0551:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0xA);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0xC);
...
l__058E:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x059E); emu_Highmem_Internal_0EFC();
l__059E:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0xA);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0xC);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x05BD); emu_Highmem_Internal_0EBE();
l__05BD:
	emu_addw(&emu_sp, 0x8);
l__05C0:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0xA);
	...
	emu_push(emu_si);
	emu_push(emu_cs);
	emu_push(0x05D4); emu_Highmem_Internal_0F3A();
l__05D4:
	emu_addw(&emu_sp, 0x6);
	goto l__037F;
l__05DA:
...
l__05DF:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x05F0); emu_Highmem_IsInHighmem();
l__05F0:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
...
l__05F9:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0604); emu_Highmem_Internal_0B26();
l__0604:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x061D); emu_Highmem_Internal_0F72();
l__061D:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_dx = 0xE;
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x063D); emu_Highmem_Internal_0EFC();
l__063D:
	emu_addw(&emu_sp, 0x8);
...
l__0667:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0677); emu_Highmem_Internal_0EFC();
l__0677:
	emu_addw(&emu_sp, 0x8);
l__067A:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
...
l__06D4:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x06E4); emu_Highmem_Internal_0EFC();
l__06E4:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0xA);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0xC);
...
l__0721:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0731); emu_Highmem_Internal_0EFC();
l__0731:
	emu_addw(&emu_sp, 0x8);
	goto l__0740;
l__0736:
...
l__079B:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x07BC); emu_Highmem_Internal_0EFC();
l__07BC:
	emu_addw(&emu_sp, 0x8);
...
l__0804:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0814); emu_Highmem_Internal_0EBE();
l__0814:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x12));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x14));
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0827); emu_Highmem_Internal_0EFC();
l__0827:
	emu_addw(&emu_sp, 0x8);
l__082A:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0846); emu_Highmem_Internal_0EBE();
l__0846:
	emu_addw(&emu_sp, 0x8);
l__0849:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0859); emu_Highmem_Internal_0EBE();
l__0859:
	emu_addw(&emu_sp, 0x8);
	goto l__0AD6;
l__085F:
...
l__08A7:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x08CF); emu_Highmem_Internal_0EFC();
l__08CF:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x8);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x08EE); emu_Highmem_Internal_0EBE();
l__08EE:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x12));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x14));
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0901); emu_Highmem_Internal_0EFC();
l__0901:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x6);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x8);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0920); emu_Highmem_Internal_0EBE();
l__0920:
	emu_addw(&emu_sp, 0x8);
l__0923:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0933); emu_Highmem_Internal_0EBE();
l__0933:
	emu_addw(&emu_sp, 0x8);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_ax = emu_get_memory16(emu_es, emu_bx, 0xC);
...
l__0968:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0984); emu_Highmem_Internal_0EBE();
l__0984:
	emu_addw(&emu_sp, 0x8);
l__0987:
	goto l__0AD6;
...
l__09A2:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x09BE); emu_Highmem_Internal_0EBE();
l__09BE:
	emu_sp += 8;
l__09C1:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x1E);
...
l__09E0:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0A08); emu_Highmem_Internal_0EBE();
l__0A08:
	emu_addw(&emu_sp, 0x8);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_ax = emu_get_memory16(emu_es, emu_bx, 0xC);
...
l__0A3D:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0A59); emu_Highmem_Internal_0EBE();
l__0A59:
	emu_addw(&emu_sp, 0x8);
l__0A5C:
	emu_ax = 0x10;
...
l__0A6F:
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0A82); emu_Highmem_Internal_0EFC();
l__0A82:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x16);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x18);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0AA1); emu_Highmem_Internal_0EBE();
l__0AA1:
	emu_addw(&emu_sp, 0x8);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x16));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x18));
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0AB4); emu_Highmem_Internal_0EFC();
l__0AB4:
	emu_addw(&emu_sp, 0x8);
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x12);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x14);
...
l__0ACD:
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0AD3); emu_Highmem_Internal_0EBE();
l__0AD3:
	emu_addw(&emu_sp, 0x8);
l__0AD6:
	emu_sp = emu_bp;
...
l__0AE8:
	...
	emu_push(emu_cs); emu_push(0x0AF8); emu_cs = 0x2BF2; emu_XMS_Free();
l__0AF8:
	emu_pop(&emu_cx);
l__0AF9:
	emu_get_memory16(emu_ds, 0x00, 0x6E40) = 0x0;
 ...
 */
void emu_Highmem_Internal_0B07()
{
l__0B07:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0B15); emu_Highmem_Internal_0F72();
l__0B15:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_dx = 0xE;
 ...
 */
void emu_Highmem_Internal_0B26()
{
l__0B26:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0B37); emu_Highmem_Internal_0F72();
l__0B37:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_dx = 0xE;
...
l__0B64:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0B75); emu_Highmem_IsInHighmem();
l__0B75:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_orw(&emu_ax, emu_ax);
...
l__0B81:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0B8B); emu_Highmem_Internal_0B26();
l__0B8B:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_subw(&emu_ax, 0x10);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0B9F); emu_Highmem_Internal_0EFC();
l__0B9F:
	emu_addw(&emu_sp, 0x8);
...
static void emu_Highmem_Internal_0E96()
{
	emu_push(emu_bp);
	emu_bp = emu_sp;
	emu_dx = emu_get_memory16(emu_ss, emu_bp,  0xC);
 ...
 */
void emu_Highmem_Memmove_ToHighmem()
{
l__0C09:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
l__0C22:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs);
	emu_push(0x0C34); emu_Highmem_Internal_0B26();
l__0C34:
	emu_sp += 4;
	emu_andw(&emu_ax, 0x1);
	emu_andw(&emu_dx, 0x0);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0C59); emu_Highmem_Memmove_FromHighmem();
l__0C59:
	emu_sp += 12;
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0C7D); emu_Highmem_Memmove_ToHighmem();
l__0C7D:
	emu_sp += 12;
...
l__0C8D:
	...
	emu_push(emu_dx);
	emu_push(emu_cs);
	emu_push(0x0CAC); emu_Highmem_Memmove_FromHighmem();
l__0CAC:
	emu_sp += 12;
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x10));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xE));
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0CC0); emu_Highmem_Internal_0E96();
l__0CC0:
	emu_sp += 8;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0CF0); emu_Highmem_Memmove_ToHighmem();
l__0CF0:
	emu_sp += 12;
l__0CF3:
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0x10);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs);
	emu_push(0x0D1D); emu_Highmem_Internal_0B07();
l__0D1D:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs);
	emu_push(0x0D2C); emu_Highmem_Internal_0B26();
l__0D2C:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	emu_get_memory16(emu_ds, 0x00, 0x9A4C) = emu_dx;
	emu_get_memory16(emu_ds, 0x00, 0x9A4A) = emu_ax;
	emu_push(emu_cs); emu_push(0x0D3A); emu_cs = 0x2BF2; emu_XMS_MoveToMemory();
l__0D3A:
	goto l__0D3C;
l__0D3C:
	emu_sp = emu_bp;
 ...
 */
void emu_Highmem_Memmove_FromHighmem()
{
l__0D40:
	emu_push(emu_bp);
	emu_bp = emu_sp;
...
l__0D59:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0D6B); emu_Highmem_Internal_0B26();
l__0D6B:
	emu_sp += 4;
	emu_andw(&emu_ax, 0x1);
	emu_andw(&emu_dx, 0x0);
	...
	emu_push(emu_ax);
	emu_push(emu_cs);
	emu_push(0x0D8F); emu_Highmem_Memmove_FromHighmem();
l__0D8F:
	emu_sp += 12;
...
l__0DA8:
	...
	emu_push(emu_dx);
	emu_push(emu_cs);
	emu_push(0x0DC6); emu_Highmem_Memmove_FromHighmem();
l__0DC6:
	emu_sp += 12;
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x10));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xE));
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs);
	emu_push(0x0DDA); emu_Highmem_Internal_0E96();
l__0DDA:
	emu_sp += 8;
	emu_get_memory16(emu_ss, emu_bp, -0x4) = emu_dx;
	emu_get_memory16(emu_ss, emu_bp, -0x6) = emu_ax;
...
l__0DEC:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0E03); emu_Highmem_Internal_0B07();
l__0E03:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs);
	emu_push(0x0E12); emu_Highmem_Internal_0B26();
l__0E12:
	emu_pop(&emu_cx);
	emu_pop(&emu_cx);
	...
	emu_push(emu_cs); emu_push(0x0E33); emu_cs = 0x2BF2; emu_XMS_MoveToMemory();
l__0E33:
	goto l__0E35;
l__0E35:
	emu_sp = emu_bp;
 ...
 */
void emu_Highmem_Internal_0EBE()
{
l__0EBE:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	emu_get_memory16(emu_ds, 0x00, 0x9A4C) = emu_ax;
	emu_get_memory16(emu_ds, 0x00, 0x9A4A) = emu_dx;
	emu_push(emu_cs); emu_push(0x0EF8); emu_cs = 0x2BF2; emu_XMS_MoveToMemory();
l__0EF8:
	goto l__0EFA;
l__0EFA:
	emu_pop(&emu_bp);
 ...
 */
void emu_Highmem_Internal_0EFC()
{
l__0EFC:
	emu_push(emu_bp);
	emu_bp = emu_sp;
	...
	emu_get_memory16(emu_ds, 0x00, 0x9A4C) = emu_ax;
	emu_get_memory16(emu_ds, 0x00, 0x9A4A) = emu_dx;
	emu_push(emu_cs); emu_push(0x0F36); emu_cs = 0x2BF2; emu_XMS_MoveToMemory();
l__0F36:
	goto l__0F38;
l__0F38:
	emu_pop(&emu_bp);
 ...
 */
void emu_Highmem_Internal_0F3A()
{
l__0F3A:
	emu_push(emu_bp);
	emu_bp = emu_sp;
 ...
 */
void emu_Highmem_Internal_0F72()
{
l__0F72:
	emu_push(emu_bp);
	emu_bp = emu_sp;
