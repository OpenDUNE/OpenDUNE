 ...
 *
 * Called From: 2649:0017:0014:67A9
 */
 ...
 *
 * Called From: 2649:001F:0008:33E4
 */
void f__2649_001F_000A_4104()
{
	emu_orw(&emu_ax.x, emu_dx.x);
	if (!emu_flags.zf) { emu_ip = 0x0029; emu_last_cs = 0x2649; emu_last_ip = 0x0021; emu_last_length = 0x000A; emu_last_crc = 0x4104; emu_call(); return; } // Jump does not resolve
...
void f__2649_0053_001D_FEB5()
{
	...
	if (!emu_flags.zf) { emu_ip = 0x0079; emu_last_cs = 0x2649; emu_last_ip = 0x006A; emu_last_length = 0x001D; emu_last_crc = 0xFEB5; emu_call(); return; } // Jump does not resolve
	emu_push(emu_cs);
 ...
 *
 * Called From: 2649:0070:001D:FEB5
 */
void f__2649_0070_0009_4B54()
{
	emu_orw(&emu_ax.x, emu_dx.x);
	if (!emu_flags.zf) { emu_ip = 0x0079; emu_last_cs = 0x2649; emu_last_ip = 0x0072; emu_last_length = 0x0009; emu_last_crc = 0x4B54; emu_call(); return; } // Jump does not resolve
	emu_xorw(&emu_ax.x, emu_ax.x);
...
void f__2649_0336_004C_0948()
{
	...
	if (emu_flags.zf) { emu_ip = 0x037B; emu_last_cs = 0x2649; emu_last_ip = 0x035F; emu_last_length = 0x004C; emu_last_crc = 0x0948; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpws(&emu_get_memory16(emu_es, emu_bx.x,  0x0), 0x0);
	if (emu_flags.zf) { emu_ip = 0x037B; emu_last_cs = 0x2649; emu_last_ip = 0x0368; emu_last_length = 0x004C; emu_last_crc = 0x0948; emu_call(); return; } // Jump does not resolve
	emu_lfp(&emu_es, &emu_bx.x, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpws(&emu_get_memory16(emu_es, emu_bx.x,  0xC), 0x0);
	if (!emu_flags.zf) { emu_ip = 0x0382; emu_last_cs = 0x2649; emu_last_ip = 0x0372; emu_last_length = 0x004C; emu_last_crc = 0x0948; emu_call(); return; } // Jump does not resolve
	emu_cmpws(&emu_get_memory16(emu_es, emu_bx.x,  0xA), 0x1);
	if (!emu_flags.zf) { emu_ip = 0x0382; emu_last_cs = 0x2649; emu_last_ip = 0x0379; emu_last_length = 0x004C; emu_last_crc = 0x0948; emu_call(); return; } // Jump does not resolve
	emu_xorw(&emu_dx.x, emu_dx.x);
	emu_xorw(&emu_ax.x, emu_ax.x);
	emu_ip = 0x05DA; emu_last_cs = 0x2649; emu_last_ip = 0x037F; emu_last_length = 0x004C; emu_last_crc = 0x0948; emu_call(); // Jump does not resolve
}
...
void f__2649_0ADA_000E_EEB3()
{
	...
	emu_movw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6E3E));
	emu_orw(&emu_ax.x, emu_get_memory16(emu_ds, 0x00,  0x6E40));
	if (!emu_flags.zf) { emu_ip = 0x0AE8; emu_last_cs = 0x2649; emu_last_ip = 0x0AE4; emu_last_length = 0x000E; emu_last_crc = 0xEEB3; emu_call(); return; } // Jump does not resolve
...
void f__2649_0BAE_001D_25B1()
{
	...
	if (!emu_flags.cf) { emu_ip = 0x0BCB; emu_last_cs = 0x2649; emu_last_ip = 0x0BC5; emu_last_length = 0x001D; emu_last_crc = 0x25B1; emu_call(); return; } // Jump does not resolve
	emu_xorw(&emu_ax.x, emu_ax.x);
