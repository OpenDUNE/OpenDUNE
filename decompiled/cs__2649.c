...
l__0BAE:
	...
	if (emu_get_memory16(emu_ss, emu_bp, -0x2) >= 0xF000) { /* Unresolved jump */ emu_ip = 0x0BCB; emu_last_cs = 0x2649; emu_last_ip = 0x0BC5; emu_last_length = 0x001D; emu_last_crc = 0x25B1; emu_call(); return; }
	emu_xorw(&emu_ax, emu_ax);
	goto l__0C05;
l__0C05:
	emu_sp = emu_bp;
