...
/**
 * Decompiled function emu_Ini_GetInteger()
 *
...
l__0000:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0018); emu_cs = 0x01F7; emu_String_sprintf();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0018:
	emu_addw(&emu_sp, 0xA);
	...
	emu_push(emu_cs);
	emu_push(0x0040); emu_Ini_GetString();
l__0040:
	emu_addw(&emu_sp, 0x16);
	emu_push(emu_ss);
	emu_movw(&emu_ax, emu_bp - 0x10);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x004D); emu_cs = 0x01F7; emu_String_ToInteger();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__004D:
	emu_pop(&emu_cx);
...
/**
 * Decompiled function emu_Ini_GetString()
 *
...
l__03C8:
	...
	if (emu_ax == 0) { /* Unresolved jump */ emu_ip = 0x0405; emu_last_cs = 0xB4FC; emu_last_ip = 0x03D6; emu_last_length = 0x002C; emu_last_crc = 0x9251; emu_call(); return; }
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0xE);
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp,  0x10));
	if (emu_ax == 0) goto l__03F7;
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x16));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x10));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xE));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x14));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x12));
	emu_push(emu_cs); emu_push(0x03F4); emu_cs = 0x01F7; emu_String_strncpy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__03F4:
	emu_addw(&emu_sp, 0xA);
...
l__0421:
	...
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x043E); emu_cs = 0x01F7; emu_String_sprintf();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__043E:
	emu_addw(&emu_sp, 0xC);
	...
	emu_movw(&emu_ax, emu_bp - 0x46);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x044B); emu_cs = 0x01F7; emu_String_strupr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__044B:
	emu_pop(&emu_cx);
	...
	emu_movw(&emu_ax, emu_bp - 0x46);
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x0457); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0457:
	emu_pop(&emu_cx);
...
l__0473:
	...
	emu_push(emu_cs); emu_push(0x0482); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0482:
	emu_addw(&emu_sp, 0x6);
...
l__0496:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x04B1); emu_cs = 0x01F7; emu_String_strncasecmp();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__04B1:
	emu_addw(&emu_sp, 0xA);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax == 0) goto l__04BB;
	goto l__07CD;
l__04BB:
	emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x11), 0xA);
	if (emu_get_memory8(emu_ss, emu_bp, -0x11) == 0xA) goto l__04CA;
	emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x11), 0xD);
	if (emu_get_memory8(emu_ss, emu_bp, -0x11) == 0xD) goto l__04CA;
	goto l__07CD;
l__04CA:
...
l__04D2:
	...
	if ((emu_ax & 0x1) != 0) goto l__04CF;
	emu_ax = 0x5B;
	emu_push(emu_ax);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x04F4); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__04F4:
	emu_addw(&emu_sp, 0x6);
...
l__04FD:
	...
	if (emu_ax == 0) goto l__0539;
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x10));
	emu_al = emu_get_memory8(emu_es, emu_bx, 0xFFFF);
	emu_get_memory8(emu_ss, emu_bp, -0x11) = emu_al;
	emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x11), 0xA);
	if (emu_get_memory8(emu_ss, emu_bp, -0x11) != 0xA) {
		emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x11), 0xD);
		if (emu_get_memory8(emu_ss, emu_bp, -0x11) != 0xD) goto l__051D;
	}
l__051B:
	goto l__0559;
l__051D:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0xE));
	emu_push(emu_ax);
	emu_push(emu_cs); emu_push(0x052E); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__052E:
	emu_addw(&emu_sp, 0x6);
...
l__0539:
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0544); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0544:
	emu_pop(&emu_cx);
...
l__0564:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xC));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0xA));
	emu_push(emu_cs); emu_push(0x057B); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__057B:
	emu_pop(&emu_cx);
...
l__057F:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0592); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0592:
	emu_addw(&emu_sp, 0x6);
	...
	if (emu_ax != 0) {
		...
		if (emu_ax < emu_get_memory16(emu_ss, emu_bp, -0x10)) goto l__05AE;
	}
l__05AB:
	goto l__040D;
l__05AE:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x05D5); emu_cs = 0x01F7; emu_String_strncasecmp();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__05D5:
	emu_addw(&emu_sp, 0xA);
	emu_orw(&emu_ax, emu_ax);
	if (emu_ax == 0) goto l__05DF;
	goto l__06CF;
l__05DF:
	emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x11), 0xA);
	if (emu_get_memory8(emu_ss, emu_bp, -0x11) == 0xA) goto l__05EE;
	emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x11), 0xD);
	if (emu_get_memory8(emu_ss, emu_bp, -0x11) == 0xD) goto l__05EE;
	goto l__06CF;
l__05EE:
	emu_cmpb(&emu_get_memory8(emu_ss, emu_bp, -0x12), 0x3D);
	if (emu_get_memory8(emu_ss, emu_bp, -0x12) == 0x3D) goto l__0604;
	emu_al = emu_get_memory8(emu_ss, emu_bp, -0x12);
	emu_ax = (int8)emu_al;
	emu_bx = emu_ax;
	emu_testb(&emu_get_memory8(emu_ds, emu_bx, 0x76BD), 0x1);
	if ((emu_get_memory8(emu_ds, emu_bx, 0x76BD) & 0x1) != 0) goto l__0604;
	goto l__06CF;
l__0604:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x2);
	emu_dx = emu_get_memory16(emu_ss, emu_bp, -0x4);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0622); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0622:
	emu_addw(&emu_sp, 0x6);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x063A); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__063A:
	emu_addw(&emu_sp, 0x6);
	...
	if (emu_ax >= emu_get_memory16(emu_ss, emu_bp, -0x4)) goto l__064E;
	goto l__07D3;
l__064E:
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_ax = 0xD;
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0660); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0660:
	emu_addw(&emu_sp, 0x6);
...
l__066B:
	...
	if (emu_ax < emu_get_memory16(emu_ss, emu_bp, -0x8)) goto l__0676;
	goto l__07D3;
l__0676:
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x4));
l__0679:
	...
	emu_ax = emu_get_memory16(emu_ss, emu_bp,  0x12);
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp,  0x14));
	if (emu_ax == 0) { /* Unresolved jump */ emu_ip = 0x06CC; emu_last_cs = 0xB4FC; emu_last_ip = 0x069F; emu_last_length = 0x003A; emu_last_crc = 0xFCA2; emu_call(); return; }
	emu_push(emu_si);
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x14));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x12));
	emu_push(emu_cs); emu_push(0x06B3); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__06B3:
	emu_addw(&emu_sp, 0xA);
...
l__06F2:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0701); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0701:
	emu_addw(&emu_sp, 0x6);
	...
	if (emu_ax != 0) goto l__0715;
	goto l__07A0;
l__0715:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x8);
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x10));
	if (emu_ax < emu_get_memory16(emu_ss, emu_bp, -0x10)) goto l__0720;
	goto l__07A0;
l__0720:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x8);
	emu_xorw(&emu_dx, emu_dx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x14));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x12));
	emu_push(emu_cs); emu_push(0x0742); emu_cs = 0x01F7; emu_Tools_Memcopy();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0742:
	emu_addw(&emu_sp, 0xA);
...
l__075A:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x14));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x12));
	emu_push(emu_cs); emu_push(0x0767); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__0767:
	emu_pop(&emu_cx);
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x6));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x8));
	emu_push(emu_cs); emu_push(0x077C); emu_cs = 0x01F7; emu_String_strchr();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__077C:
	emu_addw(&emu_sp, 0x6);
	...
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x4);
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (emu_ax != 0) goto l__078F;
	goto l__07B5;
l__078F:
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_cmpb(&emu_get_memory8(emu_es, emu_bx, 0x0), 0xA);
	if (emu_get_memory8(emu_es, emu_bx, 0x0) != 0xA) { /* Unresolved jump */ emu_ip = 0x079E; emu_last_cs = 0xB4FC; emu_last_ip = 0x0799; emu_last_length = 0x0011; emu_last_crc = 0xA4A2; emu_call(); return; }
	emu_incw(&emu_get_memory16(emu_ss, emu_bp, -0x4));
	goto l__07A2;
l__07A0:
	goto l__07B5;
l__07A2:
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x4);
	emu_orw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x2));
	if (emu_ax == 0) goto l__07B5;
	emu_ax = emu_get_memory16(emu_ss, emu_bp, -0x4);
	emu_cmpw(&emu_ax, emu_get_memory16(emu_ss, emu_bp, -0x10));
	if (emu_ax >= emu_get_memory16(emu_ss, emu_bp, -0x10)) goto l__07B5;
	goto l__06F2;
l__07B5:
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x12));
	emu_get_memory8(emu_es, emu_bx, 0x0) = 0x0;
...
l__081F:
	...
	emu_ax = (int8)emu_al;
	emu_testw(&emu_ax, 0x1);
	if ((emu_ax & 0x1) != 0) { /* Unresolved jump */ emu_ip = 0x0809; emu_last_cs = 0xB4FC; emu_last_ip = 0x0830; emu_last_length = 0x001E; emu_last_crc = 0xE9EF; emu_call(); return; }
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x8));
	emu_push(emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_push(emu_cs); emu_push(0x083D); emu_cs = 0x01F7; emu_String_strlen();
	/* Check if this overlay should be reloaded */
	if (emu_cs == 0x34FC) { overlay(0x34FC, 1); }
l__083D:
	emu_pop(&emu_cx);
...
l__0869:
	...
	if (emu_ax > emu_get_memory16(emu_ss, emu_bp,  0x6)) goto l__0854;
l__087B:
	emu_pop(&emu_si);
	emu_sp = emu_bp;
	emu_pop(&emu_bp);
