...
void f__28E6_000A_0040_D751()
{
	...
	emu_push(emu_cs); emu_push(0x004A); emu_cs = 0x252E; emu_ip = 0x0065; emu_last_cs = 0x28E6; emu_last_ip = 0x0045; emu_last_length = 0x0040; emu_last_crc = 0xD751; emu_call(); // Jump does not resolve
