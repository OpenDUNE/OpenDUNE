...
void f__1423_0D2A_0014_010D()
{
	...
	if (emu_flags.zf) { /* Unresolved jump */ emu_ip = 0x0D3E; emu_last_cs = 0x1423; emu_last_ip = 0x0D36; emu_last_length = 0x0014; emu_last_crc = 0x010D; emu_call(); return; }
