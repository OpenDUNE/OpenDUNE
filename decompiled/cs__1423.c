...
l__0678:
	emu_incw(&emu_get_memory16(emu_ds, 0x00, 0x38BC));
	emu_push(emu_cs); emu_push(0x0681); emu_cs = 0x2BB4; emu_Tools_Random_256();
l__0681:
	emu_push(emu_ax);
	emu_ax = 0x1;
	emu_push(emu_ax);
...
l__06C0:
	...
	emu_push(emu_cs); emu_push(0x06E4); emu_cs = 0x176C; emu_Unit_SetAction();
l__06E4:
	emu_addw(&emu_sp, 0x6);
l__06E7:
	emu_incw(&emu_di);
...
l__0718:
	...
	emu_incw(&emu_get_memory16(emu_ds, 0x00, 0x38BC));
	emu_push(emu_cs); emu_push(0x072A); emu_cs = 0x2BB4; emu_Tools_Random_256();
l__072A:
	emu_push(emu_ax);
	emu_push(emu_si);
...
l__0762:
	...
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x2));
	emu_push(emu_get_memory16(emu_ss, emu_bp, -0x4));
	emu_push(emu_cs); emu_push(0x0771); emu_cs = 0x176C; emu_Unit_SetAction();
l__0771:
	emu_addw(&emu_sp, 0x6);
	emu_lfp(&emu_es, &emu_bx, &emu_get_memory16(emu_ss, emu_bp,  0x6));
	emu_al = emu_get_memory8(emu_es, emu_bx, 0x8);
