...
void f__1423_0061_001A_9364()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x007B); emu_cs = 0x1082; emu_Building_Find_First();
...
void f__1423_00A8_000B_166D()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x00B3); emu_cs = 0x1082; emu_Building_Find_Next();
...
void f__1423_0A2F_002B_16F9()
{
	...
	/* Unresolved jump */ emu_ip = 0x0A5A; emu_last_cs = 0x1423; emu_last_ip = 0x0A5A; emu_last_length = 0x002B; emu_last_crc = 0x16F9; emu_call();
}
...
void f__1423_0AB0_001A_235A()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0ACA); emu_cs = 0x1082; emu_Building_Find_First();
...
void f__1423_0DC3_0029_D1E2()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0DEC); emu_cs = 0x1082; emu_Building_Find_First();
...
void f__1423_0DF1_0024_7F0A()
{
	...
	emu_push(emu_ax.x);
	emu_push(emu_dx.x);
	emu_push(emu_cs); emu_push(0x0E15); emu_cs = 0x1082; emu_Building_Find_Next();
