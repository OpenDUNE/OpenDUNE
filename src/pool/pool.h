...
typedef struct PoolFindStruct {
	/* 0000(2)   */ uint16 houseID;                 /*!< House to search for, or -1 for all. */
	/* 0002(2)   */ uint16 typeID;                  /*!< Type to search for, or -1 for all. */
	/* 0004(2)   */ uint16 index;                   /*!< Last index of search, or -1 to start from begin. */
