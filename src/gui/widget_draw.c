				...
				case 3: /* Structure */
				{
					...
					switch (o->type) {
						...
						case STRUCTURE_WINDTRAP: {
							...
							GUI_DrawText_Wrapper("%d", 302, g_global->variable_6C71 * 2 + 80, 29, 0, 0x11, powerAverage);
							GUI_DrawText_Wrapper("%d", 302, g_global->variable_6C71 * 3 + 80, (powerOutput >= powerAverage) ? 29 : 6, 0, 0x11, powerOutput);
						} break;
